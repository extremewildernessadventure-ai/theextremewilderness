...
export const packages: SafariPackage[] = [
  ...
  },
  {
    ...
    metaDescription: "프라이빗 가이드가 전 일정을 함께하는 10일 노던 서킷 사파리 — 타랑기레, 마냐라, 세렝게티, 응고롱고로 크레이터까지 탄자니아를 대표하는 4대 국립공원. 1인당 $4,800부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "이틀간의 육로 이동을 건너뛰고 중앙 세렝게티로 직접 비행하는 프라이빗 5일 사파리 — 사자, 표범, 치타와 함께하는 온전한 이틀. 1인당 $2,475부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "경관이 뛰어난 7일 마차메 루트로 킬리만자로 등정 — 모든 루트 중 가장 높은 등정 성공률, 경험 많은 산악 가이드와 포터, 전체 장비 포함. 1인당 $2,100부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "두 분만을 위한 프라이빗 8일 탄자니아 허니문 사파리 — 타랑기레, 응고롱고로 고지대, 세렝게티까지 모든 게임 드라이브와 캠프를 온전히 두 분만을 위해. 1인당 $3,824부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "킬리만자로 당일 하이킹과 마사이 문화 체험을 야생동물 서킷과 결합한 12일 탄자니아 여정 — 마냐라, 타랑기레, 응고롱고로, 세렝게티. 1인당 $5,857부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "대이동의 마라강 도하를 중심으로 짜인 8일 탄자니아 사파리 — 강가에서 보내는 온전한 이틀에 타랑기레, 응고롱고로, 세렝게티까지. 1인당 $4,977부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "프라이빗 7일 노던 서킷 사파리 — 타랑기레의 코끼리 무리, 마냐라 호수의 나무 타는 사자, 세렝게티, 응고롱고로 크레이터의 빅파이브까지. 1인당 $3,300부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "응고롱고로 크레이터 상공을 지나 은두투 출산지로 — 포식자 활동과 갓 태어난 누 떼가 절정에 이르는 시기에 맞춘 프라이빗 7일 세렝게티 사파리. 1인당 $4,000부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "르완다 화산국립공원에서의 고릴라·골든몽키 트레킹과 세렝게티·응고롱고로 크레이터 사파리를 결합한 11일 여정. 1인당 $6,500부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "르완다 고릴라 트레킹과 타랑기레·응고롱고로·세렝게티를 잇는 탄자니아 사파리, 잔지바르 해변에서의 4박을 결합한 12일. 1인당 $9,375부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "프라이빗 4일 르완다 여행 — 화산국립공원에서의 마운틴고릴라 트레킹, 골든몽키, 키갈리 대학살 추모관까지. 1인당 $3,415부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "마사이마라, 킬리만자로를 배경으로 한 암보셀리의 코끼리 떼, 삼부루 보호구역의 희귀 야생동물을 잇는 프라이빗 11일 케냐 사파리. 1인당 $5,800부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "탄자니아 남부의 야생으로 떠나는 프라이빗 10일 여정 — 니에레레 국립공원의 루피지강 보트 사파리와 밀도 높은 루아하의 대형 고양잇과 동물들. 1인당 $5,200부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "탄자니아 남부의 야생 서킷 — 니에레레의 루피지강과 루아하의 야생동물 — 에 잔지바르 스톤타운과 해변에서의 3박을 더한 11일. 1인당 $6,100부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "마사이마라와 세렝게티, 킬리만자로를 배경으로 한 암보셀리, 나쿠루 호수의 플라밍고와 코뿔소를 아우르는 12일 탄자니아·케냐 원정. 1인당 $7,200부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "단 5일 만에 완주하는 노던 서킷 전체 — 타랑기레, 응고롱고로, 세렝게티, 마냐라 호수까지, 프라이빗 가이드가 함께하는 탄자니아 사파리. 1인당 $1,909부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "세렝게티에서 온전한 이틀을 보내는 6일 노던 서킷 사파리 — 타랑기레의 코끼리 무리와 응고롱고로 크레이터로의 하루 종일 하강까지. 1인당 $2,554부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "케냐와 탄자니아의 하이라이트를 잇는 10일 사파리 — 마사이마라, 킬리만자로를 배경으로 한 암보셀리, 세렝게티, 응고롱고로 크레이터. 1인당 $4,600부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "국경을 넘나드는 10일 사파리 — 나쿠루 호수의 코뿔소 보호구역, 마사이마라에서 이틀, 세렝게티에서 온전한 사흘, 응고롱고로 크레이터까지. 1인당 $5,072부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "프라이빗 4일 탄자니아 사파리 — 타랑기레의 코끼리 무리, 응고롱고로 크레이터로의 하루 종일 하강, 하드자베 부족과 함께하는 문화 체험 오후까지. 1인당 $1,250부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "5일 케냐 사파리 — 헬스게이트에서 야생동물 사이를 달리는 자전거 라이딩, 나쿠루 호수의 플라밍고와 코뿔소, 마사이마라에서 온전한 이틀까지. 1인당 $1,520부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "타랑기레, 응고롱고로 크레이터 하강, 세렝게티에서의 이틀에 잔지바르 해변 휴양을 더한 9일 탄자니아 허니문. 1인당 $3,847부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "대이동의 마라강 도하를 중심으로 짜인 프라이빗 10일 탄자니아 사파리 — 타랑기레, 마냐라, 응고롱고로, 세렝게티까지. 1인당 $4,775부터.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "소규모 그룹, 여유로운 차량 공간, 빛과 위치 선정에 능숙한 가이드가 함께하는 10일 탄자니아 포토그래픽 사파리 — 타랑기레, 응고롱고로, 세렝게티. 1인당 $4,597부터.",
    overview: [
