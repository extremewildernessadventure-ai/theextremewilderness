...
export const accommodations: Accommodation[] = [
  {
    ...
    description: "Ett helt mobilt lyxigt tältläger som följer den stora migrationen på egen hand — du jagar inte flockarna, du vaknar helt enkelt upp där de för tillfället befinner sig.",
    amenities: ["Lyxiga tältsviter", "Rum med eget badrum", "Läge vid migrationsrutten", "Fullservicerestaurang"],
    ...
    featuredIn: [{ label: "Höjdpunkter i Kenya & Tanzania-safari", href: "/safaris/kenya-tanzania-highlights-safari" }],
  },
  {
    ...
    description: "En massajdriven lodge på Kilimanjaros västsluttningar, uppbyggd kring genuint kulturellt utbyte med den omgivande gemenskapen snarare än en iscensatt version av det.",
    amenities: ["Vacker utsikt", "Kulturella upplevelser"],
    ...
    featuredIn: [{ label: "12 dagars vildmarkssafari, kulturella möten & dagsvandring på Kilimanjaro", href: "/safaris/12-days-wild-wilderness" }],
  },
  {
    slug: "andbeyond-lake-manyara-tree-lodge",
    name: "andBeyond Lake Manyara Tree Lodge",
    tier: "sovereign",
    location: "Lake Manyara nationalpark",
    description: "Den enda permanenta lodgen inne i själva Lake Manyara, med trädhusliknande sviter upplyfta i grundvattenskogens trädkrona — ett genuint annorlunda utsiktsläge över parken än allt som ligger i dess utkant.",
    amenities: ["Vacker utsikt", "Utsikt över vilda djur", "Trädhussviter", "Läge i trädkronan", "Rum med eget badrum", "Fullservicerestaurang"],
    ...
    featuredIn: [{ label: "12 dagars Tanzania Kenya-expedition", href: "/safaris/12-days-tanzania-kenya" }, { label: "7 dagars pärlor i norr", href: "/safaris/7-days-gems-of-north" }, { label: "Höjdpunkter i Kenya & Tanzania-safari", href: "/safaris/kenya-tanzania-highlights-safari" }],
  },
  {
    slug: "angama-mara",
    name: "Angama Mara",
    ...
    description: "Belägen på Oloololo-branten med utsikt över hela Mara-slätten — en vy som blivit en av Östafrikas mest fotograferade, av goda skäl.",
    amenities: ["Swimmingpool", "Vacker utsikt", "Spa", "Läge vid migrationsrutten"],
    ...
    featuredIn: [{ label: "5 dagars Kenyasafari — Hell's Gate, Lake Nakuru & Masai Mara", href: "/safaris/5-day-kenya-safari" }],
  },
  {
    ...
    tier: "sovereign",
    location: "Arusha",
    description: "En verksam kaffeodling nära flygplatsen som gör den första eller sista natten till något genuint avslappnat snarare än en ren formalitet.",
    amenities: ["Gratis wifi", "Swimmingpool", "Vacker utsikt", "Trädgårdsområde", "Fullservicerestaurang"],
    ...
    featuredIn: [{ label: "10 dagars Tanzania-safari & Zanzibar-strand", href: "/safaris/10-day-safari-zanzibar" }, { label: "10 dagars lyxig familjesafari i Tanzania", href: "/safaris/10-days-luxury-family" }, { label: "10 dagars Den ultimata stora migrationen – safari vid flodkorsningen i Mara", href: "/safaris/10-day-ultimate-great-migration-mara-river-crossing" }, { label: "12 dagar – Rwanda, Tanzania & Zanzibar", href: "/safaris/12-days-rwanda-tanzania-zanzibar" }, { label: "12 dagars Tanzania-safari för seniorer, jubileer & grupper", href: "/safaris/12-day-seniors-anniversary-groups-safari" }, { label: "7 dagars Kronjuvel-safari", href: "/safaris/7-days-crown-jewels" }, { label: "7 dagar – Flygsafari över migrationen vid Ndutu", href: "/safaris/7-days-flight-ndutu" }, { label: "7 dagars pärlor i norr", href: "/safaris/7-days-gems-of-north" }, { label: "7 dagars Serengeti & Ngorongoro-safari", href: "/safaris/7-day-serengeti-ngorongoro" }, { label: "7 dagars foto- & äventyrssafari i Tanzania", href: "/safaris/7-day-photography-adventure-safari" }, { label: "8 dagars safari med gnuernas flodkorsning", href: "/safaris/8-days-flight-migration" }, { label: "8 dagar – Den stora norra migrationen", href: "/safaris/8-days-great-northern-migration" }, { label: "Kilimanjaro Lemosho-bestigning & 5 dagars höjdpunktssafari", href: "/safaris/14-days-kilimanjaro-lemosho-safari" }],
  },
  {
    slug: "bisate-lodge",
    name: "Bisate Lodge",
    tier: "sovereign",
    location: "Volcanoes nationalpark, Rwanda",
    description: "Kupolformade skogsvillor inbäddade i ett restaurerat vulkaniskt amfiteater-landskap, en kort bilfärd från startpunkterna för gorillatrekking — en av de mest hyllade lodgeanläggningarna som byggts i Afrika detta decennium.",
    amenities: ["Vacker utsikt", "Spa", "Utsikt över vilda djur"],
    ...
    featuredIn: [{ label: "12 dagar – Rwanda, Tanzania & Zanzibar", href: "/safaris/12-days-rwanda-tanzania-zanzibar" }],
  },
  {
    ...
    description: "En tältlodge vid gränsen till Tarangire, placerad för tidig tillgång till ett av Afrikas tätaste elefantlandskap.",
    amenities: ["Fullservicerestaurang", "Gratis wifi", "Utsikt över vilda djur"],
    ...
    featuredIn: [{ label: "Tanzania fotosafari — Tarangire, Ngorongorokratern & Serengeti", href: "/safaris/tanzania-photographic-safari" }],
  },
  {
    ...
    tier: "trail",
    location: "Tarangire nationalpark",
    description: "Ett rakt-på-sak-läger som lägger pengarna där de gör mest nytta på Tarangire-rundan: gedigen guidning, ett välskött kök och ett schysst pris snarare än en resortbudget.",
    amenities: ["Fullservicerestaurang", "Gratis wifi"],
    ...
    featuredIn: [{ label: "10 dagars Den ultimata stora migrationen – safari vid flodkorsningen i Mara", href: "/safaris/10-day-ultimate-great-migration-mara-river-crossing" }],
  },
  {
    ...
    description: "Ett strandnära stadshotell på Msasanihalvön — genuint bekvämt, och det självklara övernattningsstoppet på väg till eller från den södra safarirundan.",
    amenities: ["Swimmingpool", "Fullservicerestaurang", "Gratis wifi"],
    ...
    featuredIn: [{ label: "5 dagars privat schimpanstrekking i Gombe", href: "/safaris/5-day-gombe-chimpanzee-trekking" }, { label: "7 dagar – Den södra safarirundan — Ruaha & Nyerere", href: "/safaris/7-day-southern-circuit" }, { label: "Den ultimata Tanzania-safarin & schimpanstrekking i Gombe", href: "/safaris/ultimate-tanzania-safari" }],
  },
  {
    ...
    description: "Ett all-inclusive strandresort vid Zanzibars Nungwi-kust, den avslutande Wilderness Reserve-anläggningen i resplanen för 10 dagars Tanzania-safari & Zanzibar-strand.",
    amenities: ["All-inclusive", "Swimmingpool", "Strandläge", "Fullservicerestaurang"],
    ...
    featuredIn: [{ label: "10 dagars Tanzania-safari & Zanzibar-strand", href: "/safaris/10-day-safari-zanzibar" }],
  ...
  },
  {
    ...
    description: "En enkel bas utan krusiduller i Kigali för resenärer som hellre lägger sin budget på gorillatrekking och primatetapperna av resan än på de första och sista nätterna i staden.",
    amenities: ["Gratis wifi", "Swimmingpool", "Fullservicerestaurang"],
  ...
  },
  {
    ...
    description: "Ett pålitligt, välbeläget entréhotell i Nairobi — den typen av praktiskt första eller sista stopp som gör sitt enda jobb bra innan eller efter att parkerna tar över.",
    amenities: ["Gratis wifi", "Swimmingpool", "Fullservicerestaurang"],
    ...
    featuredIn: [{ label: "10 dagars Kenya & Tanzania-safari", href: "/safaris/10-day-kenya-tanzania-safari" }],
  },
  {
    slug: "elephant-springs",
    name: "Elephant Springs",
    tier: "reserve",
    location: "Tarangireregionen",
    description: "Byggd kring en naturlig källa som lockar elefanter och andra vilda djur rakt förbi anläggningen — ett mellanprisläger med ett försprång inom djurskådning som de flesta mellanprisläger saknar.",
    amenities: ["Swimmingpool", "Vacker utsikt", "Fullservicerestaurang"],
    ...
    featuredIn: [{ label: "7 dagars foto- & äventyrssafari i Tanzania", href: "/safaris/7-day-photography-adventure-safari" }, { label: "10 dagars Tanzania-safari & Zanzibar-strand", href: "/safaris/10-day-safari-zanzibar" }],
  },
  {
    ...
    description: "Ett genuint sparesort vid Naivashas strand — en verklig lugn dag inbyggd mitt i en riftdalsrutin, inte bara ännu en lodge mellan game drive-turerna.",
    amenities: ["Spa", "Swimmingpool", "Vacker utsikt", "Gratis wifi"],
  ...
  },
  {
    ...
    description: "Byggd kring sitt eget vattenhål mitt i hjärtat av Serengeti, där vilda djur regelbundet passerar direkt nedanför terrassen — Four Seasons-standard, mitt ute på slätterna.",
    amenities: ["Swimmingpool", "Spa", "Vacker utsikt"],
    ...
    featuredIn: [{ label: "12 dagar – Rwanda, Tanzania & Zanzibar", href: "/safaris/12-days-rwanda-tanzania-zanzibar" }, { label: "12 dagars vildmarkssafari, kulturella möten & dagsvandring på Kilimanjaro", href: "/safaris/12-days-wild-wilderness" }],
  },
  {
    slug: "gibbs-farm",
    name: "Gibb's Farm",
    tier: "sovereign",
    location: "Karatu, Ngorongoros högland",
    description: "En anrik ekologisk gårdsanläggning nedanför kraterranden, som fortfarande odlar sitt eget kaffe och sina egna grödor, och allmänt betraktad som ett av Tanzanias finaste kök rakt av — inte bara bland lodgeanläggningar.",
    amenities: ["Spa", "Vacker utsikt", "Ekologiskt från jord till bord"],
    ...
    featuredIn: [{ label: "10 dagars Den ultimata stora migrationen – safari vid flodkorsningen i Mara", href: "/safaris/10-day-ultimate-great-migration-mara-river-crossing" }, { label: "12 dagar – Rwanda, Tanzania & Zanzibar", href: "/safaris/12-days-rwanda-tanzania-zanzibar" }, { label: "12 dagars Tanzania-safari för seniorer, jubileer & grupper", href: "/safaris/12-day-seniors-anniversary-groups-safari" }, { label: "12 dagars vildmarkssafari, kulturella möten & dagsvandring på Kilimanjaro", href: "/safaris/12-days-wild-wilderness" }, { label: "5 dagars fly-in-safari i Serengeti", href: "/safaris/5-day-serengeti-fly-in" }, { label: "7 dagars Serengeti & Ngorongoro-safari", href: "/safaris/7-day-serengeti-ngorongoro" }, { label: "8 dagar – Den stora norra migrationen", href: "/safaris/8-days-great-northern-migration" }, { label: "8 dagars smekmånadssafari — för busklivsälskare", href: "/safaris/8-days-honeymoon-safari" }, { label: "9 dagars smekmånadssafari & strandflykt på Zanzibar", href: "/safaris/9-day-honeymoon-safari-zanzibar" }],
  },
  {
    slug: "governors-camp",
    name: "Governors Camp",
    tier: "reserve",
    location: "Masai Mara, Kenya",
    description: "Det ursprungliga lyxiga tältlägret i Mara, i oavbruten drift sedan 1972, vid stranden av Marafloden i en av reservatets mest pålitliga djurkorridorer — en ikon, inte ett budgetstopp.",
    amenities: ["Gratis wifi", "Swimmingpool", "Fullservicerestaurang", "Utsikt över Marafloden"],
  ...
  },
  {
    ...
    tier: "sovereign",
    location: "Arusha",
    description: "Meliás eget lyxiga undervarumärke, nära flygplatsen — fullständiga resortfaciliteter och genuin finish för resenärer som vill ha mer komfort före eller efter busken.",
    amenities: ["Gratis wifi", "Swimmingpool", "Spa"],
    ...
    featuredIn: [{ label: "10 dagars Tanzania-safari & Zanzibar-strand", href: "/safaris/10-day-safari-zanzibar" }, { label: "10 dagars lyxig familjesafari i Tanzania", href: "/safaris/10-days-luxury-family" }, { label: "12 dagar – Rwanda, Tanzania & Zanzibar", href: "/safaris/12-days-rwanda-tanzania-zanzibar" }, { label: "12 dagars vildmarkssafari, kulturella möten & dagsvandring på Kilimanjaro", href: "/safaris/12-days-wild-wilderness" }, { label: "7 dagars Serengeti & Ngorongoro-safari", href: "/safaris/7-day-serengeti-ngorongoro" }, { label: "7 dagars foto- & äventyrssafari i Tanzania", href: "/safaris/7-day-photography-adventure-safari" }, { label: "8 dagar – Den stora norra migrationen", href: "/safaris/8-days-great-northern-migration" }, { label: "8 dagars safari med gnuernas flodkorsning", href: "/safaris/8-days-flight-migration" }, { label: "Södra utgåvan: Tanzanias kalvningssäsong-migrationssafari — Ndutu & Ngorongorokratern", href: "/safaris/7-days-migration-southern" }, { label: "Tanzania fotosafari — Tarangire, Ngorongorokratern & Serengeti", href: "/safaris/tanzania-photographic-safari" }],
  },
  {
    ...
    description: "Belägen direkt på branten, och kombinerar vidsträckt utsikt över dalen med fullständiga golf- och spafaciliteter som de flesta safarianläggningar helt enkelt inte erbjuder.",
    amenities: ["Swimmingpool", "Vacker utsikt", "Spa", "Utsikt över Rift Valley"],
  ...
  },
  {
    ...
    tier: "sovereign",
    location: "Nairobi, Kenya",
    description: "Ett boutiquehotell i kolonial stil i Karen, en del av den globalt erkända Hemingways Collection — genuint bekvämt snarare än bara praktiskt, i endera änden av en Kenyasafari.",
    amenities: ["Swimmingpool", "Spa", "Fullservicerestaurang", "Gratis wifi"],
    ...
    featuredIn: [{ label: "11 dagar – Kenya i särklass", href: "/safaris/11-days-kenya-undisputed" }, { label: "12 dagars Tanzania Kenya-expedition", href: "/safaris/12-days-tanzania-kenya" }, { label: "Autentiska, exklusiva Kenya — Amboseli, Samburu & Masai Mara", href: "/safaris/authentic-exclusive-kenya" }, { label: "Klassisk Kenyasafari — Masai Mara, Rift Valley & Amboseli", href: "/safaris/classic-kenya-safari" }, { label: "Höjdpunkter i Kenya & Tanzania-safari", href: "/safaris/kenya-tanzania-highlights-safari" }],
  },
  {
    ...
    description: "Ett skogskantsläger byggt för vandring och primatspårning i en av Tanzanias minst besökta, mest givande parker — för resenärer som vill ha något utöver den vanliga safarirundan.",
    amenities: ["Trädgårdsområde", "Vacker utsikt"],
    ...
    featuredIn: [{ label: "10 dagar – Södra Tanzanias hemligheter", href: "/safaris/10-days-southern-secrets" }],
  },
  {
    ...
    tier: "reserve",
    location: "Dar es Salaam",
    description: "Ett fullservicehotell vid vattnet som används som ett bekvämt transitstopp på resplaner längs den södra safarirundan — ett starkt alternativ i det övre premiumsegmentet, i samma varumärkesklass som Radisson Blu.",
    amenities: ["Swimmingpool", "Fullservicerestaurang", "Gratis wifi"],
    ...
    featuredIn: [{ label: "7 dagar – Den södra safarirundan — Ruaha & Nyerere", href: "/safaris/7-day-southern-circuit" }],
  },
  {
    slug: "ikuka-camp",
    name: "Ikuka Camp",
    ...
    description: "Ett privat läger på en klippig utlöpare ovanför Ruahafloden, i en av Tanzanias största och minst trängselutsatta parker.",
    amenities: ["Vacker utsikt", "Utsikt över vilda djur", "Fullservicerestaurang"],
  ...
  },
  {
    ...
    tier: "trail",
    location: "Volcanoes nationalpark, Rwanda",
    description: "En budgetvänlig lodge precis vid gränsen till Volcanoes nationalpark, medvetet placerad för de tidiga avfärder som en gorillatrekking-morgon kräver.",
    amenities: ["Fullservicerestaurang", "Trädgårdsområde"],
    ...
    featuredIn: [{ label: "4 dagars gorillatrekking i Rwanda", href: "/safaris/4-day-rwanda-gorilla-trekking" }, { label: "Rwanda primatsafari & strandflykt på Zanzibar", href: "/safaris/12-days-rwanda-primates" }],
  },
  {
    slug: "kahawa-house",
    name: "Kahawa House",
    tier: "trail",
    location: "Arusha",
    description: "Ett avslappnat gästhus på en verksam kaffeodling utanför Arusha — en genuint lugn, välskött första eller sista natt före eller efter busken.",
    amenities: ["Gratis wifi", "Fullservicerestaurang", "Trädgårdsområde"],
    ...
    featuredIn: [{ label: "10 dagars Tanzania-safari & Zanzibar-strand", href: "/safaris/10-day-safari-zanzibar" }, { label: "10 dagars Kenya & Tanzania-safari", href: "/safaris/10-day-kenya-tanzania-safari" }, { label: "10 dagars Den ultimata stora migrationen – safari vid flodkorsningen i Mara", href: "/safaris/10-day-ultimate-great-migration-mara-river-crossing" }, { label: "12 dagar – Rwanda, Tanzania & Zanzibar", href: "/safaris/12-days-rwanda-tanzania-zanzibar" }, { label: "12 dagars Tanzania-safari för seniorer, jubileer & grupper", href: "/safaris/12-day-seniors-anniversary-groups-safari" }, { label: "12 dagars vildmarkssafari, kulturella möten & dagsvandring på Kilimanjaro", href: "/safaris/12-days-wild-wilderness" }, { label: "4 dagar – Tarangire, Ngorongoro & Lake Eyasi", href: "/safaris/4-day-tarangire-ngorongoro-lake-eyasi" }, { label: "5 dagars fly-in-safari i Serengeti", href: "/safaris/5-day-serengeti-fly-in" }, { label: "5 dagars komfortsafari i Tanzania", href: "/safaris/5-day-comfort-tanzania-safari" }, { label: "5 dagars Kilimanjaro-förlängningssafari", href: "/safaris/kilimanjaro-extension-safari" }, { label: "6 dagars komfortsafari i Tanzania", href: "/safaris/6-day-comfort-tanzania-safari" }, { label: "7 dagars Serengeti & Ngorongoro-safari", href: "/safaris/7-day-serengeti-ngorongoro" }, { label: "8 dagar – Den stora norra migrationen", href: "/safaris/8-days-great-northern-migration" }, { label: "8 dagars smekmånadssafari — för busklivsälskare", href: "/safaris/8-days-honeymoon-safari" }, { label: "8 dagars safari med gnuernas flodkorsning", href: "/safaris/8-days-flight-migration" }, { label: "Kilimanjaro Lemosho-bestigning & 5 dagars höjdpunktssafari", href: "/safaris/14-days-kilimanjaro-lemosho-safari" }, { label: "Södra utgåvan: Tanzanias kalvningssäsong-migrationssafari — Ndutu & Ngorongorokratern", href: "/safaris/7-days-migration-southern" }, { label: "Tanzania fotosafari — Tarangire, Ngorongorokratern & Serengeti", href: "/safaris/tanzania-photographic-safari" }, { label: "Den ultimata Tanzania-safarin & schimpanstrekking i Gombe", href: "/safaris/ultimate-tanzania-safari" }],
  },
  {
    slug: "kambi-ya-tembo",
    name: "Kambi ya Tembo",
    tier: "reserve",
    location: "Västra Kilimanjaro",
    description: "Ett tältläger på privat mark vid Kilimanjaros fot, känt för fastboende elefantflockar som passerar rakt genom lägret och en bergskuliss som inte behöver någon utsmyckning.",
    amenities: ["Vacker utsikt", "Utsikt över vilda djur"],
  ...
  },
  {
    ...
    tier: "reserve",
    location: "Masai Mara, Kenya",
    description: "&Beyonds eget, mer prisvärda läger i Mara — den fullständiga andBeyond-standarden vad gäller gästfrihet och läge, till ett märkbart mildare pris än deras signaturanläggningar.",
    amenities: ["Utsikt över vilda djur", "Vacker utsikt", "Swimmingpool", "Spa", "Läge vid migrationsrutten", "Fullservicerestaurang"],
  ...
  },
  {
    ...
    tier: "reserve",
    location: "Kigali, Rwanda",
    description: "Ett centralt beläget hotell i Kigali med Serenas konsekventa 5-stjärniga standard — ett genuint bekvämt övernattningsstopp före eller efter gorillatrekking i Virunga, inte en budgetlösning.",
    amenities: ["Gratis wifi", "Swimmingpool", "Fullservicerestaurang"],
  ...
  },
  {
    ...
    name: "Kigoma Hilltop",
    tier: "trail",
    location: "Kigoma, Tanganyikasjön",
    description: "En kuperad lodge med genuin utsikt över Tanganyikasjön, som fungerar som porten till en av Tanzanias mest avlägsna och givande upplevelser: schimpanstrekking i Gombe och Mahale.",
    amenities: ["Vacker utsikt", "Fullservicerestaurang"],
    ...
    featuredIn: [{ label: "5 dagars privat schimpanstrekking i Gombe", href: "/safaris/5-day-gombe-chimpanzee-trekking" }, { label: "Den ultimata Tanzania-safarin & schimpanstrekking i Gombe", href: "/safaris/ultimate-tanzania-safari" }],
  },
  {
    ...
    tier: "sovereign",
    location: "Zanzibar",
    description: "Kupolformade privata paviljonger inbäddade i bergssluttningen ovanför Indiska oceanen, var och en med sin egen plunge pool — ett medvetet avbrott i tempot efter dagar i busken.",
    amenities: ["Swimmingpool", "Spa", "Strandläge", "All-inclusive", "Vacker utsikt"],
    ...
    featuredIn: [{ label: "10 dagars Tanzania-safari & Zanzibar-strand", href: "/safaris/10-day-safari-zanzibar" }, { label: "11 dagar – Söderns vilda djur & kryddöarna", href: "/safaris/11-days-southern-spice" }, { label: "12 dagar – Rwanda, Tanzania & Zanzibar", href: "/safaris/12-days-rwanda-tanzania-zanzibar" }, { label: "9 dagars smekmånadssafari & strandflykt på Zanzibar", href: "/safaris/9-day-honeymoon-safari-zanzibar" }],
  },
  {
    ...
    tier: "reserve",
    location: "Volcanoes nationalpark, Rwanda",
    description: "Ett rakt-på-sak-gästhus vid entrén till Volcanoes nationalpark, byggt specifikt kring de tidiga avfärder som en gorillatrekking-morgon kräver.",
    amenities: ["Vacker utsikt", "Trädgårdsområde", "Rum med eget badrum", "Fullservicerestaurang"],
    ...
    featuredIn: [{ label: "11 dagars Rwanda Tanzania-safari", href: "/safaris/11-days-rwanda-tanzania" }, { label: "12 dagar – Rwanda, Tanzania & Zanzibar", href: "/safaris/12-days-rwanda-tanzania-zanzibar" }],
  },
  {
    ...
    description: "Ett tältläger på Riftdalens brant med en utsikt som talar för sig själv — dalbotten sträcker sig nedanför så långt ögat når.",
    amenities: ["Gratis wifi", "Fullservicerestaurang", "Utsikt över Rift Valley", "Swimmingpool"],
  ...
  },
  {
    ...
    tier: "reserve",
    location: "Lake Eyasi",
    description: "Ett litet tältläger vid Lake Eyasi, den vanliga och bäst placerade basen för besök hos Hadzabe-folkets jägar- och samlarsamhälle.",
    amenities: ["Vacker utsikt", "Trädgårdsområde"],
    ...
    featuredIn: [{ label: "11 dagars Rwanda Tanzania-safari", href: "/safaris/11-days-rwanda-tanzania" }],
  },
  {
    slug: "kitela-lodge",
    name: "Kitela Lodge",
    tier: "reserve",
    location: "Karatu, Ngorongoros högland",
    description: "En före detta kaffeodling med breda verandor vända mot Riftdalens brant och ett kök som genuint är värt att prata om, nära vägen längs kraterranden.",
    amenities: ["Swimmingpool", "Vacker utsikt", "Fullservicerestaurang", "Trädgårdsområde"],
    ...
    featuredIn: [{ label: "10 dagars Tanzania-safari & Zanzibar-strand", href: "/safaris/10-day-safari-zanzibar" }, { label: "10 dagars lyxig familjesafari i Tanzania", href: "/safaris/10-days-luxury-family" }, { label: "11 dagars Rwanda Tanzania-safari", href: "/safaris/11-days-rwanda-tanzania" }, { label: "12 dagar – Rwanda, Tanzania & Zanzibar", href: "/safaris/12-days-rwanda-tanzania-zanzibar" }, { label: "12 dagars Tanzania Kenya-expedition", href: "/safaris/12-days-tanzania-kenya" }, { label: "5 dagars höjdpunktssafari", href: "/safaris/5-days-highlights-safari" }, { label: "5 dagars fly-in-safari i Serengeti", href: "/safaris/5-day-serengeti-fly-in" }, { label: "7 dagars Serengeti & Ngorongoro-safari", href: "/safaris/7-day-serengeti-ngorongoro" }, { label: "8 dagar – Den stora norra migrationen", href: "/safaris/8-days-great-northern-migration" }, { label: "Kilimanjaro Lemosho-bestigning & 5 dagars höjdpunktssafari", href: "/safaris/14-days-kilimanjaro-lemosho-safari" }],
  },
  {
    slug: "kubukubu-tented-lodge",
    name: "Kubukubu Tented Lodge",
    tier: "reserve",
    location: "Centrala Serengeti / Tarangire",
    description: "En pålitlig tältlodge som används på både Tarangire- och centrala Serengeti-etapperna i flera av våra resplaner — gedigen guidning till ett schysst pris, varje gång.",
    amenities: ["Swimmingpool", "Vacker utsikt", "Fullservicerestaurang", "Gratis wifi", "All-inclusive", "Rum med eget badrum"],
    ...
    featuredIn: [{ label: "10 dagars Tanzania-safari & Zanzibar-strand", href: "/safaris/10-day-safari-zanzibar" }, { label: "10 dagars lyxig familjesafari i Tanzania", href: "/safaris/10-days-luxury-family" }, { label: "10 dagars Kenya & Tanzania-safari", href: "/safaris/10-day-kenya-tanzania-safari" }, { label: "10 dagars Den ultimata stora migrationen – safari vid flodkorsningen i Mara", href: "/safaris/10-day-ultimate-great-migration-mara-river-crossing" }, { label: "12 dagar – Rwanda, Tanzania & Zanzibar", href: "/safaris/12-days-rwanda-tanzania-zanzibar" }, { label: "12 dagars Tanzania-safari för seniorer, jubileer & grupper", href: "/safaris/12-day-seniors-anniversary-groups-safari" }, { label: "12 dagars vildmarkssafari, kulturella möten & dagsvandring på Kilimanjaro", href: "/safaris/12-days-wild-wilderness" }, { label: "5 dagars fly-in-safari i Serengeti", href: "/safaris/5-day-serengeti-fly-in" }, { label: "5 dagars komfortsafari i Tanzania", href: "/safaris/5-day-comfort-tanzania-safari" }, { label: "6 dagars komfortsafari i Tanzania", href: "/safaris/6-day-comfort-tanzania-safari" }, { label: "7 dagars Serengeti & Ngorongoro-safari", href: "/safaris/7-day-serengeti-ngorongoro" }, { label: "8 dagars safari med gnuernas flodkorsning", href: "/safaris/8-days-flight-migration" }, { label: "8 dagar – Den stora norra migrationen", href: "/safaris/8-days-great-northern-migration" }, { label: "9 dagars smekmånadssafari & strandflykt på Zanzibar", href: "/safaris/9-day-honeymoon-safari-zanzibar" }, { label: "Höjdpunkter i Kenya & Tanzania-safari", href: "/safaris/kenya-tanzania-highlights-safari" }, { label: "Tanzania fotosafari — Tarangire, Ngorongorokratern & Serengeti", href: "/safaris/tanzania-photographic-safari" }],
  },
  {
    slug: "la-palme-hotel",
    name: "La Palme Hotel",
    ...
    description: "En bekväm, centralt belägen bas i Musanze innan du ger dig ut för att spåra gorillor i Volcanoes.",
    amenities: ["Gratis wifi", "Fullservicerestaurang", "Trädgårdsområde"],
  ...
  },
  {
    ...
    tier: "reserve",
    location: "Centrala Serengeti",
    description: "Ett tältläger mitt på slätterna, med nära tillgång till några av ekosystemets mest pålitliga djurskådningsområden året runt.",
    amenities: ["Vacker utsikt", "Fullservicerestaurang", "Utsikt över vilda djur"],
    ...
    featuredIn: [{ label: "5 dagars höjdpunktssafari", href: "/safaris/5-days-highlights-safari" }, { label: "Kilimanjaro Lemosho-bestigning & 5 dagars höjdpunktssafari", href: "/safaris/14-days-kilimanjaro-lemosho-safari" }],
  },
  {
    ...
    tier: "trail",
    location: "Tarangire nationalpark",
    description: "En tältlodge vid kanten av Lake Burunge, på gränsen till Tarangire, mest känd bland gästerna för sin solnedgångsutsikt rakt över vattnet.",
    amenities: ["Fullservicerestaurang", "Trädgårdsområde", "Swimmingpool", "Gratis wifi", "Sjöutsikt"],
    ...
    featuredIn: [{ label: "8 dagar – Den stora norra migrationen", href: "/safaris/8-days-great-northern-migration" }, { label: "12 dagars Tanzania-safari för seniorer, jubileer & grupper", href: "/safaris/12-day-seniors-anniversary-groups-safari" }, { label: "5 dagars komfortsafari i Tanzania", href: "/safaris/5-day-comfort-tanzania-safari" }, { label: "5 dagars Kilimanjaro-förlängningssafari", href: "/safaris/kilimanjaro-extension-safari" }, { label: "6 dagars komfortsafari i Tanzania", href: "/safaris/6-day-comfort-tanzania-safari" }],
  },
  {
    ...
    description: "Ett Serena-tältläger vid en lugnare Rift Valley-sjö än sina mer besökta grannar.",
    amenities: ["Vacker utsikt", "Fullservicerestaurang", "Sjöutsikt", "Gratis wifi"],
  ...
  },
  {
    ...
    tier: "reserve",
    location: "Kivusjön, Rwanda",
    description: "En sjönära Serena-anläggning, vanligtvis det avslutande stoppet på en Rwanda-resplan efter att primattrekking-etapperna är avklarade.",
    amenities: ["Swimmingpool", "Vacker utsikt", "Fullservicerestaurang"],
  ...
  },
  {
    ...
    tier: "trail",
    location: "Lake Naivasha, Kenya",
    description: "Ett pålitligt sjönära resort, väl placerat för båtturer till Crescent Island och gåsafarier — den typen av bekväm vistelse utan överraskningar som Sopa-anläggningar är kända för i hela Östafrika.",
    amenities: ["Gratis wifi", "Swimmingpool", "Fullservicerestaurang", "Sjöutsikt"],
  ...
  },
  {
    ...
    tier: "reserve",
    location: "Lake Nakuru nationalpark, Kenya",
    description: "Inne i själva parken, historiskt känd för sin flamingokantade strandlinje och sin fastboende noshörningspopulation.",
    amenities: ["Vacker utsikt", "Fullservicerestaurang", "Gratis wifi"],
    ...
    featuredIn: [{ label: "11 dagar – Kenya i särklass", href: "/safaris/11-days-kenya-undisputed" }, { label: "12 dagars Tanzania Kenya-expedition", href: "/safaris/12-days-tanzania-kenya" }, { label: "5 dagars Kenyasafari — Hell's Gate, Lake Nakuru & Masai Mara", href: "/safaris/5-day-kenya-safari" }, { label: "Klassisk Kenyasafari — Masai Mara, Rift Valley & Amboseli", href: "/safaris/classic-kenya-safari" }],
  },
  {
    ...
    tier: "trail",
    location: "Lake Nakuru nationalpark, Kenya",
    description: "Belägen på högt liggande mark ovanför sjön med genuint panoramautsikt, och samma pålitliga Sopa-standard som återfinns på deras andra östafrikanska anläggningar.",
    amenities: ["Gratis wifi", "Swimmingpool", "Fullservicerestaurang", "Vacker utsikt"],
  ...
  },
  {
    ...
    tier: "sovereign",
    location: "Norra Serengeti, Kogatende",
    description: "Ett privat läger på en kulle rakt ovanför flodkorsningspunkterna vid Marafloden — ett av de bäst placerade lägren på berget, för resenärer som tajmar sin resa efter själva korsningarna.",
    amenities: ["Swimmingpool", "Vacker utsikt", "Utsikt över vilda djur", "Spa"],
    ...
    featuredIn: [{ label: "10 dagars Den ultimata stora migrationen – safari vid flodkorsningen i Mara", href: "/safaris/10-day-ultimate-great-migration-mara-river-crossing" }, { label: "8 dagar – Den stora norra migrationen", href: "/safaris/8-days-great-northern-migration" }],
  },
  {
    ...
    tier: "sovereign",
    location: "Tarangire nationalpark",
    description: "Ett privat tältläger med utsikt över Tarangirefloden, i ett av Afrikas tätaste elefantlandskap utanför regnperioden.",
    amenities: ["All-inclusive", "Spa", "Vacker utsikt", "Utsikt över vilda djur"],
    ...
    featuredIn: [{ label: "10 dagars lyxig familjesafari i Tanzania", href: "/safaris/10-days-luxury-family" }, { label: "7 dagars pärlor i norr", href: "/safaris/7-days-gems-of-north" }, { label: "8 dagar – Den stora norra migrationen", href: "/safaris/8-days-great-northern-migration" }, { label: "8 dagars safari med gnuernas flodkorsning", href: "/safaris/8-days-flight-migration" }],
  },
  {
    slug: "lemala-osonjoi",
    name: "Lemala Osonjoi",
    tier: "sovereign",
    location: "Ngorongoro naturreservat",
    description: "Ett privat tältläger nära nedstigningsvägen, som får gästerna ner på kraterbotten innan de flesta andra läger ens har avslutat frukosten.",
    amenities: ["Spa", "Vacker utsikt", "Fullservicerestaurang"],
    ...
    featuredIn: [{ label: "10 dagars lyxig familjesafari i Tanzania", href: "/safaris/10-days-luxury-family" }],
  },
  {
    ...
    tier: 'trail',
    location: 'Zanzibarön',
    description: 'Ett enkelt, välbeläget gästhus för resenärer som förlänger resan till Zanzibars stränder utan att förlänga budgeten.',
    amenities: ['Restaurang med full service', 'Direkt vid stranden'],
    ...
    featuredIn: [{ label: '12 dagar: Rwanda, Tanzania och Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }],
  },
  {
    slug: 'mara-katikati-tented-camp',
    name: 'Mara Katikati Tented Camp',
    tier: 'trail',
    location: 'Norra Serengeti / Mara-gränsen, Tanzania',
    description: 'Ett klassiskt tältläger som drivs enkelt och ärligt, placerat med tanke på de tidiga morgnarna som gör skillnaden på en game drive i Mara-ekosystemet.',
    amenities: ['Rum med eget badrum', 'Utsikt över djurlivet'],
    ...
    featuredIn: [{ label: '8 dagar – Den stora norra migrationen', href: '/safaris/8-days-great-northern-migration' }, { label: '8 dagars safari med gnuflodkorsning', href: '/safaris/8-days-flight-migration' }],
  },
  {
    slug: 'mara-mara-tented-lodge',
    name: 'Mara Mara Tented Lodge',
    tier: 'reserve',
    location: 'Norra Serengeti / gränsen mot Masai Mara',
    description: 'En tältlodge nära gränsområdet mellan Kenya och Tanzania, placerad specifikt med tanke på migrationens flodkorsningssäsong.',
    amenities: ['Utsikt över djurlivet', 'Panoramautsikt', 'Restaurang med full service'],
    ...
    featuredIn: [{ label: '10-dagars safari — Den ultimata stora migrationen och flodkorsningen vid Mara', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '8 dagar – Den stora norra migrationen', href: '/safaris/8-days-great-northern-migration' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenya',
    description: 'En Serena-lodge på en höjd med vidsträckt utsikt över reservatets slätter och floden nedanför.',
    amenities: ['Gratis wifi', 'Pool', 'Restaurang med full service', 'Panoramautsikt'],
    ...
    featuredIn: [{ label: "5 dagars Kenya-safari — Hell's Gate, Lake Nakuru och Masai Mara", href: '/safaris/5-day-kenya-safari' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Norra Serengeti',
    description: 'Ett mobilt tältläger som flyttar med själva migrationen genom norra Serengeti och Mara-gränsen.',
    amenities: ['Utsikt över djurlivet', 'Panoramautsikt'],
    ...
    featuredIn: [{ label: 'Fotosafari i Tanzania — Tarangire, Ngorongorokratern och Serengeti', href: '/safaris/tanzania-photographic-safari' }, { label: '8 dagars safari med gnuflodkorsning', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Masai Mara, Kenya',
    description: 'En stor, väletablerad lodge nära migrationens flodkorsningskorridor — solid Sopa-pålitlighet med ett genuint starkt läge i ryggen.',
    amenities: ['Gratis wifi', 'Pool', 'Restaurang med full service', 'Utsikt över Marafloden', 'Läge vid migrationsrutten'],
    ...
    featuredIn: [{ label: '10-dagars safari i Kenya och Tanzania', href: '/safaris/10-day-kenya-tanzania-safari' }, { label: "5 dagars Kenya-safari — Hell's Gate, Lake Nakuru och Masai Mara", href: '/safaris/5-day-kenya-safari' }],
  },
  {
    ...
    description: 'Ett tältläger nära Lake Masek, mitt i gnuernas kalvningssäsong varje år.',
    amenities: ['Panoramautsikt', 'Utsikt över djurlivet', 'Rum med eget badrum'],
    ...
    featuredIn: [{ label: '7 dagar: Flyg över Ndutu-migrationen', href: '/safaris/7-days-flight-ndutu' }, { label: '7 dagars Tanzania foto- och äventyrssafari', href: '/safaris/7-day-photography-adventure-safari' }],
  },
  {
    ...
    description: 'Ett litet tältläger vid Tanganyikasjöns strand, den praktiska och bekväma basen för schimpanstrekking i Gombe.',
    amenities: ['Utsikt över djurlivet', 'Rum med eget badrum'],
    ...
    featuredIn: [{ label: '5 dagar: Privat schimpanstrekking i Gombe', href: '/safaris/5-day-gombe-chimpanzee-trekking' }, { label: 'Den ultimata Tanzania-safarin och schimpanstrekking i Gombe', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
    ...
    description: 'Med utsikt över Mikumis öppna flodslätt — en av de mest lättillgängliga parkerna på den södra safarirundan, med en lodge som matchar dess enkelhet.',
    amenities: ['Pool', 'Panoramautsikt', 'Restaurang med full service'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Nyungweskogen, Rwanda',
    description: 'En ekolodge i utkanten av Nyungweskogen, nära startpunkterna för schimpanstrekking genom en av Afrikas äldsta bergsregnskogar.',
    amenities: ['Restaurang med full service', 'Utsikt över djurlivet', 'Utsikt över skogen'],
    ...
    featuredIn: [{ label: 'Rwanda primatsafari och strandflykt på Zanzibar', href: '/safaris/12-days-rwanda-primates' }],
    needsPhotography: true,
  },
  {
    ...
    tier: 'reserve',
    location: 'Ndutu, Södra Serengeti',
    description: 'Ett säsongsbetonat tältläger tajmat exakt efter gnuernas kalvningssäsong varje år.',
    amenities: ['Rum med eget badrum', 'Utsikt över djurlivet'],
    ...
    featuredIn: [{ label: 'Southern Edition: Tanzanias kalvningssäsong-migrationssafari — Ndutu & Ngorongorokratern', href: '/safaris/7-days-migration-southern' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Ndutu, Södra Serengeti',
    description: 'En permanent lodge i sten och halmtak med 34 stugor med utsikt över Lake Ndutu, placerad för åtkomst året runt till de fastboende rovdjuren som aldrig lämnar platsen när migrationen drar vidare.',
    amenities: ['Rum med eget badrum', 'Utsikt över djurlivet', 'Restaurang med full service', 'Panoramautsikt'],
    ...
    featuredIn: [{ label: '8-dagars fotosafari utanför de slagna vägarna', href: '/safaris/off-the-beaten-track-photography-safari' }],
  },
  {
    slug: 'ngorongoro-farm-house',
    name: 'Ngorongoro Farm House',
    tier: 'trail',
    location: 'Karatu, Ngorongoro-höglandet',
    description: 'En arbetande kaffegård som blivit en lodge bland bananlundar på kraterranden — avslappnad och hemtrevlig till sin natur, utan ambitioner om att vara något mer storslaget.',
    amenities: ['Restaurang med full service', 'Trädgårdsanläggning', 'Gratis wifi', 'Höglandsträdgårdar', 'Arbetande gård', 'Pool'],
    ...
    featuredIn: [{ label: '10-dagars safari i Kenya och Tanzania', href: '/safaris/10-day-kenya-tanzania-safari' }, { label: '10-dagars safari — Den ultimata stora migrationen och flodkorsningen vid Mara', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '12 dagars Tanzania-safari för seniorer, jubileum och grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '12-dagars vildmarkssafari, kulturella möten och Kilimanjaro-dagsvandring', href: '/safaris/12-days-wild-wilderness' }, { label: '4-dagars safari i Tarangire, Ngorongoro och Lake Eyasi', href: '/safaris/4-day-tarangire-ngorongoro-lake-eyasi' }, { label: '5 dagars höjdpunktssafari', href: '/safaris/5-days-highlights-safari' }, { label: '5 Dagars Komfortsafari i Tanzania', href: '/safaris/5-day-comfort-tanzania-safari' }, { label: '6 Dagars Komfortsafari i Tanzania', href: '/safaris/6-day-comfort-tanzania-safari' }, { label: '7 dagars Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 dagar – Den stora norra migrationen', href: '/safaris/8-days-great-northern-migration' }, { label: '9-dagars smekmånadssafari och strandflykt på Zanzibar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }, { label: 'Höjdpunkter av Kenya och Tanzania-safari', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, Ngorongoro-höglandet',
    description: 'En lodge i mellanklassen i höglandet med enkel tillgång till nedkörningen till kratern för tidiga game drive-turer.',
    amenities: ['Panoramautsikt', 'Restaurang med full service', 'Rum med eget badrum'],
    ...
    featuredIn: [{ label: '10 dagars lyxig familjesafari i Tanzania', href: '/safaris/10-days-luxury-family' }, { label: '7 dagars Tanzania foto- och äventyrssafari', href: '/safaris/7-day-photography-adventure-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Ngorongoro naturreservat',
    description: 'Beläget direkt på kraterranden, bland de platser som ligger närmast nedkörningsvägen, med genuin, ohindrad utsikt över kratern.',
    amenities: ['Panoramautsikt', 'Spa', 'Restaurang med full service', 'Rum med eget badrum'],
    ...
    featuredIn: [{ label: '12-dagars vildmarkssafari, kulturella möten och Kilimanjaro-dagsvandring', href: '/safaris/12-days-wild-wilderness' }, { label: '5 dagars höjdpunktssafari', href: '/safaris/5-days-highlights-safari' }, { label: '7 dagars Tanzania foto- och äventyrssafari', href: '/safaris/7-day-photography-adventure-safari' }, { label: '8 dagars safari med gnuflodkorsning', href: '/safaris/8-days-flight-migration' }, { label: 'Kilimanjaro Lemosho-bestigning och 5 dagars höjdpunktssafari', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }, { label: 'Southern Edition: Tanzanias kalvningssäsong-migrationssafari — Ndutu & Ngorongorokratern', href: '/safaris/7-days-migration-southern' }, { label: 'Fotosafari i Tanzania — Tarangire, Ngorongorokratern och Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Ngorongoro naturreservat',
    description: 'En stenbyggd Serena-lodge inskuren i kraterns skogklädda rand, med rum som blickar rakt ner i Ngorongorokraterns botten.',
    amenities: ['Panoramautsikt', 'Restaurang med full service', 'Rum med eget badrum'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Nungwi, Zanzibar',
    description: 'En strandnära anläggning på Zanzibars nordspets, känd bland gästerna för lugnt badvatten och pålitligt vackra solnedgångar.',
    amenities: ['Pool', 'Panoramautsikt', 'Restaurang med full service', 'Gratis wifi'],
    ...
    featuredIn: [{ label: '7 dagars Crown Jewels-safari', href: '/safaris/7-days-crown-jewels' }, { label: '9-dagars smekmånadssafari och strandflykt på Zanzibar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }, { label: '10 dagars Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: 'Rwanda primatsafari och strandflykt på Zanzibar', href: '/safaris/12-days-rwanda-primates' }],
  },
  {
    slug: 'ol-tukai-lodge',
    name: 'Ol Tukai Lodge',
    tier: 'trail',
    location: 'Amboseli nationalpark, Kenya',
    description: 'Inne i själva parken, med några av de mest konsekvent pålitliga Kilimanjaro-utsikterna av alla anläggningar i Amboseli — en verklig skillnad i denna prisklass.',
    amenities: ['Panoramautsikt', 'Utsikt över djurlivet', 'Pool', 'Gratis wifi', 'Restaurang med full service', 'Utsikt över Kilimanjaro'],
    ...
    featuredIn: [{ label: '11 Dagar Kenya Obestridd', href: '/safaris/11-days-kenya-undisputed' }, { label: '12 Dagar Tanzania Kenya-expedition', href: '/safaris/12-days-tanzania-kenya' }, { label: 'Autentiska, exklusiva Kenya — Amboseli, Samburu och Masai Mara', href: '/safaris/authentic-exclusive-kenya' }, { label: 'Klassisk Kenya-safari — Masai Mara, Riftdalen och Amboseli', href: '/safaris/classic-kenya-safari' }, { label: 'Höjdpunkter av Kenya och Tanzania-safari', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Nyungweskogen, Rwanda',
    description: 'Ett globalt erkänt ultralyxvarumärke beläget på en aktiv teplantage i utkanten av Nyungwe — uppbyggt kring schimpanstrekking och tillgång till trädkronvandringen snarare än gorillor.',
    amenities: ['Panoramautsikt', 'Spa', 'Restaurang med full service'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Västra Kilimanjaro',
    description: 'En massajägd lodge vid Kilimanjaros fot, med en premium Kisiwa Boma-svitkategori vid sidan av standardrummen — ett fristående ställe, skilt från den separat placerade Africa Amini Original Maasai Lodge.',
    amenities: ['Restaurang med full service', 'Trädgårdsanläggning', 'Panoramautsikt'],
    ...
    featuredIn: [{ label: '12 dagars Tanzania-safari för seniorer, jubileum och grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Rwanda',
    description: 'Ett internationellt hotell med full service i centrala Kigali, ett bekvämt stopp på vägen före eller efter Rwandas primattrekking.',
    amenities: ['Pool', 'Restaurang med full service', 'Gratis wifi', 'Spa'],
    ...
    featuredIn: [{ label: '11 dagars Rwanda- och Tanzaniasafari', href: '/safaris/11-days-rwanda-tanzania' }, { label: '12 dagar: Rwanda, Tanzania och Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }],
  },
  {
    slug: 'royal-zanzibar',
    name: 'Royal Zanzibar',
    tier: 'reserve',
    location: 'Zanzibarön',
    description: 'Ett all-inclusive-resort direkt vid stranden, det klassiska avslutande stoppet för safarier som förlängs till ön.',
    amenities: ['All-inclusive', 'Direkt vid stranden', 'Pool', 'Panoramautsikt'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Ruaha nationalpark',
    description: 'Utspridd längs Great Ruaha-floden, i Tanzanias största nationalpark och en av dess mest genuint underbesökta.',
    amenities: ['Panoramautsikt', 'Utsikt över djurlivet', 'Restaurang med full service'],
    ...
    featuredIn: [{ label: '10 Dagar Södra Tanzanias Hemligheter', href: '/safaris/10-days-southern-secrets' }, { label: '11 Dagar Söderns Djurliv och Kryddöarna', href: '/safaris/11-days-southern-spice' }, { label: '7 dagar södra safarirundan — Ruaha & Nyerere', href: '/safaris/7-day-southern-circuit' }],
  },
  {
    ...
    description: 'Ett läger vid Rufijiflodens strand, basen för både game drive-turer och båtsafarier under samma resa.',
    amenities: ['Utsikt över djurlivet', 'Restaurang med full service', 'Panoramautsikt'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Akagera nationalpark, Rwanda',
    description: 'Med utsikt över Lake Ihema i Akagera, Rwandas eget Big Five-resmål och ett helt annat landskap än vulkanerna.',
    amenities: ['Panoramautsikt', 'Utsikt över djurlivet'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Samburu nationalreservat, Kenya',
    description: 'Vid Ewaso Nyiro-floden, hem för arter som knappt finns någon annanstans i Kenya — nätgiraff, Grevys zebra, gerenuk.',
    amenities: ['Panoramautsikt', 'Utsikt över djurlivet'],
    ...
    featuredIn: [{ label: '11 Dagar Kenya Obestridd', href: '/safaris/11-days-kenya-undisputed' }, { label: 'Autentiska, exklusiva Kenya — Amboseli, Samburu och Masai Mara', href: '/safaris/authentic-exclusive-kenya' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Nyerere nationalpark (Selous)',
    description: 'Byggd in i klipporna ovanför Rufijifloden och endast nåbar med småflyg — avlägsen på ett sätt få platser i denna klass klarar av.',
    amenities: ['Restaurang med full service', 'Panoramautsikt', 'Gratis wifi', 'Utsikt över djurlivet'],
    ...
    featuredIn: [{ label: '2-dagars Nyerere-safari från Zanzibar', href: '/safaris/2-day-selous-safari-from-zanzibar' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Lake Nakuru nationalpark, Kenya',
    description: 'Högt beläget inne i parken, med vid utsikt över sjön och det djurliv den lockar till sig.',
    amenities: ['Gratis wifi', 'Pool', 'Restaurang med full service', 'Panoramautsikt'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Nyerere nationalpark (Selous)',
    description: 'En Serena-lodge ovanför Rufijiflodens forsar, som kombinerar game drive-turer med flodbaserade aktiviteter under samma vistelse.',
    amenities: ['All-inclusive', 'Pool', 'Utsikt över djurlivet'],
    ...
    featuredIn: [{ label: '7 dagar södra safarirundan — Ruaha & Nyerere', href: '/safaris/7-day-southern-circuit' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Centrala Serengeti',
    description: 'Ett privat läger byggt medvetet för ett mindre, mer exklusivt avtryck i ekosystemet än de större anläggningarna i centrala Serengeti.',
    amenities: ['Pool', 'Panoramautsikt', 'Spa'],
    ...
    featuredIn: [{ label: '10-dagars safari — Den ultimata stora migrationen och flodkorsningen vid Mara', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '10 dagars Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Centrala Serengeti',
    description: 'Ett klassiskt tältläger under akaciornas kronor, mitt i slätternas viltrika hjärta — solid tillgång utan den höga prislappen.',
    amenities: ['Rum med eget badrum', 'Restaurang med full service', 'Utsikt över djurlivet'],
    ...
    featuredIn: [{ label: '5 dagars höjdpunktssafari', href: '/safaris/5-days-highlights-safari' }, { label: '7 dagars Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 dagar – Den stora norra migrationen', href: '/safaris/8-days-great-northern-migration' }, { label: '8 dagars safari med gnuflodkorsning', href: '/safaris/8-days-flight-migration' }, { label: '10 dagars Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '5 Dagars Kilimanjaro-förlängningssafari', href: '/safaris/kilimanjaro-extension-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Centrala Serengeti',
    description: 'Ett rättframt tältläger med verklig tillgång till de centrala slätterna, prissatt för resenärer som hellre lägger pengarna på fler dagar än på ett finare tält.',
    amenities: ['Rum med eget badrum', 'Restaurang med full service', 'Utsikt över djurlivet'],
    ...
    featuredIn: [{ label: '12 dagar: Rwanda, Tanzania och Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '8 dagars smekmånadssafari — för buskälskare', href: '/safaris/8-days-honeymoon-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Ndutu, Södra Serengeti',
    description: 'Ett säsongsbetonat mobilt läger som varje år slås upp vid Ndutu-platsen för att följa gnuernas kalvningssäsong.',
    amenities: ['Rum med eget badrum', 'Panoramautsikt', 'Utsikt över djurlivet'],
    ...
    featuredIn: [{ label: '7 dagars Tanzania foto- och äventyrssafari', href: '/safaris/7-day-photography-adventure-safari' }, { label: 'Southern Edition: Tanzanias kalvningssäsong-migrationssafari — Ndutu & Ngorongorokratern', href: '/safaris/7-days-migration-southern' }, { label: 'Fotosafari i Tanzania — Tarangire, Ngorongorokratern och Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Tarangire nationalpark',
    description: 'Ett privat tältläger rest på pålar ovanför Tarangires trädtoppar, i elefantland året runt.',
    amenities: ['Panoramautsikt', 'Utsikt över djurlivet', 'Lyxiga tältsviter', 'Restaurang med full service', 'Pool'],
    ...
    featuredIn: [{ label: '10-dagars safari — Den ultimata stora migrationen och flodkorsningen vid Mara', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '7 dagars Tanzania foto- och äventyrssafari', href: '/safaris/7-day-photography-adventure-safari' }, { label: '8 dagars smekmånadssafari — för buskälskare', href: '/safaris/8-days-honeymoon-safari' }, { label: 'Fotosafari i Tanzania — Tarangire, Ngorongorokratern och Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'En privat villa, ett mer personligt alternativ till en vanlig hotellvistelse före eller efter busken.',
    amenities: ['Pool', 'Spa', 'Panoramautsikt', 'Gratis wifi'],
    ...
    featuredIn: [{ label: '5 dagars Serengeti fly-in-safari', href: '/safaris/5-day-serengeti-fly-in' }, { label: '8 dagars smekmånadssafari — för buskälskare', href: '/safaris/8-days-honeymoon-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Centrala Serengeti',
    description: 'Ett tältläger på slätterna med en premium svitkategori vid sidan av standardtälten.',
    amenities: ['Gratis wifi', 'Panoramautsikt', 'Restaurang med full service', 'Spa', 'Utsikt över djurlivet', 'Lyxiga tältsviter'],
    ...
    featuredIn: [{ label: '11 dagars Rwanda- och Tanzaniasafari', href: '/safaris/11-days-rwanda-tanzania' }, { label: '12 Dagar Tanzania Kenya-expedition', href: '/safaris/12-days-tanzania-kenya' }, { label: '12 dagars Tanzania-safari för seniorer, jubileum och grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '5 dagars höjdpunktssafari', href: '/safaris/5-days-highlights-safari' }, { label: '5 dagars Serengeti fly-in-safari', href: '/safaris/5-day-serengeti-fly-in' }, { label: '7 dagars Crown Jewels-safari', href: '/safaris/7-days-crown-jewels' }, { label: '7 dagar: Flyg över Ndutu-migrationen', href: '/safaris/7-days-flight-ndutu' }, { label: '7 dagar: Norrens pärlor', href: '/safaris/7-days-gems-of-north' }, { label: '7 dagars Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 dagars smekmånadssafari — för buskälskare', href: '/safaris/8-days-honeymoon-safari' }, { label: '9-dagars smekmånadssafari och strandflykt på Zanzibar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }, { label: 'Kilimanjaro Lemosho-bestigning och 5 dagars höjdpunktssafari', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }, { label: 'Fotosafari i Tanzania — Tarangire, Ngorongorokratern och Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    slug: 'sweetwaters-serena-camp',
    name: 'Sweetwaters Serena Camp',
    tier: 'reserve',
    location: 'Ol Pejeta naturreservat, Kenya',
    description: 'Inne i Ol Pejeta, hem för Kenyas största reservat för svarta noshörningar och världens sista norra vita noshörningar — en genuint sällsynt merit inom djurliv.',
    amenities: ['Utsikt över djurlivet', 'Pool'],
    ...
    featuredIn: [{ label: '11 Dagar Kenya Obestridd', href: '/safaris/11-days-kenya-undisputed' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Tarangire nationalpark',
    description: 'Ett rättframt tältläger på Tarangire-rundan, väl placerat i förhållande till parkens täta elefantflockar utan resortpriser.',
    amenities: ['Rum med eget badrum', 'Utsikt över djurlivet', 'Restaurang med full service'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Tarangire nationalpark',
    description: 'Ett upphöjt lyxläger på Tarangire-rundan, en del av Elewana Collection, med utsikt i trädtoppshöjd över ett av Afrikas tätaste elefantlandskap.',
    amenities: ['Pool', 'Panoramautsikt', 'Spa', 'Utsikt över djurlivet'],
  ...
  },
  {
    ...
    name: 'Tawi Lodge',
    tier: 'reserve',
    location: 'Amboseli-området, Kenya',
    description: 'En lodge i ett privat naturreservat som gränsar till Amboseli, uppbyggd kring ett lokalt naturbevarandeprogram och med sin egen utsikt över Kilimanjaro.',
    amenities: ['Pool', 'Spa', 'Utsikt över Kilimanjaro', 'Naturbevarandeprogram'],
    ...
    featuredIn: [{ label: 'Höjdpunkter av Kenya och Tanzania-safari', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, Ngorongoro-höglandet',
    description: 'Ett herrgårdshus i kolonialstil på en kaffeplantage nära kraterranden, som förenar tidstypisk arkitektur med ett kök som verkligen lever upp till sitt rykte.',
    amenities: ['Panoramautsikt', 'Restaurang med full service', 'Rum med eget badrum', 'Pool', 'Spa', 'Arkitektur från kolonitiden'],
    ...
    featuredIn: [{ label: '10 dagars lyxig familjesafari i Tanzania', href: '/safaris/10-days-luxury-family' }, { label: '10 dagars Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '7 dagars Crown Jewels-safari', href: '/safaris/7-days-crown-jewels' }, { label: 'Höjdpunkter av Kenya och Tanzania-safari', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    slug: 'tloma-lodge',
    name: 'Tloma Lodge',
    tier: 'reserve',
    location: 'Karatu, Ngorongoro-höglandet',
    description: 'En trädgårdslodge på en tidigare kaffegård utanför Karatu, avslappnad och nära nedkörningen till kratern.',
    amenities: ['Gratis wifi', 'Restaurang med full service', 'Trädgårdsanläggning', 'Ekologiskt från gård till bord'],
    ...
    featuredIn: [{ label: '12 dagar: Rwanda, Tanzania och Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '7 dagar: Flyg över Ndutu-migrationen', href: '/safaris/7-days-flight-ndutu' }, { label: '7 dagar: Norrens pärlor', href: '/safaris/7-days-gems-of-north' }, { label: '8 dagars smekmånadssafari — för buskälskare', href: '/safaris/8-days-honeymoon-safari' }],
  },
  {
    slug: 'tortils-ngorongoro-camp',
    name: 'Tortils Ngorongoro Camp',
    tier: 'trail',
    location: 'Ngorongoro-höglandet',
    description: 'Ett budgetvänligt läger i höglandet, det förnuftiga valet för resenärer som prioriterar valuta för pengarna på kraterdelen av en längre resa.',
    amenities: ['Restaurang med full service', 'Trädgårdsanläggning'],
    ...
    featuredIn: [{ label: '5 dagars höjdpunktssafari', href: '/safaris/5-days-highlights-safari' }, { label: '8 dagars safari med gnuflodkorsning', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Rwanda',
    description: 'Ett centralt beläget hotell i Kigali, bekvämt och väl placerat före eller efter Rwandas nationalparker.',
    amenities: ['Gratis wifi', 'Restaurang med full service', 'Panoramautsikt'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Zanzibarön',
    description: 'Ett Serena-hotell på Zanzibarön, ankomststoppet där Rwandas primattrekking övergår i en rad oplanerade stranddagar.',
    amenities: ['Pool', 'Direkt vid stranden', 'Restaurang med full service'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Tarangire-regionen',
    description: 'Ett tältläger på Tarangire-rundan med pålitlig guidning och djurskådning till ett genuint mellanklasspris.',
    amenities: ['Restaurang med full service', 'Gratis wifi', 'Utsikt över djurlivet'],
    ...
    featuredIn: [{ label: '8 dagars smekmånadssafari — för buskälskare', href: '/safaris/8-days-honeymoon-safari' }],
  },
]
