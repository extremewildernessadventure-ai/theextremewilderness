...
export const packages: SafariPackage[] = [
  ...
  },
  {
    ...
    metaDescription: "سفاري خاصة في تنزانيا بوتيرة تناسب العائلة على مدى جيلين — أروشا وتارانجيري ونجورونجورو وسيرينغيتي. فئتان، تبدأ الأسعار من 6,025 دولارًا للشخص الواحد.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "حياة برية في الدائرة الشمالية وتتبع شمبانزي في غومبي، ضمن برنامج واحد متواصل — مزيج نادر في سوق سفاري تنزانيا. 11 يومًا، ابتداءً من 5,908.96 دولار للشخص.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "طيران مباشر إلى نقاط عبور نهر مارا، ثم تحرك جنوبًا عبر سيرينغيتي وفوهة نجورونجورو. ثلاث فئات، ابتداءً من 3,852.29 دولار للشخص.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "تتبع الشمبانزي والغوريلا والقرد الذهبي في رواندا، تليه أربع ليالٍ على شواطئ زنجبار. حجز واحد متكامل، ابتداءً من 7,742.08 دولار للشخص.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "بعثة خاصة بمرشد لتتبع الشمبانزي البري في غومبي ستريم — أحد أندر لقاءات الحياة البرية في أفريقيا. خمسة أيام، ابتداءً من 4,206.25 دولار للشخص.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "تسلقوا قمة كليمنجارو عبر مسار ليموشو، ثم طيروا مباشرة إلى سيرينغيتي وفوهة نجورونجورو. 14 يوماً، حجز واحد متكامل. ابتداءً من 6,607.58 دولاراً للشخص الواحد.",
    overview: [
