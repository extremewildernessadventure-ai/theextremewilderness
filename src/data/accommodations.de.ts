...
export const accommodations: Accommodation[] = [
  {
    ...
    description: 'Ein vollständig mobiles Luxus-Zeltcamp, das der Großen Migration selbst folgt — statt den Herden hinterherzujagen, wachen Gäste einfach dort auf, wo sie sich gerade befinden.',
  ...
  },
  {
    ...
    description: 'Eine von Massai geführte Lodge an den Westhängen des Kilimandscharo, die auf einen echten kulturellen Austausch mit der umliegenden Gemeinschaft setzt statt auf eine inszenierte Version davon.',
  ...
  },
  {
    ...
    description: 'Die einzige feste Lodge innerhalb des Manyarasee-Nationalparks selbst, mit baumhausartigen Suiten hoch im Kronendach des Grundwasserwalds — eine wirklich andere Perspektive auf den Park als alles am Rand.',
  ...
  },
  {
    ...
    description: 'Am Rand des Oloololo-Steilhangs gelegen, mit einem Blick über die gesamte Mara-Ebene, der zu Recht zu den meistfotografierten Ausblicken Ostafrikas zählt.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'Eine aktive Kaffeeplantage nahe dem Flughafen, die aus einer ersten oder letzten Nacht keine bloße Formalität macht, sondern eine wirklich entspannte.',
  ...
  },
  {
    ...
    description: 'Kuppelförmige Waldvillen in einem restaurierten vulkanischen Amphitheater, nur eine kurze Fahrt von den Ausgangspunkten des Gorilla-Trekkings entfernt — eine der meistgefeierten Lodges, die in diesem Jahrzehnt in Afrika entstanden sind.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Tarangire-Nationalpark',
    description: 'Ein unkompliziertes Camp auf der Tarangire-Route, das sein Geld dort investiert, wo es zählt: solide Führung, eine gut geführte Küche und ein fairer Preis statt Resort-Budget.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Daressalam',
    description: 'Ein Stadthotel in Strandlage auf der Msasani-Halbinsel — wirklich komfortabel und der übliche Übernachtungsstopp auf dem Weg zur oder von der südlichen Route.',
    ...
    featuredIn: [{ label: '5 Tage Privates Schimpansen-Trekking in Gombe', href: '/safaris/5-day-gombe-chimpanzee-trekking' }, { label: '7 Tage Südlicher Rundkurs — Ruaha & Nyerere', href: '/safaris/7-day-southern-circuit' }, { label: 'Ultimative Tansania-Safari & Schimpansen-Trekking in Gombe', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
    ...
    description: 'Ein All-Inclusive-Resort in Strandlage an Sansibars Nungwi-Küste, der abschließende Stopp der Kategorie Wilderness Reserve für die Reiseroute 10 Tage Safari & Sansibar-Strände.',
    amenities: ['All-Inclusive', 'Swimmingpool', 'Strandlage', 'Vollservice-Restaurant'],
    ...
    featuredIn: [{ label: '10 Tage Safari & Sansibar-Strände', href: '/safaris/10-day-safari-zanzibar' }],
  ...
  },
  {
    ...
    description: 'Eine einfache, unkomplizierte Basis in Kigali für Reisende, die ihr Budget lieber in Gorilla-Trekking und die Primaten-Etappen der Reise stecken als in die erste und letzte Nacht in der Stadt.',
  ...
  },
  {
    ...
    description: 'Ein verlässliches, gut gelegenes Gateway-Hotel in Nairobi — der praktische erste oder letzte Stopp, der seine eine Aufgabe gut erfüllt, bevor oder nachdem die Parks übernehmen.',
    amenities: ['Kostenloses WLAN', 'Swimmingpool', 'Vollservice-Restaurant'],
  ...
  },
  {
    ...
    description: 'Rund um eine natürliche Quelle gebaut, die Elefanten und andere Tiere direkt an der Unterkunft vorbeiführt — ein Camp im mittleren Preissegment mit einem Vorteil bei der Tierbeobachtung, den die meisten Camps dieser Kategorie nicht bieten.',
    ...
    featuredIn: [{ label: 'Fotografie- und Abenteuersafari über 7 Tage in Tansania', href: '/safaris/7-day-photography-adventure-safari' }, { label: '10 Tage Safari & Sansibar-Strände', href: '/safaris/10-day-safari-zanzibar' }],
  },
  {
    ...
    description: 'Ein echtes Spa-Resort am Ufer des Naivashasees — ein wirklicher Ruhetag mitten in einer Rift-Valley-Route, nicht nur eine weitere Lodge zwischen den Pirschfahrten.',
  ...
  },
  {
    ...
    description: 'Rund um ein eigenes Wasserloch mitten im Serengeti gebaut, an dem regelmäßig Tiere direkt unterhalb der Terrasse vorbeiziehen — der Four-Seasons-Standard, mitten in den Ebenen.',
    ...
    featuredIn: [{ label: '12 Tage Ruanda, Tansania & Sansibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '12-Tage-Wildnis-Safari, Kulturbegegnungen & Kilimandscharo-Tageswanderung', href: '/safaris/12-days-wild-wilderness' }],
  },
  {
    slug: 'gibbs-farm',
    name: 'Gibb\'s Farm',
    ...
    description: 'Ein traditionsreiches Bio-Landgut unterhalb des Kraterrands, das nach wie vor eigenen Kaffee und eigenes Gemüse anbaut und weithin als eine der besten Küchen Tansanias gilt — nicht nur unter Lodges.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenia',
    description: 'Das ursprüngliche Luxus-Zeltcamp in der Mara, seit 1972 durchgehend in Betrieb, an den Ufern des Mara-Flusses in einem der zuverlässigsten Wildtierkorridore des Reservats — eine Institution, kein Budget-Stopp.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'Meliás eigene Luxus-Submarke nahe dem Flughafen — volle Resort-Ausstattung und echter Schliff für Reisende, die sich vor oder nach dem Busch mehr Komfort wünschen.',
  ...
  },
  {
    ...
    description: 'Direkt am Steilhang gelegen, verbindet dieses Resort weite Talblicke mit einer vollständigen Golf- und Spa-Anlage, wie sie kaum ein Safari-Anwesen bietet.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Nairobi, Kenia',
    description: 'Ein Boutique-Hotel im Kolonialstil im Nairobier Vorort Karen, Teil der weltweit bekannten Hemingways Collection — wirklich komfortabel und nicht nur praktisch, an beiden Enden einer Kenia-Safari.',
  ...
  },
  {
    ...
    description: 'Ein Camp am Waldrand für Wanderungen und Primaten-Tracking in einem von Tansanias am wenigsten besuchten, aber lohnendsten Parks — für Reisende, die mehr als die Standardroute suchen.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Daressalam',
    description: 'Ein Vollservice-Hotel an der Uferpromenade, das als komfortabler Zwischenstopp auf Reiserouten der südlichen Route dient — eine starke Option im gehobenen Segment, auf derselben Markenstufe wie Radisson Blu.',
    amenities: ['Swimmingpool', 'Vollservice-Restaurant', 'Kostenloses WLAN'],
  ...
  },
  {
    ...
    description: 'Ein privates Camp auf einem Felsvorsprung über dem Ruaha-Fluss, in einem von Tansanias größten und am wenigsten überlaufenen Parks.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Volcanoes-Nationalpark, Ruanda',
    description: 'Eine preisgünstige Lodge direkt an der Grenze des Volcanoes-Nationalparks, bewusst für die frühen Abfahrten gelegen, die ein Gorilla-Trekking-Morgen verlangt.',
    ...
    featuredIn: [{ label: '4 Tage Ruanda Gorilla-Trekking', href: '/safaris/4-day-rwanda-gorilla-trekking' }, { label: '12 Tage Primaten-Erlebnis in Ruanda', href: '/safaris/12-days-rwanda-primates' }],
  },
  {
    slug: 'kahawa-house',
    name: 'Kahawa House',
    tier: 'trail',
    location: 'Arusha',
    description: 'Ein entspanntes Gästehaus auf einer aktiven Kaffeeplantage vor den Toren Arushas — eine wirklich ruhige, gut geführte erste oder letzte Nacht vor oder nach dem Busch.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Westlicher Kilimandscharo',
    description: 'Ein Zeltcamp auf Privatgrund am Fuß des Kilimandscharo, bekannt für ansässige Elefantenherden, die direkt durchs Camp ziehen, und eine Bergkulisse, die keine weitere Erklärung braucht.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenia',
    description: '&Beyonds eigenes, zugänglicheres Mara-Camp — der volle andBeyond-Standard bei Gastfreundschaft und Lage, zu einem spürbar moderateren Preis als bei den Signature-Unterkünften der Marke.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Ruanda',
    description: 'Ein zentral gelegenes Hotel in Kigali mit Serenas durchgehendem 5-Sterne-Standard — ein wirklich komfortabler Übernachtungsstopp vor oder nach dem Gorilla-Trekking in den Virunga-Bergen, kein Budget-Lückenfüller.',
    amenities: ['Kostenloses WLAN', 'Swimmingpool', 'Vollservice-Restaurant'],
  ...
  },
  {
    ...
    description: 'Eine Hügellodge mit echtem Blick auf den Tanganjikasee, die als Tor zu einem von Tansanias abgelegensten und lohnendsten Erlebnissen dient: Schimpansen-Trekking in Gombe und Mahale.',
    ...
    featuredIn: [{ label: '5 Tage Privates Schimpansen-Trekking in Gombe', href: '/safaris/5-day-gombe-chimpanzee-trekking' }, { label: 'Ultimative Tansania-Safari & Schimpansen-Trekking in Gombe', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Volcanoes-Nationalpark, Ruanda',
    description: 'Ein unkompliziertes Gästehaus am Eingang des Volcanoes-Nationalparks, gezielt für die frühen Abfahrten gebaut, die ein Gorilla-Trekking-Morgen verlangt.',
    ...
    featuredIn: [{ label: '11 Tage Ruanda-Tansania-Safari', href: '/safaris/11-days-rwanda-tanzania' }, { label: '12 Tage Ruanda, Tansania & Sansibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Manyarasee',
    description: 'Ein Zeltcamp am Steilhang des Rift Valley mit einem Ausblick, der für sich spricht — der Talboden erstreckt sich darunter, soweit das Auge reicht.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Eyasisee',
    description: 'Ein kleines Zeltcamp am Eyasisee, die übliche und bestgelegene Basis für Besuche bei der Hadzabe-Jäger-und-Sammler-Gemeinschaft.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, Ngorongoro-Hochland',
    description: 'Eine ehemalige Kaffeeplantage mit weiten Veranden zum Steilhang des Rift Valley und einer Küche, über die wirklich gesprochen wird, nahe der Straße zum Kraterrand.',
  ...
  },
  {
    ...
    description: 'Eine verlässliche Zeltlodge, die sowohl auf der Tarangire- als auch auf der zentralen Serengeti-Etappe mehrerer unserer Reiserouten genutzt wird — solide Führung zu einem fairen Preis, jedes Mal.',
  ...
  },
  {
    ...
    description: 'Eine komfortable, zentrale Basis in Musanze, bevor es zum Gorilla-Trekking in die Vulkane geht.',
    amenities: ['Kostenloses WLAN', 'Vollservice-Restaurant', 'Gartenanlage'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Zentraler Serengeti',
    description: 'Ein Zeltcamp mitten in den Ebenen, mit direktem Zugang zu einigen der zuverlässigsten ganzjährigen Wildtierbeobachtungen des Ökosystems.',
    ...
    featuredIn: [{ label: '5 Tage Highlights-Safari', href: '/safaris/5-days-highlights-safari' }, { label: 'Kilimandscharo Lemosho-Besteigung & 5-Tage-Highlights-Safari', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Tarangire-Nationalpark',
    description: 'Eine Zeltlodge am Ufer des Burunge-Sees am Rand von Tarangire, bei Gästen vor allem für ihre Sonnenuntergangsblicke übers Wasser bekannt.',
    ...
    featuredIn: [{ label: '8 Tage Große Nördliche Migration', href: '/safaris/8-days-great-northern-migration' }, { label: '12-Tage-Safari in Tansania für Senioren, Jubiläen und Gruppen', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '5-Tage Komfort-Safari Tansania', href: '/safaris/5-day-comfort-tanzania-safari' }, { label: '5 Tage Kilimandscharo-Verlängerungssafari', href: '/safaris/kilimanjaro-extension-safari' }, { label: '6-Tage Komfort-Safari Tansania', href: '/safaris/6-day-comfort-tanzania-safari' }],
  },
  {
    ...
    description: 'Ein Serena-Zeltcamp an einem ruhigeren Rift-Valley-See als seine belebteren Nachbarn.',
  ...
  },
  {
    ...
    description: 'Ein Serena-Anwesen am See, meist der abschließende Stopp einer Ruanda-Reiseroute, wenn die Primaten-Trekking-Etappen erledigt sind.',
    amenities: ['Swimmingpool', 'Landschaftliche Aussicht', 'Vollservice-Restaurant'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Naivashasee, Kenia',
    description: 'Ein verlässliches Resort am See, gut gelegen für Bootsausflüge zur Crescent Island und Walking-Safaris — der komfortable, überraschungsfreie Aufenthalt, für den Sopa-Häuser in ganz Ostafrika bekannt sind.',
  ...
  },
  {
    ...
    description: 'Direkt im Park gelegen, historisch bekannt für seine von Flamingos gesäumte Uferlinie und die dort ansässige Nashornpopulation.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Nakurusee-Nationalpark, Kenia',
    description: 'Auf einer Anhöhe über dem See gelegen mit wirklich panoramischen Ausblicken, und demselben verlässlichen Sopa-Standard, den man von ihren anderen ostafrikanischen Häusern kennt.',
  ...
  },
  {
    ...
    description: 'Ein privates Camp auf einem Hügel direkt über den Flussüberquerungsstellen des Mara-Flusses — eines der bestgelegenen Camps am Berg für Reisende, die ihre Reise gezielt auf die Flussüberquerungen abstimmen.',
  ...
  },
  {
    ...
    featuredIn: [{ label: '10 Tage Luxus-Familiensafari in Tansania', href: '/safaris/10-days-luxury-family' }, { label: '7 Tage Die Juwelen des Nordens', href: '/safaris/7-days-gems-of-north' }, { label: '8 Tage Große Nördliche Migration', href: '/safaris/8-days-great-northern-migration' }, { label: '8 Tage Mara-Fluss-Überquerungssafari', href: '/safaris/8-days-flight-migration' }],
  },
  {
    slug: 'lemala-osonjoi',
    name: 'Lemala Osonjoi',
    ...
    description: 'Ein privates Zeltcamp nahe der Abstiegsstraße, das Gäste auf den Kraterboden bringt, bevor die meisten anderen Camps überhaupt mit dem Frühstück fertig sind.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Insel Sansibar',
    description: 'Ein einfaches, gut gelegenes Gästehaus für Reisende, die ihren Aufenthalt auf Sansibars Strände ausdehnen, ohne dabei das Budget zu sprengen.',
  ...
  },
  {
    ...
    description: 'Ein klassisches Zeltcamp, einfach und ehrlich geführt, ideal gelegen für die frühen Starts, die bei einer Pirschfahrt im Mara-Ökosystem den Unterschied machen.',
    ...
    featuredIn: [{ label: '8 Tage Große Nördliche Migration', href: '/safaris/8-days-great-northern-migration' }, { label: '8 Tage Mara-Fluss-Überquerungssafari', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    description: 'Eine Zeltlodge nahe dem Grenzgebiet zwischen Kenia und Tansania, gezielt für die Flussüberquerungssaison der Migration gelegen.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenia',
    description: 'Eine Serena-Lodge auf einem Hügel mit weiten Ausblicken über die Ebenen und den Fluss des Reservats darunter.',
    amenities: ['Kostenloses WLAN', 'Swimmingpool', 'Vollservice-Restaurant', 'Landschaftliche Aussicht'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Nördlicher Serengeti',
    description: 'Ein mobiles Zeltcamp, das mit der Migration selbst durch den nördlichen Serengeti und das Grenzgebiet zur Mara zieht.',
    ...
    featuredIn: [{ label: 'Tansania-Fotosafari — Tarangire, Ngorongoro-Krater & Serengeti', href: '/safaris/tanzania-photographic-safari' }, { label: '8 Tage Mara-Fluss-Überquerungssafari', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Masai Mara, Kenia',
    description: 'Eine große, etablierte Lodge nahe dem Flussüberquerungskorridor der Migration — solide Sopa-Zuverlässigkeit mit einer wirklich starken Lage im Rücken.',
  ...
  },
  {
    ...
    description: 'Ein Zeltcamp nahe dem Masek-See, mitten im jährlichen Zentrum der Kälbersaison der Gnus.',
  ...
  },
  {
    ...
    description: 'Ein kleines Zeltcamp am Ufer des Tanganjikasees, die praktische, komfortable Basis für Schimpansen-Trekking in Gombe.',
  ...
  },
  {
    ...
    description: 'Mit Blick auf Mikumis offene Flussebene — einer der am leichtesten erreichbaren Parks der südlichen Route, mit einer Lodge, die dieser Leichtigkeit entspricht.',
    amenities: ['Swimmingpool', 'Landschaftliche Aussicht', 'Vollservice-Restaurant'],
  ...
  },
  {
    ...
    description: 'Eine Öko-Lodge am Rand des Nyungwe-Walds, nahe den Ausgangspunkten für Schimpansen-Trekking durch einen der ältesten Bergregenwälder Afrikas.',
    amenities: ['Vollservice-Restaurant', 'Tierbeobachtung', 'Waldblick'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Ndutu, Südlicher Serengeti',
    description: 'Ein saisonales Zeltcamp, das jedes Jahr präzise auf die Kälbersaison der Gnus abgestimmt ist.',
    amenities: ['Zimmer mit eigenem Bad', 'Tierbeobachtung'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Ndutu, Südlicher Serengeti',
    description: 'Eine dauerhafte Lodge aus Stein und Reetdach mit 34 Cottages mit Blick auf den Ndutusee, ideal gelegen für ganzjährigen Zugang zu den ansässigen Raubtieren, die auch bleiben, wenn die Migration weiterzieht.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Karatu, Ngorongoro-Hochland',
    description: 'Ein aktiver Kaffeebauernhof, der zur Lodge wurde, zwischen Bananenhainen am Kraterrand — bewusst entspannt und heimelig, ohne den Anspruch, mehr zu sein.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, Ngorongoro-Hochland',
    description: 'Eine Lodge im mittleren Preissegment im Hochland mit leichtem Zugang zur Abstiegsstraße für frühe Pirschfahrten.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Ngorongoro-Schutzgebiet',
    description: 'Direkt am Kraterrand gelegen, eine der Unterkünfte, die der Abstiegsstraße am nächsten liegen, mit echtem, ungehindertem Kraterblick.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Ngorongoro-Schutzgebiet',
    description: 'Eine aus Stein errichtete Serena-Lodge, in den bewaldeten Kraterrand eingelassen, mit Zimmern, die direkt hinunter auf den Boden des Ngorongoro-Kraters blicken.',
    amenities: ['Landschaftliche Aussicht', 'Vollservice-Restaurant', 'Zimmer mit eigenem Bad'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Nungwi, Sansibar',
    description: 'Eine Unterkunft in Strandlage an Sansibars Nordspitze, bei Gästen bekannt für ruhiges Badewasser und verlässlich schöne Sonnenuntergänge.',
    ...
    featuredIn: [{ label: '7 Tage Kronjuwelen-Safari', href: '/safaris/7-days-crown-jewels' }, { label: '9-Tage-Flitterwochen-Safari & Sansibar-Strandurlaub', href: '/safaris/9-day-honeymoon-safari-zanzibar' }, { label: '10 Tage Safari & Sansibar-Strände', href: '/safaris/10-day-safari-zanzibar' }, { label: '12 Tage Primaten-Erlebnis in Ruanda', href: '/safaris/12-days-rwanda-primates' }],
  },
  {
    slug: 'ol-tukai-lodge',
    name: 'Ol Tukai Lodge',
    ...
    description: 'Direkt im Park gelegen, mit einigen der zuverlässigsten Kilimandscharo-Blicke aller Unterkünfte in Amboseli — ein echtes Unterscheidungsmerkmal in dieser Preisklasse.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Nyungwe-Wald, Ruanda',
    description: 'Eine weltweit bekannte Ultra-Luxusmarke, eingebettet in eine aktive Teeplantage am Rand des Nyungwe-Walds — ausgerichtet auf Schimpansen-Trekking und den Zugang zum Baumkronenpfad statt auf Gorillas.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Westlicher Kilimandscharo',
    description: 'Eine Massai-geführte Lodge am Fuß des Kilimandscharo, mit einer gehobenen Kisiwa-Boma-Suitenkategorie neben den Standardzimmern — ein eigenständiges Anwesen, getrennt von der separat positionierten Africa Amini Original Maasai Lodge.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Insel Sansibar',
    description: 'Ein All-Inclusive-Resort in Strandlage, der übliche Abschlussstopp für Safaris, die sich auf die Insel verlängern.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Ruaha-Nationalpark',
    description: 'Entlang des Great-Ruaha-Flusses verstreut, in Tansanias größtem Nationalpark und einem der am wenigsten besuchten.',
    amenities: ['Landschaftliche Aussicht', 'Tierbeobachtung', 'Vollservice-Restaurant'],
    ...
    featuredIn: [{ label: '10 Tage Geheimnisse des Südlichen Tansanias', href: '/safaris/10-days-southern-secrets' }, { label: '11 Tage Südliche Tierwelt & Gewürzinseln', href: '/safaris/11-days-southern-spice' }, { label: '7 Tage Südlicher Rundkurs — Ruaha & Nyerere', href: '/safaris/7-day-southern-circuit' }],
  },
  {
    ...
    description: 'Ein Camp am Ufer des Rufiji, die Basis sowohl für Pirschfahrten als auch für Bootssafaris innerhalb derselben Reise.',
  ...
  },
  {
    ...
    description: 'Mit Blick auf den Ihema-See in Akagera, Ruandas eigenem Big-Five-Ziel und einer wirklich anderen Landschaft als die Vulkane.',
    amenities: ['Landschaftliche Aussicht', 'Tierbeobachtung'],
  ...
  },
  {
    ...
    description: 'Am Ewaso-Nyiro-Fluss gelegen, Heimat von Arten, die es fast nirgendwo sonst in Kenia gibt — Netzgiraffe, Grevyzebra, Gerenuk.',
    amenities: ['Landschaftliche Aussicht', 'Tierbeobachtung'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Nyerere-Nationalpark (Selous)',
    description: 'In die Felsen über dem Rufiji-Fluss gebaut und nur mit dem Kleinflugzeug erreichbar — abgelegen auf eine Art, wie es nur wenige Unterkünfte dieser Kategorie schaffen.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Nakurusee-Nationalpark, Kenia',
    description: 'Auf einer Anhöhe im Park gelegen, mit weiten Ausblicken über den See und die Tierwelt, die er anzieht.',
    amenities: ['Kostenloses WLAN', 'Swimmingpool', 'Vollservice-Restaurant', 'Landschaftliche Aussicht'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Nyerere-Nationalpark (Selous)',
    description: 'Eine Serena-Lodge über den Stromschnellen des Rufiji-Flusses, die Pirschfahrten mit Aktivitäten auf dem Fluss im selben Aufenthalt verbindet.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Zentraler Serengeti',
    description: 'Ein privates Camp, bewusst für einen kleineren, exklusiveren Fußabdruck im Ökosystem konzipiert als die größeren Unterkünfte im zentralen Serengeti.',
    ...
    featuredIn: [{ label: '10-Tage-Ultimative Große Migration — Mara-Fluss-Überquerungs-Safari', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '10 Tage Safari & Sansibar-Strände', href: '/safaris/10-day-safari-zanzibar' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Zentraler Serengeti',
    description: 'Ein klassisches Zeltcamp unter Akazien, mitten im wildreichen Herzen der Ebenen — solider Zugang ohne Premium-Preis.',
    ...
    featuredIn: [{ label: '5 Tage Highlights-Safari', href: '/safaris/5-days-highlights-safari' }, { label: '7 Tage Serengeti & Ngorongoro Safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 Tage Große Nördliche Migration', href: '/safaris/8-days-great-northern-migration' }, { label: '8 Tage Mara-Fluss-Überquerungssafari', href: '/safaris/8-days-flight-migration' }, { label: '10 Tage Safari & Sansibar-Strände', href: '/safaris/10-day-safari-zanzibar' }, { label: '5 Tage Kilimandscharo-Verlängerungssafari', href: '/safaris/kilimanjaro-extension-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Zentraler Serengeti',
    description: 'Ein unkompliziertes Zeltcamp mit echtem Zugang zu den zentralen Ebenen, kalkuliert für Reisende, die ihr Geld lieber in mehr Tage stecken als in ein schickeres Zelt.',
    amenities: ['Zimmer mit eigenem Bad', 'Vollservice-Restaurant', 'Tierbeobachtung'],
    ...
    featuredIn: [{ label: '12 Tage Ruanda, Tansania & Sansibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '8 Tage Flitterwochen-Safari — Für Naturliebhaber', href: '/safaris/8-days-honeymoon-safari' }],
  },
  {
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'Eine private Villa, eine persönlichere Alternative zu einem gewöhnlichen Hotelaufenthalt vor oder nach dem Busch.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Zentraler Serengeti',
    description: 'Ein Zeltcamp in den Ebenen mit einer gehobenen Suitenkategorie neben den Standardzelten.',
    ...
    featuredIn: [{ label: '11 Tage Ruanda-Tansania-Safari', href: '/safaris/11-days-rwanda-tanzania' }, { label: '12 Tage Tansania-Kenia-Expedition', href: '/safaris/12-days-tanzania-kenya' }, { label: '12-Tage-Safari in Tansania für Senioren, Jubiläen und Gruppen', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '5 Tage Highlights-Safari', href: '/safaris/5-days-highlights-safari' }, { label: '5 Tage Serengeti Fly-In-Safari', href: '/safaris/5-day-serengeti-fly-in' }, { label: '7 Tage Kronjuwelen-Safari', href: '/safaris/7-days-crown-jewels' }, { label: '7 Tage Flug zur Ndutu-Migration', href: '/safaris/7-days-flight-ndutu' }, { label: '7 Tage Die Juwelen des Nordens', href: '/safaris/7-days-gems-of-north' }, { label: '7 Tage Serengeti & Ngorongoro Safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 Tage Flitterwochen-Safari — Für Naturliebhaber', href: '/safaris/8-days-honeymoon-safari' }, { label: '9-Tage-Flitterwochen-Safari & Sansibar-Strandurlaub', href: '/safaris/9-day-honeymoon-safari-zanzibar' }, { label: 'Kilimandscharo Lemosho-Besteigung & 5-Tage-Highlights-Safari', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }, { label: 'Tansania-Fotosafari — Tarangire, Ngorongoro-Krater & Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    ...
    description: 'In der Ol-Pejeta-Conservancy gelegen, Heimat des größten Schwarznashorn-Schutzgebiets Kenias und der letzten Nördlichen Breitmaulnashörner der Welt — ein wirklich seltenes Tierwelt-Prädikat.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Tarangire-Nationalpark',
    description: 'Ein unkompliziertes Zeltcamp auf der Tarangire-Route, gut gelegen für die dichten Elefantenherden des Parks, ohne Resort-Preis.',
    amenities: ['Zimmer mit eigenem Bad', 'Tierbeobachtung', 'Vollservice-Restaurant'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Tarangire-Nationalpark',
    description: 'Ein erhöhtes Luxuscamp auf der Tarangire-Route, Teil der Elewana Collection, mit Ausblicken auf Baumkronenhöhe über eine der dichtesten Elefantenlandschaften Afrikas.',
    amenities: ['Swimmingpool', 'Landschaftliche Aussicht', 'Spa', 'Tierbeobachtung'],
  ...
  },
  {
    ...
    description: 'Eine Conservancy-Lodge am Rand von Amboseli, die neben ihren eigenen Kilimandscharo-Blicken auf ein gemeinschaftliches Naturschutzprogramm setzt.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, Ngorongoro-Hochland',
    description: 'Ein Herrenhaus im Kolonialstil auf einer Kaffeeplantage nahe dem Kraterrand, das historische Architektur mit einer Küche verbindet, die ihren Ruf wirklich verdient.',
    ...
    featuredIn: [{ label: '10 Tage Luxus-Familiensafari in Tansania', href: '/safaris/10-days-luxury-family' }, { label: '10 Tage Safari & Sansibar-Strände', href: '/safaris/10-day-safari-zanzibar' }, { label: '7 Tage Kronjuwelen-Safari', href: '/safaris/7-days-crown-jewels' }, { label: 'Kenia & Tansania Highlights-Safari', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    slug: 'tloma-lodge',
    name: 'Tloma Lodge',
    tier: 'reserve',
    location: 'Karatu, Ngorongoro-Hochland',
    description: 'Eine Gartenlodge auf einer ehemaligen Kaffeeplantage vor den Toren Karatus, entspannt und nahe der Abstiegsstraße zum Krater.',
  ...
  },
  {
    ...
    description: 'Ein preisgünstiges Camp im Hochland, die vernünftige Wahl für Reisende, denen auf der Krater-Etappe einer längeren Reise vor allem der Preis wichtig ist.',
    amenities: ['Vollservice-Restaurant', 'Gartenanlage'],
    ...
    featuredIn: [{ label: '5 Tage Highlights-Safari', href: '/safaris/5-days-highlights-safari' }, { label: '8 Tage Mara-Fluss-Überquerungssafari', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Ruanda',
    description: 'Ein zentral gelegenes Hotel in Kigali, komfortabel und gut gelegen vor oder nach Ruandas Nationalparks.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Insel Sansibar',
    description: 'Ein Serena-Anwesen auf der Insel Sansibar, der Ankunftsstopp, an dem Ruandas Primaten-Trekking einer Reihe unverplanter Strandtage weicht.',
    amenities: ['Swimmingpool', 'Strandlage', 'Vollservice-Restaurant'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Tarangire-Region',
    description: 'Ein Zeltcamp auf der Tarangire-Route, verlässliche Führung und Tierbeobachtung zu einem wirklich mittleren Preis.',
    amenities: ['Vollservice-Restaurant', 'Kostenloses WLAN', 'Tierbeobachtung'],
