...
export const accommodations: Accommodation[] = [
  {
    ...
    description: "En fuldt mobil luksusteltlejr, der følger den store migration selv — du jager ikke flokkene, du vågner ganske enkelt op, hvor de befinder sig lige nu.",
    amenities: ['Luksuriøse teltsuiter', 'Værelser med eget badeværelse', 'Beliggenhed på migrationsruten', 'Restaurant med fuld betjening'],
    ...
    featuredIn: [{ label: 'Højdepunkter i Kenya & Tanzania-safari', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    ...
    description: "En masai-drevet lodge på Kilimanjaros vestlige skråninger, bygget op omkring ægte kulturel udveksling med det omkringliggende lokalsamfund frem for en iscenesat udgave af den.",
    amenities: ['Panoramaudsigt', 'Kulturelle oplevelser'],
    ...
    featuredIn: [{ label: '12-Dages Vildmarkssafari, Kulturmøder & Kilimanjaro-dagvandring', href: '/safaris/12-days-wild-wilderness' }],
  },
  {
    ...
    description: "Den eneste permanente lodge inde i selve Lake Manyara, med trætopsuiter hævet op i grundvandsskovens kroner — et ægte anderledes udsigtspunkt over parken end noget som helst i dens udkant.",
    amenities: ['Panoramaudsigt', 'Udsigt til dyreliv', 'Trætopsuiter', 'Beliggenhed i skovens trækroner', 'Værelser med eget badeværelse', 'Restaurant med fuld betjening'],
    ...
    featuredIn: [{ label: '12 dages Tanzania-Kenya-ekspedition', href: '/safaris/12-days-tanzania-kenya' }, { label: '7 dages nordens perler', href: '/safaris/7-days-gems-of-north' }, { label: 'Højdepunkter i Kenya & Tanzania-safari', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    slug: 'angama-mara',
    name: 'Angama Mara',
    ...
    description: "Beliggende højt oppe på Oloololo-skrænten med en udsigt over hele Mara-sletten, som er blevet et af de mest fotograferede udsigtspunkter i Østafrika — af gode grunde.",
    amenities: ['Swimmingpool', 'Panoramaudsigt', 'Spa', 'Beliggenhed på migrationsruten'],
    ...
    featuredIn: [{ label: "5 dages Kenya-safari — Hell’s Gate, Lake Nakuru & Masai Mara", href: '/safaris/5-day-kenya-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'En aktiv kaffeplantage tæt på lufthavnen, som forvandler den første eller sidste nat fra en formalitet til en ægte afslappet oplevelse.',
    amenities: ['Gratis wi-fi', 'Swimmingpool', 'Panoramaudsigt', 'Haveanlæg', 'Restaurant med fuld betjening'],
    ...
    featuredIn: [{ label: '10 Dages Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '10 Dages Tanzania Luksus-familiesafari', href: '/safaris/10-days-luxury-family' }, { label: '10 dages ultimativ migrationssafari — Mara-flodens krydsninger', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '12 dages Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '12 dages Tanzania-safari for seniorer, jubilæer & grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '7 Dages Crown Jewels-safari', href: '/safaris/7-days-crown-jewels' }, { label: '7 dages flyvning over Ndutu-migrationen', href: '/safaris/7-days-flight-ndutu' }, { label: '7 dages nordens perler', href: '/safaris/7-days-gems-of-north' }, { label: '7 Dages Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '7 dages foto- & eventyrsafari i Tanzania', href: '/safaris/7-day-photography-adventure-safari' }, { label: '8-dages safari til gnuernes flodkrydsning', href: '/safaris/8-days-flight-migration' }, { label: '8 Dages Den Store Nordlige Migration', href: '/safaris/8-days-great-northern-migration' }, { label: 'Kilimanjaro Lemosho-bestigning og 5 dages højdepunktssafari', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }],
  },
  {
    slug: 'bisate-lodge',
    name: 'Bisate Lodge',
    ...
    description: 'Kuppelformede skovvillaer indpasset i et genoprettet vulkansk amfiteater, en kort køretur fra gorillatrekkingens startpunkter — en af de mest roste lodger bygget i Afrika i dette årti.',
    amenities: ['Panoramaudsigt', 'Spa', 'Udsigt til dyreliv'],
    ...
    featuredIn: [{ label: '12 dages Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }],
  },
  {
    ...
    description: 'En teltlodge ved Tarangires grænse, placeret med henblik på tidlig adgang til et af Afrikas tættest befolkede elefantlandskaber.',
    amenities: ['Restaurant med fuld betjening', 'Gratis wi-fi', 'Udsigt til dyreliv'],
    ...
    featuredIn: [{ label: 'Tanzania fotosafari — Tarangire, Ngorongoro-krateret & Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Tarangire Nationalpark',
    description: 'En ukompliceret lejr, der bruger pengene dér, hvor de betyder mest på Tarangire-ruten: solid guidning, et velfungerende køkken og en fair pris frem for et resortbudget.',
    amenities: ['Restaurant med fuld betjening', 'Gratis wi-fi'],
    ...
    featuredIn: [{ label: '10 dages ultimativ migrationssafari — Mara-flodens krydsninger', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }],
  },
  {
    ...
    description: 'Et byhotel direkte ved stranden på Msasani-halvøen — ægte komfortabelt og det faste overnatningsstop på vej til eller fra den sydlige safarirute.',
    amenities: ['Swimmingpool', 'Restaurant med fuld betjening', 'Gratis wi-fi'],
    ...
    featuredIn: [{ label: '5 dages privat chimpansetrekking i Gombe', href: '/safaris/5-day-gombe-chimpanzee-trekking' }, { label: '7 dages Southern Circuit — Ruaha & Nyerere', href: '/safaris/7-day-southern-circuit' }, { label: 'Den ultimative Tanzania-safari & chimpansetrekking i Gombe', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
    ...
    description: 'Et all-inclusive strandresort på Zanzibars Nungwi-kyst, det afsluttende stop i Wilderness Reserve-niveauet på rejseplanen 10 dages Tanzania-safari & Zanzibar-strand.',
    amenities: ['All-inclusive', 'Swimmingpool', 'Direkte ved stranden', 'Restaurant med fuld betjening'],
    ...
    featuredIn: [{ label: '10 Dages Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }],
  ...
  },
  {
    ...
    description: 'En enkel base i Kigali uden dikkedarer for rejsende, der hellere vil bruge budgettet på rejsens gorillatrekking og primatoplevelser end på den første og sidste nat i byen.',
    amenities: ['Gratis wi-fi', 'Swimmingpool', 'Restaurant med fuld betjening'],
  ...
  },
  {
    ...
    description: 'Et pålideligt, velbeliggende hotel i Nairobi som indgangsport — den slags praktiske første eller sidste stop, der gør sit ene job godt, før eller efter parkerne tager over.',
    amenities: ['Gratis wi-fi', 'Swimmingpool', 'Restaurant med fuld betjening'],
    ...
    featuredIn: [{ label: '10 dages Kenya- & Tanzania-safari', href: '/safaris/10-day-kenya-tanzania-safari' }],
  },
  {
    ...
    description: 'Bygget op omkring en naturlig kilde, der trækker elefanter og andet dyreliv lige forbi stedet — en lejr i mellemklassen med en fordel i dyrelivsoplevelser, som de fleste lejre i mellemklassen ikke har.',
    amenities: ['Swimmingpool', 'Panoramaudsigt', 'Restaurant med fuld betjening'],
    ...
    featuredIn: [{ label: '7 dages foto- & eventyrsafari i Tanzania', href: '/safaris/7-day-photography-adventure-safari' }, { label: '10 Dages Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }],
  },
  {
    ...
    description: 'Et ægte spa-resort ved Naivasha-bredden — en rigtig dag til at sætte tempoet ned, bygget ind midt i en Rift Valley-rutine, ikke bare endnu en lodge mellem game drives.',
    amenities: ['Spa', 'Swimmingpool', 'Panoramaudsigt', 'Gratis wi-fi'],
  ...
  },
  {
    ...
    description: 'Bygget op omkring sit eget vandhul i hjertet af Serengeti, hvor dyrelivet jævnligt passerer lige under terrassen — Four Seasons-standarden, midt ude på sletterne.',
    amenities: ['Swimmingpool', 'Spa', 'Panoramaudsigt'],
    ...
    featuredIn: [{ label: '12 dages Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '12-Dages Vildmarkssafari, Kulturmøder & Kilimanjaro-dagvandring', href: '/safaris/12-days-wild-wilderness' }],
  },
  {
    slug: 'gibbs-farm',
    name: 'Gibb\'s Farm',
    tier: 'sovereign',
    location: 'Karatu, Ngorongoro-højlandet',
    description: 'En mangeårig økologisk gård under kraterranden, der stadig dyrker sin egen kaffe og sine egne afgrøder, og som bredt anses for at have et af Tanzanias fineste køkkener overhovedet — ikke kun blandt lodger.',
    amenities: ['Spa', 'Panoramaudsigt', 'Økologisk fra gård til bord'],
    ...
    featuredIn: [{ label: '10 dages ultimativ migrationssafari — Mara-flodens krydsninger', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '12 dages Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '12 dages Tanzania-safari for seniorer, jubilæer & grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '12-Dages Vildmarkssafari, Kulturmøder & Kilimanjaro-dagvandring', href: '/safaris/12-days-wild-wilderness' }, { label: '5 dages Serengeti fly-in safari', href: '/safaris/5-day-serengeti-fly-in' }, { label: '7 Dages Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 Dages Den Store Nordlige Migration', href: '/safaris/8-days-great-northern-migration' }, { label: '8-Dages Bryllupsrejsesafari — For Bushelskere', href: '/safaris/8-days-honeymoon-safari' }, { label: '9 dages bryllupsrejsesafari & strandferie på Zanzibar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }],
  },
  {
    slug: 'governors-camp',
    name: 'Governors Camp',
    tier: 'reserve',
    location: 'Masai Mara, Kenya',
    description: 'Den oprindelige luksusteltlejr i Mara, i uafbrudt drift siden 1972, på bredden af Mara-floden i en af reservatets mest pålidelige dyrelivskorridorer — et ikon, ikke et budgetstop.',
    amenities: ['Gratis wi-fi', 'Swimmingpool', 'Restaurant med fuld betjening', 'Udsigt over Mara-floden'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'Meliás eget luksus-undermærke, tæt på lufthavnen — fulde resortfaciliteter og ægte finish for rejsende, der ønsker mere komfort før eller efter bushen.',
    amenities: ['Gratis wi-fi', 'Swimmingpool', 'Spa'],
    ...
    featuredIn: [{ label: '10 Dages Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '10 Dages Tanzania Luksus-familiesafari', href: '/safaris/10-days-luxury-family' }, { label: '12 dages Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '12-Dages Vildmarkssafari, Kulturmøder & Kilimanjaro-dagvandring', href: '/safaris/12-days-wild-wilderness' }, { label: '7 Dages Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '7 dages foto- & eventyrsafari i Tanzania', href: '/safaris/7-day-photography-adventure-safari' }, { label: '8 Dages Den Store Nordlige Migration', href: '/safaris/8-days-great-northern-migration' }, { label: '8-dages safari til gnuernes flodkrydsning', href: '/safaris/8-days-flight-migration' }, { label: 'Southern Edition: Tanzanias kælvningssæson-migrationssafari — Ndutu & Ngorongoro-krateret', href: '/safaris/7-days-migration-southern' }, { label: 'Tanzania fotosafari — Tarangire, Ngorongoro-krateret & Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    ...
    description: 'Beliggende direkte på skrænten og kombinerer vidtstrakt udsigt over dalen med fulde golf- og spafaciliteter, som de fleste safaristeder ganske enkelt ikke tilbyder.',
    amenities: ['Swimmingpool', 'Panoramaudsigt', 'Spa', 'Udsigt over Rift Valley'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Nairobi, Kenya',
    description: 'Et boutiquehotel i kolonistil i Karen, en del af den internationalt anerkendte Hemingways Collection — ægte komfortabelt frem for blot bekvemt, i begge ender af en Kenya-safari.',
    amenities: ['Swimmingpool', 'Spa', 'Restaurant med fuld betjening', 'Gratis wi-fi'],
    ...
    featuredIn: [{ label: '11 dage: Kenya uden sidestykke', href: '/safaris/11-days-kenya-undisputed' }, { label: '12 dages Tanzania-Kenya-ekspedition', href: '/safaris/12-days-tanzania-kenya' }, { label: 'Autentisk, eksklusivt Kenya — Amboseli, Samburu & Masai Mara', href: '/safaris/authentic-exclusive-kenya' }, { label: 'Klassisk Kenya-safari — Masai Mara, Rift Valley & Amboseli', href: '/safaris/classic-kenya-safari' }, { label: 'Højdepunkter i Kenya & Tanzania-safari', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    ...
    description: 'En lejr i skovkanten bygget til vandring og primatsporing i en af Tanzanias mindst besøgte og mest givende parker for rejsende, der vil have noget ud over standardruten.',
    amenities: ['Haveanlæg', 'Panoramaudsigt'],
    ...
    featuredIn: [{ label: '10 dage: Det sydlige Tanzanias hemmeligheder', href: '/safaris/10-days-southern-secrets' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Dar es Salaam',
    description: 'Et hotel ved vandet med fuld service, der bruges som komfortabelt transitstop på rejseplaner ad den sydlige safarirute — et stærkt valg i den øvre klasse, på samme mærkeniveau som Radisson Blu.',
    amenities: ['Swimmingpool', 'Restaurant med fuld betjening', 'Gratis wi-fi'],
    ...
    featuredIn: [{ label: '7 dages Southern Circuit — Ruaha & Nyerere', href: '/safaris/7-day-southern-circuit' }],
  },
  {
    slug: 'ikuka-camp',
    name: 'Ikuka Camp',
    ...
    description: 'En privat lejr på en klippeknold over Ruaha-floden, i en af Tanzanias største og mindst overrendte parker.',
    amenities: ['Panoramaudsigt', 'Udsigt til dyreliv', 'Restaurant med fuld betjening'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Volcanoes Nationalpark, Rwanda',
    description: 'En budgetvenlig lodge lige ved grænsen til Volcanoes Nationalpark, bevidst placeret med henblik på de tidlige afgange, en morgen med gorillatrekking kræver.',
    amenities: ['Restaurant med fuld betjening', 'Haveanlæg'],
    ...
    featuredIn: [{ label: '4 dages gorillatrekking i Rwanda', href: '/safaris/4-day-rwanda-gorilla-trekking' }, { label: 'Rwanda-primatsafari og badeferie på Zanzibar', href: '/safaris/12-days-rwanda-primates' }],
  },
  {
    slug: 'kahawa-house',
    name: 'Kahawa House',
    tier: 'trail',
    location: 'Arusha',
    description: 'Et afslappet gæstehus på en aktiv kaffeplantage uden for Arusha — en ægte rolig og veldrevet første eller sidste nat før eller efter bushen.',
    amenities: ['Gratis wi-fi', 'Restaurant med fuld betjening', 'Haveanlæg'],
    ...
    featuredIn: [{ label: '10 Dages Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '10 dages Kenya- & Tanzania-safari', href: '/safaris/10-day-kenya-tanzania-safari' }, { label: '10 dages ultimativ migrationssafari — Mara-flodens krydsninger', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '12 dages Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '12 dages Tanzania-safari for seniorer, jubilæer & grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '12-Dages Vildmarkssafari, Kulturmøder & Kilimanjaro-dagvandring', href: '/safaris/12-days-wild-wilderness' }, { label: '4 dages Tarangire, Ngorongoro & Lake Eyasi', href: '/safaris/4-day-tarangire-ngorongoro-lake-eyasi' }, { label: '5 dages Serengeti fly-in safari', href: '/safaris/5-day-serengeti-fly-in' }, { label: '5 dages komfortsafari i Tanzania', href: '/safaris/5-day-comfort-tanzania-safari' }, { label: '5 dages Kilimanjaro-forlængelsessafari', href: '/safaris/kilimanjaro-extension-safari' }, { label: '6 dages komfort-safari i Tanzania', href: '/safaris/6-day-comfort-tanzania-safari' }, { label: '7 Dages Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 Dages Den Store Nordlige Migration', href: '/safaris/8-days-great-northern-migration' }, { label: '8-Dages Bryllupsrejsesafari — For Bushelskere', href: '/safaris/8-days-honeymoon-safari' }, { label: '8-dages safari til gnuernes flodkrydsning', href: '/safaris/8-days-flight-migration' }, { label: 'Kilimanjaro Lemosho-bestigning og 5 dages højdepunktssafari', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }, { label: 'Southern Edition: Tanzanias kælvningssæson-migrationssafari — Ndutu & Ngorongoro-krateret', href: '/safaris/7-days-migration-southern' }, { label: 'Tanzania fotosafari — Tarangire, Ngorongoro-krateret & Serengeti', href: '/safaris/tanzania-photographic-safari' }, { label: 'Den ultimative Tanzania-safari & chimpansetrekking i Gombe', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
    slug: 'kambi-ya-tembo',
    name: 'Kambi ya Tembo',
    tier: 'reserve',
    location: 'Vestlige Kilimanjaro',
    description: 'En teltlejr på privat jord ved Kilimanjaros fod, kendt for de fastboende elefantflokke, der passerer lige gennem lejren, og en bjergkulisse, der ikke behøver nogen udsmykning.',
    amenities: ['Panoramaudsigt', 'Udsigt til dyreliv'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenya',
    description: '&Beyonds egen mere tilgængelige Mara-lejr — den fulde andBeyond-standard for gæstfrihed og beliggenhed, til en mærkbart mildere pris end deres signaturejendomme.',
    amenities: ['Udsigt til dyreliv', 'Panoramaudsigt', 'Swimmingpool', 'Spa', 'Beliggenhed på migrationsruten', 'Restaurant med fuld betjening'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Rwanda',
    description: 'Et centralt hotel i Kigali med Serenas konsekvente 5-stjernede standard — et ægte komfortabelt overnatningsstop før eller efter gorillatrekking i Virunga-bjergene, ikke en budgetudfylder.',
    amenities: ['Gratis wi-fi', 'Swimmingpool', 'Restaurant med fuld betjening'],
  ...
  },
  {
    ...
    name: 'Kigoma Hilltop',
    tier: 'trail',
    location: 'Kigoma, Tanganyikasøen',
    description: 'En lodge på en bjergskråning med ægte udsigt over Tanganyikasøen, der fungerer som indgangsport til en af Tanzanias mest afsidesliggende og givende oplevelser: chimpansetrekking i Gombe og Mahale.',
    amenities: ['Panoramaudsigt', 'Restaurant med fuld betjening'],
    ...
    featuredIn: [{ label: '5 dages privat chimpansetrekking i Gombe', href: '/safaris/5-day-gombe-chimpanzee-trekking' }, { label: 'Den ultimative Tanzania-safari & chimpansetrekking i Gombe', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
    slug: 'kilindi-zanzibar',
    name: 'Kilindi Zanzibar',
    tier: 'sovereign',
    location: 'Zanzibar-øen',
    description: 'Kuppelformede private pavilloner indpasset i skråningen over Det Indiske Ocean, hver med sin egen plunge pool — et bevidst temposkift efter dage i bushen.',
    amenities: ['Swimmingpool', 'Spa', 'Direkte ved stranden', 'All-inclusive', 'Panoramaudsigt'],
    ...
    featuredIn: [{ label: '10 Dages Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '11 dage: Sydens dyreliv & krydderiøerne', href: '/safaris/11-days-southern-spice' }, { label: '12 dages Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '9 dages bryllupsrejsesafari & strandferie på Zanzibar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Volcanoes Nationalpark, Rwanda',
    description: 'Et ukompliceret gæstehus ved porten til Volcanoes Nationalpark, bygget specifikt op omkring de tidlige afgange, en morgen med gorillatrekking kræver.',
    amenities: ['Panoramaudsigt', 'Haveanlæg', 'Værelser med eget badeværelse', 'Restaurant med fuld betjening'],
    ...
    featuredIn: [{ label: '11 dages Rwanda-Tanzania-safari', href: '/safaris/11-days-rwanda-tanzania' }, { label: '12 dages Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }],
  },
  {
    ...
    description: 'En teltlejr på Rift Valley-skrænten med en udsigt, der taler for sig selv — dalbunden strækker sig ud nedenfor, så langt øjet rækker.',
    amenities: ['Gratis wi-fi', 'Restaurant med fuld betjening', 'Udsigt over Rift Valley', 'Swimmingpool'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Lake Eyasi',
    description: 'En lille teltlejr ved Lake Eyasi, den sædvanlige og bedst placerede base for besøg hos hadzabe-folkets jæger-samler-samfund.',
    amenities: ['Panoramaudsigt', 'Haveanlæg'],
    ...
    featuredIn: [{ label: '11 dages Rwanda-Tanzania-safari', href: '/safaris/11-days-rwanda-tanzania' }],
  },
  {
    slug: 'kitela-lodge',
    name: 'Kitela Lodge',
    tier: 'reserve',
    location: 'Karatu, Ngorongoro-højlandet',
    description: 'En tidligere kaffeplantage med brede verandaer vendt mod Rift Valley-skrænten og et køkken, der virkelig er værd at tale om, tæt på vejen til kraterranden.',
    amenities: ['Swimmingpool', 'Panoramaudsigt', 'Restaurant med fuld betjening', 'Haveanlæg'],
    ...
    featuredIn: [{ label: '10 Dages Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '10 Dages Tanzania Luksus-familiesafari', href: '/safaris/10-days-luxury-family' }, { label: '11 dages Rwanda-Tanzania-safari', href: '/safaris/11-days-rwanda-tanzania' }, { label: '12 dages Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '12 dages Tanzania-Kenya-ekspedition', href: '/safaris/12-days-tanzania-kenya' }, { label: '5 Dages Højdepunkter-safari', href: '/safaris/5-days-highlights-safari' }, { label: '5 dages Serengeti fly-in safari', href: '/safaris/5-day-serengeti-fly-in' }, { label: '7 Dages Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 Dages Den Store Nordlige Migration', href: '/safaris/8-days-great-northern-migration' }, { label: 'Kilimanjaro Lemosho-bestigning og 5 dages højdepunktssafari', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }],
  },
  {
    ...
    description: 'En pålidelig teltlodge, der bruges på både Tarangire- og det centrale Serengeti-ben af flere af vores rejseplaner — solid guidning til en fair pris, hver gang.',
    amenities: ['Swimmingpool', 'Panoramaudsigt', 'Restaurant med fuld betjening', 'Gratis wi-fi', 'All-inclusive', 'Værelser med eget badeværelse'],
    ...
    featuredIn: [{ label: '10 Dages Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '10 Dages Tanzania Luksus-familiesafari', href: '/safaris/10-days-luxury-family' }, { label: '10 dages Kenya- & Tanzania-safari', href: '/safaris/10-day-kenya-tanzania-safari' }, { label: '10 dages ultimativ migrationssafari — Mara-flodens krydsninger', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '12 dages Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '12 dages Tanzania-safari for seniorer, jubilæer & grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '12-Dages Vildmarkssafari, Kulturmøder & Kilimanjaro-dagvandring', href: '/safaris/12-days-wild-wilderness' }, { label: '5 dages Serengeti fly-in safari', href: '/safaris/5-day-serengeti-fly-in' }, { label: '5 dages komfortsafari i Tanzania', href: '/safaris/5-day-comfort-tanzania-safari' }, { label: '6 dages komfort-safari i Tanzania', href: '/safaris/6-day-comfort-tanzania-safari' }, { label: '7 Dages Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8-dages safari til gnuernes flodkrydsning', href: '/safaris/8-days-flight-migration' }, { label: '8 Dages Den Store Nordlige Migration', href: '/safaris/8-days-great-northern-migration' }, { label: '9 dages bryllupsrejsesafari & strandferie på Zanzibar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }, { label: 'Højdepunkter i Kenya & Tanzania-safari', href: '/safaris/kenya-tanzania-highlights-safari' }, { label: 'Tanzania fotosafari — Tarangire, Ngorongoro-krateret & Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    slug: 'la-palme-hotel',
    name: 'La Palme Hotel',
    ...
    description: 'En komfortabel, central base i Musanze, før du tager ud for at spore gorillaer i Volcanoes.',
    amenities: ['Gratis wi-fi', 'Restaurant med fuld betjening', 'Haveanlæg'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Centrale Serengeti',
    description: 'En teltlejr i hjertet af sletterne, med kort afstand til noget af økosystemets mest pålidelige dyreliv året rundt.',
    amenities: ['Panoramaudsigt', 'Restaurant med fuld betjening', 'Udsigt til dyreliv'],
    ...
    featuredIn: [{ label: '5 Dages Højdepunkter-safari', href: '/safaris/5-days-highlights-safari' }, { label: 'Kilimanjaro Lemosho-bestigning og 5 dages højdepunktssafari', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Tarangire Nationalpark',
    description: 'En teltlodge ved bredden af Lake Burunge, på Tarangires grænse, bedst kendt blandt gæsterne for sin solnedgangsudsigt lige ud over vandet.',
    amenities: ['Restaurant med fuld betjening', 'Haveanlæg', 'Swimmingpool', 'Gratis wi-fi', 'Udsigt over søen'],
    ...
    featuredIn: [{ label: '8 Dages Den Store Nordlige Migration', href: '/safaris/8-days-great-northern-migration' }, { label: '12 dages Tanzania-safari for seniorer, jubilæer & grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '5 dages komfortsafari i Tanzania', href: '/safaris/5-day-comfort-tanzania-safari' }, { label: '5 dages Kilimanjaro-forlængelsessafari', href: '/safaris/kilimanjaro-extension-safari' }, { label: '6 dages komfort-safari i Tanzania', href: '/safaris/6-day-comfort-tanzania-safari' }],
  },
  {
    ...
    description: 'En Serena-teltlejr ved en roligere Rift Valley-sø end dens mere travle naboer.',
    amenities: ['Panoramaudsigt', 'Restaurant med fuld betjening', 'Udsigt over søen', 'Gratis wi-fi'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kivu-søen, Rwanda',
    description: 'Et Serena-hotel ved søbredden, som regel det afsluttende stop på en Rwanda-rejseplan, når primattrekkingens etaper er overstået.',
    amenities: ['Swimmingpool', 'Panoramaudsigt', 'Restaurant med fuld betjening'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Lake Naivasha, Kenya',
    description: 'Et pålideligt resort ved søbredden, velplaceret for bådture til Crescent Island og gåsafarier — den slags komfortable ophold uden overraskelser, som Sopas steder er kendt for i hele Østafrika.',
    amenities: ['Gratis wi-fi', 'Swimmingpool', 'Restaurant med fuld betjening', 'Udsigt over søen'],
  ...
  },
  {
    ...
    description: 'Inde i selve parken, historisk kendt for sin flamingokantede bred og fastboende næsehornsbestand.',
    amenities: ['Panoramaudsigt', 'Restaurant med fuld betjening', 'Gratis wi-fi'],
    ...
    featuredIn: [{ label: '11 dage: Kenya uden sidestykke', href: '/safaris/11-days-kenya-undisputed' }, { label: '12 dages Tanzania-Kenya-ekspedition', href: '/safaris/12-days-tanzania-kenya' }, { label: "5 dages Kenya-safari — Hell’s Gate, Lake Nakuru & Masai Mara", href: '/safaris/5-day-kenya-safari' }, { label: 'Klassisk Kenya-safari — Masai Mara, Rift Valley & Amboseli', href: '/safaris/classic-kenya-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Lake Nakuru Nationalpark, Kenya',
    description: 'Beliggende højt over søen med ægte panoramaudsigt og den samme pålidelige Sopa-standard, som findes på deres andre østafrikanske steder.',
    amenities: ['Gratis wi-fi', 'Swimmingpool', 'Restaurant med fuld betjening', 'Panoramaudsigt'],
  ...
  },
  {
    ...
    description: 'En privat lejr på en bakketop direkte over Mara-flodens krydsningssteder — en af de bedst placerede lejre på højdedraget for rejsende, der timer deres rejse efter selve krydsningerne.',
    amenities: ['Swimmingpool', 'Panoramaudsigt', 'Udsigt til dyreliv', 'Spa'],
    ...
    featuredIn: [{ label: '10 dages ultimativ migrationssafari — Mara-flodens krydsninger', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '8 Dages Den Store Nordlige Migration', href: '/safaris/8-days-great-northern-migration' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Tarangire Nationalpark',
    description: 'En privat teltlejr med udsigt over Tarangire-floden, i et af Afrikas tættest befolkede elefantlandskaber uden for regntiden.',
    amenities: ['All-inclusive', 'Spa', 'Panoramaudsigt', 'Udsigt til dyreliv'],
    ...
    featuredIn: [{ label: '10 Dages Tanzania Luksus-familiesafari', href: '/safaris/10-days-luxury-family' }, { label: '7 dages nordens perler', href: '/safaris/7-days-gems-of-north' }, { label: '8 Dages Den Store Nordlige Migration', href: '/safaris/8-days-great-northern-migration' }, { label: '8-dages safari til gnuernes flodkrydsning', href: '/safaris/8-days-flight-migration' }],
  },
  {
    slug: 'lemala-osonjoi',
    name: 'Lemala Osonjoi',
    tier: 'sovereign',
    location: 'Ngorongoro-beskyttelsesområdet',
    description: 'En privat teltlejr tæt på nedkørselsvejen, som bringer gæsterne ned på kraterbunden, før de fleste andre lejre er færdige med morgenmaden.',
    amenities: ['Spa', 'Panoramaudsigt', 'Restaurant med fuld betjening'],
    ...
    featuredIn: [{ label: '10 Dages Tanzania Luksus-familiesafari', href: '/safaris/10-days-luxury-family' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Zanzibar-øen',
    description: 'Et enkelt, velbeliggende gæstehus for rejsende, der forlænger turen til Zanzibars strande uden at forlænge budgettet.',
    amenities: ['Restaurant med fuld betjening', 'Direkte ved stranden'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Nordlige Serengeti / Mara-grænsen, Tanzania',
    description: 'En klassisk teltlejr drevet enkelt og ærligt, placeret med henblik på de tidlige morgener, der gør forskellen på en game drive i Mara-økosystemet.',
    amenities: ['Værelser med eget badeværelse', 'Udsigt til dyreliv'],
    ...
    featuredIn: [{ label: '8 Dages Den Store Nordlige Migration', href: '/safaris/8-days-great-northern-migration' }, { label: '8-dages safari til gnuernes flodkrydsning', href: '/safaris/8-days-flight-migration' }],
  },
  {
    slug: 'mara-mara-tented-lodge',
    name: 'Mara Mara Tented Lodge',
    tier: 'reserve',
    location: 'Nordlige Serengeti / grænsen til Masai Mara',
    description: 'En teltlodge tæt på grænseområdet mellem Kenya og Tanzania, placeret specifikt med henblik på migrationens flodkrydsningssæson.',
    amenities: ['Udsigt til dyreliv', 'Panoramaudsigt', 'Restaurant med fuld betjening'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenya',
    description: 'En Serena-lodge på en bakketop med vidtstrakt udsigt over reservatets sletter og floden nedenfor.',
    amenities: ['Gratis wi-fi', 'Swimmingpool', 'Restaurant med fuld betjening', 'Panoramaudsigt'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Nordlige Serengeti',
    description: 'En mobil teltlejr, der flytter med selve migrationen gennem det nordlige Serengeti og Mara-grænsen.',
    amenities: ['Udsigt til dyreliv', 'Panoramaudsigt'],
    ...
    featuredIn: [{ label: 'Tanzania fotosafari — Tarangire, Ngorongoro-krateret & Serengeti', href: '/safaris/tanzania-photographic-safari' }, { label: '8-dages safari til gnuernes flodkrydsning', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Masai Mara, Kenya',
    description: 'En stor, veletableret lodge tæt på migrationens flodkrydsningskorridor — solid Sopa-pålidelighed med en virkelig stærk beliggenhed bag sig.',
    amenities: ['Gratis wi-fi', 'Swimmingpool', 'Restaurant med fuld betjening', 'Udsigt over Mara-floden', 'Beliggenhed på migrationsruten'],
    ...
    featuredIn: [{ label: '10 dages Kenya- & Tanzania-safari', href: '/safaris/10-day-kenya-tanzania-safari' }, { label: "5 dages Kenya-safari — Hell’s Gate, Lake Nakuru & Masai Mara", href: '/safaris/5-day-kenya-safari' }],
  },
  {
    slug: 'masek-tented-lodge',
    name: 'Masek Tented Lodge',
    tier: 'reserve',
    location: 'Ndutu, Sydlige Serengeti',
    description: 'En teltlejr nær Lake Masek, lige i hjertet af gnuernes kælvningssæson hvert år.',
    amenities: ['Panoramaudsigt', 'Udsigt til dyreliv', 'Værelser med eget badeværelse'],
    ...
    featuredIn: [{ label: '7 dages flyvning over Ndutu-migrationen', href: '/safaris/7-days-flight-ndutu' }, { label: '7 dages foto- & eventyrsafari i Tanzania', href: '/safaris/7-day-photography-adventure-safari' }],
  },
  {
    ...
    description: 'En lille teltlejr ved Tanganyikasøens bred, den praktiske og komfortable base for chimpansetrekking i Gombe.',
    amenities: ['Udsigt til dyreliv', 'Værelser med eget badeværelse'],
  ...
  },
  {
    ...
    description: 'Med udsigt over Mikumis åbne flodslette — en af de mest tilgængelige parker på den sydlige safarirute, med en lodge, der matcher dens lethed.',
    amenities: ['Swimmingpool', 'Panoramaudsigt', 'Restaurant med fuld betjening'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Nyungwe-skoven, Rwanda',
    description: 'En økolodge i udkanten af Nyungwe-skoven, tæt på stierne til chimpansetrekking gennem en af Afrikas ældste bjergregnskove.',
    amenities: ['Restaurant med fuld betjening', 'Udsigt til dyreliv', 'Udsigt over skoven'],
    ...
    featuredIn: [{ label: 'Rwanda-primatsafari og badeferie på Zanzibar', href: '/safaris/12-days-rwanda-primates' }],
    needsPhotography: true,
  },
  {
    ...
    tier: 'reserve',
    location: 'Ndutu, Sydlige Serengeti',
    description: 'En sæsonbestemt teltlejr timet præcist efter gnuernes kælvningssæson hvert år.',
    amenities: ['Værelser med eget badeværelse', 'Udsigt til dyreliv'],
    ...
    featuredIn: [{ label: 'Southern Edition: Tanzanias kælvningssæson-migrationssafari — Ndutu & Ngorongoro-krateret', href: '/safaris/7-days-migration-southern' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Ndutu, Sydlige Serengeti',
    description: 'En permanent lodge i sten og stråtag med 34 hytter med udsigt over Lake Ndutu, placeret med henblik på adgang året rundt til de fastboende rovdyr, der aldrig rejser, når migrationen drager videre.',
    amenities: ['Værelser med eget badeværelse', 'Udsigt til dyreliv', 'Restaurant med fuld betjening', 'Panoramaudsigt'],
    ...
    featuredIn: [{ label: '8 dages fotosafari uden for alfarvej', href: '/safaris/off-the-beaten-track-photography-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Karatu, Ngorongoro-højlandet',
    description: 'En aktiv kaffefarm, der er blevet til en lodge blandt bananlunde på kraterranden — afslappet og hjemlig af natur, uden ambitioner om at være noget mere storslået.',
    amenities: ['Restaurant med fuld betjening', 'Haveanlæg', 'Gratis wi-fi', 'Højlandshaver', 'Aktiv landbrugsgård', 'Swimmingpool'],
    ...
    featuredIn: [{ label: '10 dages Kenya- & Tanzania-safari', href: '/safaris/10-day-kenya-tanzania-safari' }, { label: '10 dages ultimativ migrationssafari — Mara-flodens krydsninger', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '12 dages Tanzania-safari for seniorer, jubilæer & grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '12-Dages Vildmarkssafari, Kulturmøder & Kilimanjaro-dagvandring', href: '/safaris/12-days-wild-wilderness' }, { label: '4 dages Tarangire, Ngorongoro & Lake Eyasi', href: '/safaris/4-day-tarangire-ngorongoro-lake-eyasi' }, { label: '5 Dages Højdepunkter-safari', href: '/safaris/5-days-highlights-safari' }, { label: '5 dages komfortsafari i Tanzania', href: '/safaris/5-day-comfort-tanzania-safari' }, { label: '6 dages komfort-safari i Tanzania', href: '/safaris/6-day-comfort-tanzania-safari' }, { label: '7 Dages Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 Dages Den Store Nordlige Migration', href: '/safaris/8-days-great-northern-migration' }, { label: '9 dages bryllupsrejsesafari & strandferie på Zanzibar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }, { label: 'Højdepunkter i Kenya & Tanzania-safari', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, Ngorongoro-højlandet',
    description: 'En mellemklasse-lodge i højlandet med nem adgang til nedkørslen til krateret for tidlige game drives.',
    amenities: ['Panoramaudsigt', 'Restaurant med fuld betjening', 'Værelser med eget badeværelse'],
    ...
    featuredIn: [{ label: '10 Dages Tanzania Luksus-familiesafari', href: '/safaris/10-days-luxury-family' }, { label: '7 dages foto- & eventyrsafari i Tanzania', href: '/safaris/7-day-photography-adventure-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Ngorongoro-beskyttelsesområdet',
    description: 'Beliggende direkte på kraterranden, blandt de steder, der ligger tættest på nedkørselsvejen, med ægte, uhindret udsigt over krateret.',
    amenities: ['Panoramaudsigt', 'Spa', 'Restaurant med fuld betjening', 'Værelser med eget badeværelse'],
    ...
    featuredIn: [{ label: '12-Dages Vildmarkssafari, Kulturmøder & Kilimanjaro-dagvandring', href: '/safaris/12-days-wild-wilderness' }, { label: '5 Dages Højdepunkter-safari', href: '/safaris/5-days-highlights-safari' }, { label: '7 dages foto- & eventyrsafari i Tanzania', href: '/safaris/7-day-photography-adventure-safari' }, { label: '8-dages safari til gnuernes flodkrydsning', href: '/safaris/8-days-flight-migration' }, { label: 'Kilimanjaro Lemosho-bestigning og 5 dages højdepunktssafari', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }, { label: 'Southern Edition: Tanzanias kælvningssæson-migrationssafari — Ndutu & Ngorongoro-krateret', href: '/safaris/7-days-migration-southern' }, { label: 'Tanzania fotosafari — Tarangire, Ngorongoro-krateret & Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Ngorongoro-beskyttelsesområdet',
    description: 'En stenbygget Serena-lodge skåret ind i kraterets skovklædte rand, med værelser, der ser lige ned i Ngorongoro-kraterets bund.',
    amenities: ['Panoramaudsigt', 'Restaurant med fuld betjening', 'Værelser med eget badeværelse'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Nungwi, Zanzibar',
    description: 'Et sted direkte ved stranden på Zanzibars nordspids, kendt blandt gæsterne for roligt badevand og pålideligt smukke solnedgange.',
    amenities: ['Swimmingpool', 'Panoramaudsigt', 'Restaurant med fuld betjening', 'Gratis wi-fi'],
    ...
    featuredIn: [{ label: '7 Dages Crown Jewels-safari', href: '/safaris/7-days-crown-jewels' }, { label: '9 dages bryllupsrejsesafari & strandferie på Zanzibar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }, { label: '10 Dages Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: 'Rwanda-primatsafari og badeferie på Zanzibar', href: '/safaris/12-days-rwanda-primates' }],
  },
  {
    slug: 'ol-tukai-lodge',
    name: 'Ol Tukai Lodge',
    ...
    description: 'Inde i selve parken, med noget af den mest konsekvent pålidelige udsigt til Kilimanjaro af alle steder i Amboseli — en reel forskel i denne prisklasse.',
    amenities: ['Panoramaudsigt', 'Udsigt til dyreliv', 'Swimmingpool', 'Gratis wi-fi', 'Restaurant med fuld betjening', 'Udsigt til Kilimanjaro'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Nyungwe-skoven, Rwanda',
    description: 'Et globalt anerkendt ultra-luksusbrand beliggende på en aktiv teplantage i udkanten af Nyungwe — bygget op omkring chimpansetrekking og adgang til trætopstien snarere end gorillaer.',
    amenities: ['Panoramaudsigt', 'Spa', 'Restaurant med fuld betjening'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Vestlige Kilimanjaro',
    description: 'En masai-ejet lodge ved foden af Kilimanjaro, med en premium Kisiwa Boma-suitekategori ved siden af standardværelserne — et selvstændigt sted, adskilt fra den separat placerede Africa Amini Original Maasai Lodge.',
    amenities: ['Restaurant med fuld betjening', 'Haveanlæg', 'Panoramaudsigt'],
    ...
    featuredIn: [{ label: '12 dages Tanzania-safari for seniorer, jubilæer & grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Rwanda',
    description: 'Et internationalt hotel med fuld service i det centrale Kigali, et komfortabelt stop på vejen før eller efter Rwandas primattrekking.',
    amenities: ['Swimmingpool', 'Restaurant med fuld betjening', 'Gratis wi-fi', 'Spa'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Zanzibar-øen',
    description: 'Et all-inclusive resort direkte ved stranden, det klassiske afsluttende stop for safarier, der forlænges til øen.',
    amenities: ['All-inclusive', 'Direkte ved stranden', 'Swimmingpool', 'Panoramaudsigt'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Ruaha Nationalpark',
    description: 'Spredt langs Great Ruaha-floden i Tanzanias største nationalpark og en af dens mest oversete.',
    amenities: ['Panoramaudsigt', 'Udsigt til dyreliv', 'Restaurant med fuld betjening'],
    ...
    featuredIn: [{ label: '10 dage: Det sydlige Tanzanias hemmeligheder', href: '/safaris/10-days-southern-secrets' }, { label: '11 dage: Sydens dyreliv & krydderiøerne', href: '/safaris/11-days-southern-spice' }, { label: '7 dages Southern Circuit — Ruaha & Nyerere', href: '/safaris/7-day-southern-circuit' }],
  },
  {
    ...
    description: 'En lejr ved bredden af Rufiji-floden, basen for både game drives og bådsafarier på samme rejse.',
    amenities: ['Udsigt til dyreliv', 'Restaurant med fuld betjening', 'Panoramaudsigt'],
  ...
  },
  {
    ...
    description: 'Med udsigt over Lake Ihema i Akagera, Rwandas eget Big Five-rejsemål og et helt andet landskab end vulkanerne.',
    amenities: ['Panoramaudsigt', 'Udsigt til dyreliv'],
  ...
  },
  {
    ...
    description: 'Ved Ewaso Nyiro-floden, hjemsted for arter, der næsten ikke findes andre steder i Kenya — netgiraf, Grevys zebra, gerenuk.',
    amenities: ['Panoramaudsigt', 'Udsigt til dyreliv'],
    ...
    featuredIn: [{ label: '11 dage: Kenya uden sidestykke', href: '/safaris/11-days-kenya-undisputed' }, { label: 'Autentisk, eksklusivt Kenya — Amboseli, Samburu & Masai Mara', href: '/safaris/authentic-exclusive-kenya' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Nyerere Nationalpark (Selous)',
    description: 'Bygget ind i klipperne over Rufiji-floden og kun tilgængelig med småfly — afsides på en måde, få steder i denne klasse formår.',
    amenities: ['Restaurant med fuld betjening', 'Panoramaudsigt', 'Gratis wi-fi', 'Udsigt til dyreliv'],
    ...
    featuredIn: [{ label: '2 dages Nyerere-safari fra Zanzibar', href: '/safaris/2-day-selous-safari-from-zanzibar' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Lake Nakuru Nationalpark, Kenya',
    description: 'Højt beliggende inde i parken, med vid udsigt over søen og det dyreliv, den tiltrækker.',
    amenities: ['Gratis wi-fi', 'Swimmingpool', 'Restaurant med fuld betjening', 'Panoramaudsigt'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Nyerere Nationalpark (Selous)',
    description: 'En Serena-lodge over Rufiji-flodens strømfald, der kombinerer game drives med aktiviteter på floden under samme ophold.',
    amenities: ['All-inclusive', 'Swimmingpool', 'Udsigt til dyreliv'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Centrale Serengeti',
    description: 'En privat lejr bygget bevidst til et mindre og mere eksklusivt aftryk i økosystemet end de større steder i det centrale Serengeti.',
    amenities: ['Swimmingpool', 'Panoramaudsigt', 'Spa'],
    ...
    featuredIn: [{ label: '10 dages ultimativ migrationssafari — Mara-flodens krydsninger', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '10 Dages Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Centrale Serengeti',
    description: 'En klassisk teltlejr under akacietræernes kroner, lige i sletternes vildtrige hjerte — solid adgang uden den høje pris.',
    amenities: ['Værelser med eget badeværelse', 'Restaurant med fuld betjening', 'Udsigt til dyreliv'],
    ...
    featuredIn: [{ label: '5 Dages Højdepunkter-safari', href: '/safaris/5-days-highlights-safari' }, { label: '7 Dages Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 Dages Den Store Nordlige Migration', href: '/safaris/8-days-great-northern-migration' }, { label: '8-dages safari til gnuernes flodkrydsning', href: '/safaris/8-days-flight-migration' }, { label: '10 Dages Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '5 dages Kilimanjaro-forlængelsessafari', href: '/safaris/kilimanjaro-extension-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Centrale Serengeti',
    description: 'En ligefrem teltlejr med reel adgang til de centrale sletter, prissat til rejsende, der hellere vil bruge pengene på flere dage end på et finere telt.',
    amenities: ['Værelser med eget badeværelse', 'Restaurant med fuld betjening', 'Udsigt til dyreliv'],
    ...
    featuredIn: [{ label: '12 dages Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '8-Dages Bryllupsrejsesafari — For Bushelskere', href: '/safaris/8-days-honeymoon-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Ndutu, Sydlige Serengeti',
    description: 'En sæsonbestemt mobil lejr, der hvert år slås op ved Ndutu for at følge gnuernes kælvningssæson.',
    amenities: ['Værelser med eget badeværelse', 'Panoramaudsigt', 'Udsigt til dyreliv'],
    ...
    featuredIn: [{ label: '7 dages foto- & eventyrsafari i Tanzania', href: '/safaris/7-day-photography-adventure-safari' }, { label: 'Southern Edition: Tanzanias kælvningssæson-migrationssafari — Ndutu & Ngorongoro-krateret', href: '/safaris/7-days-migration-southern' }, { label: 'Tanzania fotosafari — Tarangire, Ngorongoro-krateret & Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Tarangire Nationalpark',
    description: 'En privat teltlejr hævet på pæle over Tarangires trætoppe, i elefantland året rundt.',
    amenities: ['Panoramaudsigt', 'Udsigt til dyreliv', 'Luksuriøse teltsuiter', 'Restaurant med fuld betjening', 'Swimmingpool'],
    ...
    featuredIn: [{ label: '10 dages ultimativ migrationssafari — Mara-flodens krydsninger', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '7 dages foto- & eventyrsafari i Tanzania', href: '/safaris/7-day-photography-adventure-safari' }, { label: '8-Dages Bryllupsrejsesafari — For Bushelskere', href: '/safaris/8-days-honeymoon-safari' }, { label: 'Tanzania fotosafari — Tarangire, Ngorongoro-krateret & Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'En privat villa, et mere personligt alternativ til et almindeligt hotelophold før eller efter bushen.',
    amenities: ['Swimmingpool', 'Spa', 'Panoramaudsigt', 'Gratis wi-fi'],
    ...
    featuredIn: [{ label: '5 dages Serengeti fly-in safari', href: '/safaris/5-day-serengeti-fly-in' }, { label: '8-Dages Bryllupsrejsesafari — For Bushelskere', href: '/safaris/8-days-honeymoon-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Centrale Serengeti',
    description: 'En teltlejr på sletterne med en premium suitekategori ved siden af standardteltene.',
    amenities: ['Gratis wi-fi', 'Panoramaudsigt', 'Restaurant med fuld betjening', 'Spa', 'Udsigt til dyreliv', 'Luksuriøse teltsuiter'],
    ...
    featuredIn: [{ label: '11 dages Rwanda-Tanzania-safari', href: '/safaris/11-days-rwanda-tanzania' }, { label: '12 dages Tanzania-Kenya-ekspedition', href: '/safaris/12-days-tanzania-kenya' }, { label: '12 dages Tanzania-safari for seniorer, jubilæer & grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '5 Dages Højdepunkter-safari', href: '/safaris/5-days-highlights-safari' }, { label: '5 dages Serengeti fly-in safari', href: '/safaris/5-day-serengeti-fly-in' }, { label: '7 Dages Crown Jewels-safari', href: '/safaris/7-days-crown-jewels' }, { label: '7 dages flyvning over Ndutu-migrationen', href: '/safaris/7-days-flight-ndutu' }, { label: '7 dages nordens perler', href: '/safaris/7-days-gems-of-north' }, { label: '7 Dages Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8-Dages Bryllupsrejsesafari — For Bushelskere', href: '/safaris/8-days-honeymoon-safari' }, { label: '9 dages bryllupsrejsesafari & strandferie på Zanzibar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }, { label: 'Kilimanjaro Lemosho-bestigning og 5 dages højdepunktssafari', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }, { label: 'Tanzania fotosafari — Tarangire, Ngorongoro-krateret & Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    ...
    description: 'Inde i Ol Pejeta, hjemsted for Kenyas største reservat for sorte næsehorn og verdens sidste nordlige hvide næsehorn — en virkelig sjælden dyrelivsreference.',
    amenities: ['Udsigt til dyreliv', 'Swimmingpool'],
    ...
    featuredIn: [{ label: '11 dage: Kenya uden sidestykke', href: '/safaris/11-days-kenya-undisputed' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Tarangire Nationalpark',
    description: 'En ligefrem teltlejr på Tarangire-ruten, velplaceret i forhold til parkens tætte elefantflokke uden resortpriser.',
    amenities: ['Værelser med eget badeværelse', 'Udsigt til dyreliv', 'Restaurant med fuld betjening'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Tarangire Nationalpark',
    description: 'En hævet luksuslejr på Tarangire-ruten, en del af Elewana Collection, med udsigt i trætopshøjde over et af Afrikas tætteste elefantlandskaber.',
    amenities: ['Swimmingpool', 'Panoramaudsigt', 'Spa', 'Udsigt til dyreliv'],
  ...
  },
  {
    ...
    description: 'En lodge i et privat naturreservat, der grænser op til Amboseli, bygget op omkring et lokalt naturbevaringsprogram og med sin egen udsigt til Kilimanjaro.',
    amenities: ['Swimmingpool', 'Spa', 'Udsigt til Kilimanjaro', 'Naturbevaringsprogram'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, Ngorongoro-højlandet',
    description: 'Et herregårdshus i kolonistil på en kaffeplantage nær kraterranden, der forener tidstypisk arkitektur med et køkken, der virkelig lever op til sit ry.',
    amenities: ['Panoramaudsigt', 'Restaurant med fuld betjening', 'Værelser med eget badeværelse', 'Swimmingpool', 'Spa', 'Arkitektur fra kolonitiden'],
    ...
    featuredIn: [{ label: '10 Dages Tanzania Luksus-familiesafari', href: '/safaris/10-days-luxury-family' }, { label: '10 Dages Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '7 Dages Crown Jewels-safari', href: '/safaris/7-days-crown-jewels' }, { label: 'Højdepunkter i Kenya & Tanzania-safari', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    slug: 'tloma-lodge',
    name: 'Tloma Lodge',
    tier: 'reserve',
    location: 'Karatu, Ngorongoro-højlandet',
    description: 'En havelodge på en tidligere kaffefarm uden for Karatu, afslappet og tæt på nedkørslen til krateret.',
    amenities: ['Gratis wi-fi', 'Restaurant med fuld betjening', 'Haveanlæg', 'Økologisk fra gård til bord'],
    ...
    featuredIn: [{ label: '12 dages Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '7 dages flyvning over Ndutu-migrationen', href: '/safaris/7-days-flight-ndutu' }, { label: '7 dages nordens perler', href: '/safaris/7-days-gems-of-north' }, { label: '8-Dages Bryllupsrejsesafari — For Bushelskere', href: '/safaris/8-days-honeymoon-safari' }],
  },
  {
    slug: 'tortils-ngorongoro-camp',
    name: 'Tortils Ngorongoro Camp',
    tier: 'trail',
    location: 'Ngorongoro-højlandet',
    description: 'En budgetvenlig lejr i højlandet, det fornuftige valg for rejsende, der prioriterer værdi for pengene på kraterdelen af en længere rejse.',
    amenities: ['Restaurant med fuld betjening', 'Haveanlæg'],
    ...
    featuredIn: [{ label: '5 Dages Højdepunkter-safari', href: '/safaris/5-days-highlights-safari' }, { label: '8-dages safari til gnuernes flodkrydsning', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Rwanda',
    description: 'Et centralt beliggende hotel i Kigali, komfortabelt og velplaceret før eller efter Rwandas nationalparker.',
    amenities: ['Gratis wi-fi', 'Restaurant med fuld betjening', 'Panoramaudsigt'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Zanzibar-øen',
    description: 'Et Serena-hotel på Zanzibar-øen, ankomststoppet hvor Rwandas primattrekking afløses af en række uplanlagte stranddage.',
    amenities: ['Swimmingpool', 'Direkte ved stranden', 'Restaurant med fuld betjening'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Tarangire-regionen',
    description: 'En teltlejr på Tarangire-ruten med pålidelig guidning og dyreobservation til en ægte mellemklassepris.',
    amenities: ['Restaurant med fuld betjening', 'Gratis wi-fi', 'Udsigt til dyreliv'],
    ...
    featuredIn: [{ label: '8-Dages Bryllupsrejsesafari — For Bushelskere', href: '/safaris/8-days-honeymoon-safari' }],
  },
]
