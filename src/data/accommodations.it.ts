...
export const accommodations: Accommodation[] = [
  {
    ...
    description: 'Un campo tendato di lusso completamente mobile che segue la Grande Migrazione stessa, così gli ospiti si svegliano ovunque si trovino le mandrie in quel momento.',
  ...
  },
  {
    ...
    description: 'Un lodge gestito dai Maasai sulle pendici occidentali del Kilimanjaro, costruito attorno a un autentico scambio culturale con la comunità circostante.',
  ...
  },
  {
    ...
    description: 'Suite in stile casa sull\'albero, sollevate nella volta forestale alimentata dalle acque sotterranee, nel cuore del Lago Manyara e non ai suoi margini.',
  ...
  },
  {
    ...
    description: 'Arroccato sul bordo dell\'escarpment di Oloololo, con una vista mozzafiato sull\'intera pianura del Mara — uno dei punti panoramici più fotografati dell\'Africa orientale.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'Una piantagione di caffè in attività alla periferia di Arusha, vicina all\'aeroporto, ideale per una prima o ultima notte rilassante prima o dopo la savana.',
  ...
  },
  {
    ...
    description: 'Ville a cupola inserite in un anfiteatro vulcanico restaurato, a breve distanza in auto dai punti di partenza per il trekking dei gorilla.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parco Nazionale di Tarangire',
    description: 'Un campo semplice e ben gestito sul circuito di Tarangire, per viaggiatori che cercano una guida solida senza pagare un prezzo premium.',
  ...
  },
  {
    ...
    description: 'Un hotel urbano sul lungomare della penisola di Msasani, utilizzato soprattutto come comoda tappa notturna in viaggio verso il circuito meridionale o al ritorno.',
    ...
    featuredIn: [{ label: '5 Giorni Trekking Privato agli Scimpanzé di Gombe', href: '/safaris/5-day-gombe-chimpanzee-trekking' }, { label: '7 Giorni Circuito del Sud — Ruaha e Nyerere', href: '/safaris/7-day-southern-circuit' }],
  },
  {
    ...
    description: 'Una base semplice ed economica a Kigali per viaggiatori che privilegiano il risparmio nelle tappe di trekking dei gorilla e dei primati di un viaggio in Ruanda.',
  ...
  },
  {
    ...
    description: 'Un hotel affidabile a Nairobi, utilizzato come tappa d\'ingresso prima di partire verso i parchi e le riserve del Kenya.',
    amenities: ['WiFi Gratuito', 'Piscina', 'Ristorante con Servizio Completo'],
  ...
  },
  {
    ...
    description: 'Un campo di fascia media costruito attorno a una sorgente naturale che attira elefanti e altra fauna fin quasi alla proprietà.',
    ...
    featuredIn: [{ label: 'Safari Fotografico e d\'Avventura di 7 Giorni in Tanzania', href: '/safaris/7-day-photography-adventure-safari' }],
  },
  {
    ...
    description: 'Un resort con spa sulle rive del Lago Naivasha, che offre una vera pausa tra una giornata di game drive e l\'altra nella Rift Valley.',
  ...
  },
  {
    ...
    description: 'Un lodge costruito attorno alla propria pozza d\'acqua nel cuore del Serengeti, dove la fauna selvatica passa regolarmente proprio sotto la terrazza.',
  ...
  },
  {
    ...
    description: 'Una storica tenuta agricola biologica sotto il bordo del cratere, che coltiva ancora il proprio caffè e i propri prodotti, ampiamente considerata una delle migliori cucine della Tanzania.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Masai Mara, Kenya',
    description: 'Un classico campo tendato sulle rive del Fiume Mara, in uno dei corridoi faunistici più affidabili della riserva.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Arusha',
    description: 'Un raffinato hotel urbano ad Arusha, con tutti i comfort di un resort, per viaggiatori che desiderano più comfort prima o dopo il proprio safari.',
  ...
  },
  {
    ...
    description: 'Un resort situato direttamente sull\'escarpment della Rift Valley, che unisce ampie vedute della valle a strutture complete di golf e spa.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Nairobi, Kenya',
    description: 'Un boutique hotel in stile coloniale nel sobborgo di Karen a Nairobi, una base davvero comoda all\'inizio o alla fine di un safari in Kenya.',
  ...
  },
  {
    ...
    description: 'Un campo ai margini della foresta, pensato per l\'escursionismo e il tracking dei primati sui Monti Udzungwa, uno dei parchi meno visitati della Tanzania.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Dar es Salaam',
    description: 'Un hotel urbano a servizio completo sul lungomare di Dar es Salaam, utilizzato come comoda tappa di transito negli itinerari del circuito meridionale.',
    amenities: ['Piscina', 'Ristorante con Servizio Completo', 'WiFi Gratuito'],
  ...
  },
  {
    ...
    description: 'Un campo privato su uno sperone roccioso con vista sul Fiume Ruaha, in uno dei parchi più grandi e meno affollati della Tanzania.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parco Nazionale dei Vulcani, Ruanda',
    description: 'Un lodge economico vicino al confine del Parco Nazionale dei Vulcani, posizionato per le partenze mattutine nei giorni di trekking dei gorilla.',
    ...
    featuredIn: [{ label: '4 Giorni Trekking dei Gorilla in Ruanda', href: '/safaris/4-day-rwanda-gorilla-trekking' }],
  },
  {
    slug: 'kahawa-house',
    name: 'Kahawa House',
    tier: 'trail',
    location: 'Arusha',
    description: 'Una guesthouse rilassata in una piantagione di caffè in attività appena fuori Arusha, una notte tranquilla prima o dopo la savana.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kilimanjaro Occidentale',
    description: 'Un campo tendato su terreno privato ai piedi del Kilimanjaro, noto per le sue mandrie di elefanti residenti e lo sfondo montuoso.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenya',
    description: 'Un campo tendato sul margine occidentale del Mara, vicino all\'escarpment di Oloololo e a portata dei punti di attraversamento del fiume.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Kigali, Ruanda',
    description: 'Un hotel centrale a Kigali, utilizzato come comoda tappa notturna prima o dopo il trekking dei gorilla nei Virunga.',
    amenities: ['WiFi Gratuito', 'Piscina', 'Ristorante con Servizio Completo'],
  ...
  },
  {
    ...
    description: 'Un lodge collinare con vista sul Lago Tanganica, la tappa d\'ingresso per il trekking degli scimpanzé a Gombe e Mahale.',
    ...
    featuredIn: [{ label: '5 Giorni Trekking Privato agli Scimpanzé di Gombe', href: '/safaris/5-day-gombe-chimpanzee-trekking' }],
  },
  {
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Parco Nazionale dei Vulcani, Ruanda',
    description: 'Una guesthouse semplice vicina all\'ingresso del Parco Nazionale dei Vulcani, pensata per le partenze mattutine del trekking dei gorilla.',
    ...
    featuredIn: [{ label: '11 Giorni Safari Ruanda Tanzania', href: '/safaris/11-days-rwanda-tanzania' }, { label: '12 Giorni Esperienza Primati in Ruanda', href: '/safaris/12-days-rwanda-primates' }, { label: '12 Giorni Ruanda, Tanzania e Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }],
  },
  {
    ...
    description: 'Un campo tendato sull\'escarpment della Rift Valley con vista sul Lago Manyara, con panorami che si estendono su tutto il fondovalle.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Lago Eyasi',
    description: 'Un piccolo campo tendato accanto al Lago Eyasi, la base abituale per le visite alla comunità di cacciatori-raccoglitori hadzabe.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, altopiani del Ngorongoro',
    description: 'Un lodge ricavato da un\'ex piantagione di caffè, con ampie verande rivolte verso l\'escarpment della Rift Valley e una cucina molto apprezzata, vicino alla strada del bordo del cratere.',
  ...
  },
  {
    ...
    description: 'Un affidabile lodge di tende utilizzato sia nella tappa di Tarangire sia in quella del centro del Serengeti di diversi itinerari, apprezzato per una guida solida a un prezzo equo.',
  ...
  },
  {
    ...
    description: 'Un hotel urbano a Kigali, che offre una base centrale e comoda prima di partire verso i parchi nazionali del Ruanda.',
    amenities: ['WiFi Gratuito', 'Ristorante con Servizio Completo', 'Giardini'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Centro del Serengeti',
    description: 'Un campo tendato nelle pianure centrali del Serengeti, con accesso diretto a una delle zone di osservazione della fauna più affidabili dell\'ecosistema durante tutto l\'anno.',
    ...
    featuredIn: [{ label: '5 Giorni Safari in Evidenza', href: '/safaris/5-days-highlights-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Parco Nazionale di Tarangire',
    description: 'Un lodge di tende con vista sul Lago Burunge, al confine di Tarangire, molto apprezzato per le vedute del tramonto sull\'acqua.',
    ...
    featuredIn: [{ label: 'Safari di 12 Giorni in Tanzania per Anziani, Anniversari e Gruppi', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: 'Safari Comfort di 5 Giorni in Tanzania', href: '/safaris/5-day-comfort-tanzania-safari' }, { label: 'Safari Comfort di 6 Giorni in Tanzania', href: '/safaris/6-day-comfort-tanzania-safari' }, { label: '8 Giorni Grande Migrazione del Nord', href: '/safaris/8-days-great-northern-migration' }],
  },
  {
    ...
    description: 'Un campo tendato sulle rive del Lago Elementaita, un\'alternativa più tranquilla ai laghi più affollati della Rift Valley.',
  ...
  },
  {
    ...
    description: 'Un hotel sul Lago Kivu, solitamente l\'ultima tappa di un itinerario in Ruanda dopo le fasi di trekking dei primati.',
    amenities: ['Piscina', 'Viste Panoramiche', 'Ristorante con Servizio Completo'],
    ...
    featuredIn: [{ label: '12 Giorni Esperienza Primati in Ruanda', href: '/safaris/12-days-rwanda-primates' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Lago Naivasha, Kenya',
    description: 'Un resort sulle rive del Lago Naivasha, ben posizionato per gite in barca e safari a piedi sulla vicina Isola di Crescent.',
  ...
  },
  {
    ...
    description: 'Un lodge all\'interno dello stesso Parco Nazionale del Lago Nakuru, storicamente noto per la sua costa costeggiata di fenicotteri e la sua popolazione residente di rinoceronti.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parco Nazionale del Lago Nakuru, Kenya',
    description: 'Un lodge in posizione elevata sopra il Lago Nakuru, con viste panoramiche sul lago e sul parco circostante.',
  ...
  },
  {
    ...
    description: 'Un campo privato in cima a una collina sopra i punti di attraversamento del Fiume Mara, pensato per i viaggiatori che pianificano il loro viaggio in base agli attraversamenti del fiume.',
  ...
  },
  {
    ...
    featuredIn: [{ label: '10 Giorni Safari di Lusso in Famiglia in Tanzania', href: '/safaris/10-days-luxury-family' }, { label: '7 Giorni tra le Gemme del Nord', href: '/safaris/7-days-gems-of-north' }, { label: '8 Giorni Grande Migrazione del Nord', href: '/safaris/8-days-great-northern-migration' }, { label: 'Safari Definitivo in Tanzania', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
    slug: 'lemala-osonjoi',
    name: 'Lemala Osonjoi',
    ...
    description: 'Un campo tendato privato vicino alla strada di discesa verso il Ngorongoro, che porta gli ospiti sul fondo del cratere prima dell\'alba.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Isola di Zanzibar',
    description: 'Una guesthouse semplice e ben posizionata per viaggiatori che prolungano un safari in Tanzania sulle spiagge di Zanzibar con un budget più contenuto.',
    ...
    featuredIn: [{ label: '10 Giorni Safari e Spiaggia di Zanzibar', href: '/safaris/10-day-safari-zanzibar' }, { label: '12 Giorni Ruanda, Tanzania e Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }],
  },
  {
    ...
    description: 'Un classico campo tendato all\'interno dell\'ecosistema del Masai Mara, gestito in modo semplice e ben posizionato per i game drive mattutini.',
    ...
    featuredIn: [{ label: '8 Giorni Grande Migrazione del Nord', href: '/safaris/8-days-great-northern-migration' }],
  },
  {
    ...
    description: 'Un lodge di tende vicino alla zona di confine tra Kenya e Tanzania, ben posizionato per la stagione degli attraversamenti del fiume durante la migrazione.',
    ...
    featuredIn: [{ label: 'Safari Definitivo della Grande Migrazione di 10 Giorni — Attraversamento del Fiume Mara', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '8 Giorni in Volo verso la Migrazione', href: '/safaris/8-days-flight-migration' }, { label: '8 Giorni Grande Migrazione del Nord', href: '/safaris/8-days-great-northern-migration' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenya',
    description: 'Un lodge in cima a una collina all\'interno del Masai Mara, con ampie viste sulle pianure della riserva e sul fiume sottostante.',
    amenities: ['WiFi Gratuito', 'Piscina', 'Ristorante con Servizio Completo', 'Viste Panoramiche'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Nord del Serengeti',
    description: 'Un campo tendato mobile che si sposta seguendo la migrazione attraverso il nord del Serengeti e la zona di confine con il Mara.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Masai Mara, Kenya',
    description: 'Un lodge grande e consolidato all\'interno dell\'ecosistema del Mara, vicino al corridoio degli attraversamenti del fiume durante la migrazione.',
  ...
  },
  {
    ...
    description: 'Un campo tendato vicino al Lago Masek, nella zona di Ndutu, il cuore della stagione dei parti degli gnu ogni anno.',
  ...
  },
  {
    ...
    description: 'Un piccolo campo tendato sulle rive del Lago Tanganica, la base per il trekking degli scimpanzé a Gombe Stream.',
  ...
  },
  {
    ...
    description: 'Un lodge con vista sull\'ampia pianura alluvionale di Mikumi, uno dei parchi più accessibili del circuito meridionale della Tanzania.',
    amenities: ['Piscina', 'Viste Panoramiche', 'Ristorante con Servizio Completo'],
    ...
    featuredIn: [{ label: '10 Giorni Segreti del Sud della Tanzania', href: '/safaris/10-days-southern-secrets' }, { label: '12 Giorni Il Grande Safari', href: '/safaris/12-days-grand-safari' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Ndutu, sud del Serengeti',
    description: 'Un campo tendato stagionale nella zona di Ndutu, programmato in base alla stagione dei parti degli gnu ogni anno.',
    amenities: ['Camere con Bagno Privato', 'Viste sulla Fauna'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Karatu, altopiani del Ngorongoro',
    description: 'Un\'ex piantagione di caffè trasformata in lodge, immersa tra i banani sul bordo boscoso del cratere — un ambiente rilassato e familiare piuttosto che formale.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, altopiani del Ngorongoro',
    description: 'Un lodge di fascia media negli altopiani del Ngorongoro, con facile accesso alla strada di discesa verso il cratere per i game drive mattutini.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Area di Conservazione del Ngorongoro',
    description: 'Un lodge situato direttamente sul bordo del cratere, tra le proprietà più vicine alla strada di discesa, con autentiche viste sul cratere.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Area di Conservazione del Ngorongoro',
    description: 'Un lodge in pietra scavato nel bordo boscoso del cratere, con camere che guardano direttamente sul fondo del Ngorongoro.',
    amenities: ['Viste Panoramiche', 'Ristorante con Servizio Completo', 'Camere con Bagno Privato'],
  ...
  },
  {
    ...
    description: 'Una struttura fronte spiaggia sulla punta settentrionale di Zanzibar, a Nungwi, nota per le acque calme e le viste sul tramonto.',
    ...
    featuredIn: [{ label: '7 Giorni Safari Gioielli della Corona', href: '/safaris/7-days-crown-jewels' }, { label: 'Safari di Luna di Miele di 9 Giorni e Fuga sulla Spiaggia di Zanzibar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }],
  },
  {
    slug: 'ol-tukai-lodge',
    name: 'Ol Tukai Lodge',
    ...
    description: 'Un lodge all\'interno del Parco Nazionale di Amboseli, con alcune delle viste sul Kilimanjaro più affidabili tra tutte le strutture del parco.',
  ...
  },
  {
    ...
    description: 'Un lodge ai margini della Foresta di Nyungwe, costruito attorno al trekking degli scimpanzé e all\'accesso al camminamento sulla volta forestale, piuttosto che ai gorilla.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kilimanjaro Occidentale',
    description: 'Un lodge di proprietà maasai ai piedi del Kilimanjaro, con una categoria di suite premium Kisiwa Boma accanto alle camere standard.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Isola di Zanzibar',
    description: 'Un resort fronte spiaggia all-inclusive a Zanzibar, la tappa finale abituale per i safari che si prolungano sull\'isola.',
    ...
    featuredIn: [{ label: '10 Giorni Safari e Spiaggia di Zanzibar', href: '/safaris/10-day-safari-zanzibar' }, { label: '12 Giorni Ruanda, Tanzania e Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: 'Safari Definitivo in Tanzania', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Parco Nazionale di Ruaha',
    description: 'Un lodge disseminato lungo il Grande Fiume Ruaha, nel parco nazionale più grande della Tanzania e uno dei meno visitati.',
    amenities: ['Viste Panoramiche', 'Viste sulla Fauna', 'Ristorante con Servizio Completo'],
    ...
    featuredIn: [{ label: '10 Giorni Segreti del Sud della Tanzania', href: '/safaris/10-days-southern-secrets' }, { label: '11 Giorni Fauna del Sud e Isole delle Spezie', href: '/safaris/11-days-southern-spice' }, { label: '12 Giorni Il Grande Safari', href: '/safaris/12-days-grand-safari' }, { label: '7 Giorni Circuito del Sud — Ruaha e Nyerere', href: '/safaris/7-day-southern-circuit' }],
  },
  {
    ...
    description: 'Un campo fluviale sul Fiume Rufiji nel Parco Nazionale di Nyerere, base sia per i game drive sia per i safari in barca.',
  ...
  },
  {
    ...
    description: 'Un lodge di tende con vista sul Lago Ihema ad Akagera, il parco di savana del Ruanda e la destinazione Big Five del paese.',
    amenities: ['Viste Panoramiche', 'Viste sulla Fauna'],
  ...
  },
  {
    ...
    description: 'Un campo tendato sul Fiume Ewaso Nyiro a Samburu, dimora di specie che non si trovano quasi in nessun altro luogo del Kenya.',
    amenities: ['Viste Panoramiche', 'Viste sulla Fauna'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parco Nazionale di Nyerere (Selous)',
    description: 'Un campo costruito tra le rocce sopra il Fiume Rufiji nell\'ecosistema del Selous, raggiungibile in aereo leggero.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Parco Nazionale del Lago Nakuru, Kenya',
    description: 'Un lodge in posizione elevata all\'interno del Parco Nazionale del Lago Nakuru, con ampie viste sul lago e sulla sua fauna.',
    amenities: ['WiFi Gratuito', 'Piscina', 'Ristorante con Servizio Completo', 'Viste Panoramiche'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Parco Nazionale di Nyerere (Selous)',
    description: 'Un lodge sopra le rapide del Fiume Rufiji nel Parco Nazionale di Nyerere, che unisce i game drive alle attività fluviali.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Centro del Serengeti',
    description: 'Un campo privato nel centro del Serengeti, pensato per i viaggiatori che desiderano un\'impronta più ridotta ed esclusiva nell\'ecosistema.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Centro del Serengeti',
    description: 'Un classico campo tendato all\'ombra delle acacie, nel cuore delle pianure centrali del Serengeti, ricche di fauna.',
    ...
    featuredIn: [{ label: '5 Giorni Safari in Evidenza', href: '/safaris/5-days-highlights-safari' }, { label: '7 Giorni Safari Serengeti e Ngorongoro', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 Giorni Grande Migrazione del Nord', href: '/safaris/8-days-great-northern-migration' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Centro del Serengeti',
    description: 'Un semplice campo tendato nel centro del Serengeti, che offre un accesso solido alle pianure senza un prezzo premium.',
    amenities: ['Camere con Bagno Privato', 'Ristorante con Servizio Completo', 'Viste sulla Fauna'],
    ...
    featuredIn: [{ label: '10 Giorni Safari e Spiaggia di Zanzibar', href: '/safaris/10-day-safari-zanzibar' }, { label: '12 Giorni Ruanda, Tanzania e Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: 'Safari di Luna di Miele di 8 Giorni — Amanti della Savana', href: '/safaris/8-days-honeymoon-safari' }],
  },
  {
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'Una villa privata ad Arusha, un\'alternativa comoda e più personale a un soggiorno alberghiero standard prima o dopo la savana.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Centro del Serengeti',
    description: 'Un campo tendato di lusso nelle pianure del centro del Serengeti, con una categoria di suite premium accanto alle sue tende standard.',
  ...
  },
  {
    ...
    description: 'Un campo tendato all\'interno della Riserva di Ol Pejeta, sede del più grande santuario di rinoceronti neri del Kenya e degli ultimi rinoceronti bianchi settentrionali al mondo.',
  ...
  },
  {
    ...
    description: 'Un lodge di conservazione confinante con il Parco Nazionale di Amboseli, costruito attorno a un programma di conservazione comunitaria oltre alle sue viste sul Kilimanjaro.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, altopiani del Ngorongoro',
    description: 'Una tenuta signorile in stile coloniale su un\'ex piantagione di caffè vicino al bordo del cratere, che unisce un\'architettura d\'epoca a una cucina davvero eccellente.',
    ...
    featuredIn: [{ label: '10 Giorni Safari di Lusso in Famiglia in Tanzania', href: '/safaris/10-days-luxury-family' }, { label: '7 Giorni Safari Gioielli della Corona', href: '/safaris/7-days-crown-jewels' }, { label: '8 Giorni in Volo verso la Migrazione', href: '/safaris/8-days-flight-migration' }, { label: 'Safari in Evidenza tra Kenya e Tanzania', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    slug: 'tloma-lodge',
    name: 'Tloma Lodge',
    tier: 'reserve',
    location: 'Karatu, altopiani del Ngorongoro',
    description: 'Un lodge con giardini su un\'ex piantagione di caffè fuori Karatu, una base rilassata vicina alla strada di discesa verso il cratere.',
  ...
  },
  {
    ...
    description: 'Un campo economico negli altopiani del Ngorongoro per viaggiatori che privilegiano il risparmio nella tappa del cratere del loro viaggio.',
    amenities: ['Ristorante con Servizio Completo', 'Giardini'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Ruanda',
    description: 'Un hotel centrale a Kigali che offre una base comoda e ben collegata prima o dopo i parchi nazionali del Ruanda.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Regione di Tarangire',
    description: 'Un campo tendato sul circuito di Tarangire, che offre una guida affidabile e una buona osservazione della fauna a un prezzo di fascia media.',
    amenities: ['Ristorante con Servizio Completo', 'WiFi Gratuito', 'Viste sulla Fauna'],
