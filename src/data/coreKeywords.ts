...
export const CORE_KEYWORDS_BY_LOCALE: Record<Locale, string[]> = {
  ...
  ko: [
    ...
    '잔지바르 비치 사파리', '마차메 루트 킬리만자로', 'TATO 인증 여행사',
  ],
  ar: [
    'سفاري تنزانيا', 'سفاري تنزانيا 2026', 'سفاري سيرينغيتي', 'تسلق كليمنجارو',
    'رحلة تتبع الغوريلا في رواندا', 'سفاري فاخر في أفريقيا', 'تكلفة سفاري تنزانيا',
    'سفاري شهر العسل في أفريقيا', 'شركة سياحة تنزانيا', 'سفاري شرق أفريقيا',
    'سفاري زنجبار والشاطئ', 'مسار ماتشامي كليمنجارو', 'شركة سياحة معتمدة من TATO',
  ],
  he: [
    'ספארי בטנזניה', 'ספארי בטנזניה 2026', 'ספארי בסרנגטי', 'טיפוס קילימנג\'רו',
    'טרק גורילות ברואנדה', 'ספארי יוקרה באפריקה', 'עלות ספארי בטנזניה',
    'ספארי ירח דבש באפריקה', 'חברת ספארי בטנזניה', 'ספארי מזרח אפריקה',
    'ספארי זנזיבר וחוף', 'מסלול מצ\'אמה קילימנג\'רו', 'חברת ספארי מוסמכת TATO',
  ],
  hi: [
    'तंजानिया सफारी', 'तंजानिया सफारी 2026', 'सेरेनगेटी सफारी', 'किलिमंजारो ट्रेकिंग',
    'रवांडा गोरिल्ला ट्रेकिंग', 'अफ्रीका लक्जरी सफारी', 'तंजानिया सफारी लागत',
    'अफ्रीका हनीमून सफारी', 'तंजानिया टूर कंपनी', 'पूर्वी अफ्रीका सफारी',
    'ज़ांज़ीबार बीच सफारी', 'माचामे रूट किलिमंजारो', 'TATO प्रमाणित टूर कंपनी',
  ],
  th: [
    'ทัวร์ซาฟารีแทนซาเนีย', 'ซาฟารีแทนซาเนีย 2026', 'ซาฟารีเซเรนเกติ', 'เดินป่าคิลิมันจาโร',
    'เดินป่าชมกอริลลารวันดา', 'ซาฟารีหรูแอฟริกา', 'ค่าใช้จ่ายซาฟารีแทนซาเนีย',
  ...
  pl: [
    'safari Tanzania', 'safari w Tanzanii 2026', 'safari Serengeti', 'wejście na Kilimandżaro',
    'trekking do goryli Rwanda', 'luksusowe safari Afryka', 'cena safari Tanzania',
  ...
  no: [
    'safari Tanzania', 'safari i Tanzania 2026', 'safari Serengeti', 'Kilimanjaro-bestigning',
    'gorillatrekking Rwanda', 'luksussafari Afrika', 'pris safari Tanzania',
    'bryllupsreise safari Afrika', 'reisebyrå safari Tanzania', 'familiesafari Afrika',
    'Machame-ruten Kilimanjaro', 'strand og safari Zanzibar', 'sertifisert safarioperatør TATO',
  ],
  sv: [
    'safari Tanzania', 'safari i Tanzania 2026', 'safari Serengeti', 'Kilimanjaro-bestigning',
    'gorillatrekking Rwanda', 'lyxsafari Afrika', 'pris safari Tanzania',
    'bröllopsresa safari Afrika', 'resebyrå safari Tanzania', 'familjesafari Afrika',
    'Machame-leden Kilimanjaro', 'strand och safari Zanzibar', 'certifierad safarioperatör TATO',
  ],
}
