...
export const packages: SafariPackage[] = [
  ...
  },
  {
    ...
    name: '9 Days Great Migration — Southern Edition',
    duration: 9,
    ...
    highlights: [
      'Witness calving season on the Ndutu plains — up to 8,000 wildebeest births a day',
      'Five nights based in Ndutu with four full game-drive days, never rushed between parks',
      'Strong cheetah and predator-prey photography, alongside newborn wildlife',
      'A full day on the Ngorongoro Crater floor to close the trip on a different note',
      'Small-group, tailor-made departures rather than fixed group dates',
    ],
    ...
    notes: [
      'This itinerary is fixed to calving season (late January–March); there is no separate low/high season rate, since the safari only runs during this window.',
      'A 30% deposit secures your booking, with the balance due 60 days before departure.',
    ...
    itinerary: [
      ...
      },
      {
        ...
        description: "An early descent into one of Africa's most concentrated wildlife environments, and a genuine change of pace from Ndutu's open drama. Lion, elephant, buffalo, flamingo, and — with luck — the endangered black rhino are all within reach here, set against the crater's dramatic walls and grassland floor. A strong, varied close to the safari, adding a landscape and species mix the plains simply don't offer.",
        accommodation: 'Ngorongoro Serena Safari Lodge',
        meals: 'All meals',
