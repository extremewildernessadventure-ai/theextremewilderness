...
export const accommodations: Accommodation[] = [
  {
    ...
    description: 'A fully mobile luxury tented camp that follows the Great Migration itself — you don’t chase the herds, you simply wake up wherever they currently are.',
  ...
  },
  {
    ...
    description: 'A Maasai-run lodge on Kilimanjaro’s western slopes, built around genuine cultural exchange with the surrounding community rather than a staged version of it.',
  ...
  },
  {
    ...
    description: 'The only permanent lodge inside Lake Manyara itself, with treehouse-style suites raised into the groundwater forest canopy — a genuinely different vantage point on the park than anything on its edge.',
  ...
  },
  {
    ...
    description: 'Perched on the Oloololo Escarpment with a view over the entire Mara plain that’s become one of the most photographed outlooks in East Africa — for good reason.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'A working coffee estate near the airport that turns a first or last night from a formality into a genuinely relaxed one.',
  ...
  },
  {
    ...
    description: 'Domed forest villas set into a restored volcanic amphitheatre, a short drive from the gorilla trekking trailheads — one of the most acclaimed lodges built in Africa this decade.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Tarangire National Park',
    description: 'A straightforward camp that puts its money where it matters most on the Tarangire circuit: solid guiding, a well-run kitchen, and a fair price rather than a resort budget.',
  ...
  },
  {
    ...
    description: 'A beachfront city hotel on the Msasani Peninsula — genuinely comfortable, and the standard overnight stop en route to or from the southern circuit.',
    ...
    featuredIn: [{ label: '5 Days Private Gombe Chimpanzee Trekking', href: '/safaris/5-day-gombe-chimpanzee-trekking' }, { label: '7 Days Southern Circuit — Ruaha & Nyerere', href: '/safaris/7-day-southern-circuit' }, { label: 'Ultimate Tanzania Safari & Gombe Chimpanzee Trekking', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
    ...
    description: 'An all-inclusive beachfront resort on Zanzibar\'s Nungwi coast, the Wilderness Reserve-tier closing stop for the 10-Day Tanzania Safari & Zanzibar Beach itinerary.',
    amenities: ['All-Inclusive', 'Swimming Pool', 'Beachfront', 'Full-Service Restaurant'],
    ...
    featuredIn: [{ label: '10 Days Tanzania Safari & Zanzibar Beach', href: '/safaris/10-day-safari-zanzibar' }],
  ...
  },
  {
    ...
    description: 'A simple, no-frills Kigali base for travelers who’d rather spend their budget on the gorilla trekking and primate legs of the trip than on the first and last nights in the city.',
  ...
  },
  {
    ...
    description: 'A dependable, well-located Nairobi gateway hotel — the kind of practical first or last stop that does its one job well before or after the parks take over.',
    amenities: ['Free WiFi', 'Swimming Pool', 'Full-Service Restaurant'],
  ...
  },
  {
    ...
    description: 'Built around a natural spring that draws elephant and other wildlife right past the property — a mid-range camp with a wildlife-viewing edge most mid-range camps don’t have.',
    ...
    featuredIn: [{ label: '7-Day Tanzania Photography & Adventure Safari', href: '/safaris/7-day-photography-adventure-safari' }, { label: '10 Days Tanzania Safari & Zanzibar Beach', href: '/safaris/10-day-safari-zanzibar' }],
  },
  {
    ...
    description: 'A genuine spa resort on the Naivasha shore — a real slow-down day built into the middle of a Rift Valley routine, not just another lodge between game drives.',
  ...
  },
  {
    ...
    description: 'Built around its own watering hole in the heart of the Serengeti, where wildlife regularly passes directly below the terrace — the Four Seasons standard, in the middle of the plains.',
    ...
    featuredIn: [{ label: '12 Days Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '12-Day Wilderness Safari, Cultural Encounters & Kilimanjaro Day Hike', href: '/safaris/12-days-wild-wilderness' }],
  },
  {
    slug: 'gibbs-farm',
    name: 'Gibb\'s Farm',
    ...
    description: 'A long-running organic farm estate below the crater rim, still growing its own coffee and produce, and widely regarded as one of Tanzania’s finest kitchens full stop, not just among lodges.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenya',
    description: 'The original luxury tented camp in the Mara, in continuous operation since 1972, on the banks of the Mara River in one of the reserve’s most reliable wildlife corridors — an icon, not a budget stop.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'Meliá’s own luxury sub-brand, close to the airport — full resort facilities and genuine polish for travelers who want more comfort before or after the bush.',
  ...
  },
  {
    ...
    description: 'Set directly on the escarpment, pairing sweeping valley views with full golf and spa facilities most safari properties simply don’t offer.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Nairobi, Kenya',
    description: 'A colonial-style boutique hotel in Karen, part of the globally recognized Hemingways Collection — genuinely comfortable rather than merely convenient, at either end of a Kenya safari.',
  ...
  },
  {
    ...
    description: 'A forest-edge camp built for hiking and primate-tracking in one of Tanzania’s least-visited, most rewarding parks for travelers who want something beyond the standard circuit.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Dar es Salaam',
    description: 'A full-service waterfront hotel used as a comfortable transit stop on southern-circuit itineraries — a strong upper-upscale option, at the same brand tier as Radisson Blu.',
    amenities: ['Swimming Pool', 'Full-Service Restaurant', 'Free WiFi'],
  ...
  },
  {
    ...
    description: 'A private camp on a rocky outcrop above the Ruaha River, in one of Tanzania’s largest and least-crowded parks.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Volcanoes National Park, Rwanda',
    description: 'A budget-friendly lodge right at the Volcanoes National Park boundary, positioned deliberately for the early departures a gorilla trekking morning demands.',
    ...
    featuredIn: [{ label: '4 Days Rwanda Gorilla Trekking', href: '/safaris/4-day-rwanda-gorilla-trekking' }, { label: 'Rwanda Primate Safari & Zanzibar Beach Escape', href: '/safaris/12-days-rwanda-primates' }],
  },
  {
    slug: 'kahawa-house',
    name: 'Kahawa House',
    tier: 'trail',
    location: 'Arusha',
    description: 'A relaxed guesthouse on a working coffee estate outside Arusha — a genuinely quiet, well-run first or last night before or after the bush.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'West Kilimanjaro',
    description: 'A tented camp on private land at Kilimanjaro’s foot, known for resident elephant herds passing right through camp and a mountain backdrop that needs no embellishment.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenya',
    description: '&Beyond’s own more accessible Mara camp — the full andBeyond standard of hospitality and location, at a noticeably gentler price than their signature properties.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Rwanda',
    description: 'A central Kigali hotel carrying Serena’s consistent 5-star standard — a genuinely comfortable overnight stop before or after gorilla trekking in the Virungas, not a budget placeholder.',
    amenities: ['Free WiFi', 'Swimming Pool', 'Full-Service Restaurant'],
  ...
  },
  {
    ...
    description: 'A hillside lodge with genuine Lake Tanganyika views, functioning as the gateway for one of Tanzania’s most remote and rewarding experiences: chimpanzee trekking in Gombe and Mahale.',
    ...
    featuredIn: [{ label: '5 Days Private Gombe Chimpanzee Trekking', href: '/safaris/5-day-gombe-chimpanzee-trekking' }, { label: 'Ultimate Tanzania Safari & Gombe Chimpanzee Trekking', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Volcanoes National Park, Rwanda',
    description: 'A straightforward guesthouse at the Volcanoes National Park gate, built specifically around the early departures a gorilla trekking morning demands.',
    ...
    featuredIn: [{ label: '11 Days Rwanda Tanzania Safari', href: '/safaris/11-days-rwanda-tanzania' }, { label: '12 Days Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }],
  },
  {
    ...
    description: 'A tented camp on the Rift Valley escarpment with a view that does the talking — the valley floor stretches out below for as far as you can see.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Lake Eyasi',
    description: 'A small tented camp beside Lake Eyasi, the usual and best-placed base for visits to the Hadzabe hunter-gatherer community.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, Ngorongoro Highlands',
    description: 'A former coffee estate with wide verandas facing the Rift Valley escarpment and a kitchen genuinely worth talking about, close to the crater rim road.',
  ...
  },
  {
    ...
    description: 'A dependable tented lodge used across both the Tarangire and central Serengeti legs of several of our itineraries — solid guiding at a fair price, every time.',
  ...
  },
  {
    ...
    description: 'A comfortable, central Musanze base before heading out to track gorillas in the Volcanoes.',
    amenities: ['Free WiFi', 'Full-Service Restaurant', 'Garden Grounds'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Central Serengeti',
    description: 'A tented camp in the heart of the plains, with close access to some of the ecosystem’s most reliable year-round game viewing.',
    ...
    featuredIn: [{ label: '5 Days Highlights Safari', href: '/safaris/5-days-highlights-safari' }, { label: 'Kilimanjaro Lemosho Climb & 5-Day Highlights Safari', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Tarangire National Park',
    description: 'A tented lodge on Lake Burunge’s edge, on the Tarangire boundary, best known among guests for its sunset views straight across the water.',
  ...
  },
  {
    ...
    description: 'A Serena tented camp on a quieter Rift Valley lake than its busier neighbors.',
  ...
  },
  {
    ...
    description: 'A lakeside Serena property, usually the closing stop on a Rwanda itinerary after the primate trekking legs are done.',
    amenities: ['Swimming Pool', 'Scenic Views', 'Full-Service Restaurant'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Lake Naivasha, Kenya',
    description: 'A reliable lakeside resort well placed for Crescent Island boat trips and walking safaris — the kind of comfortable, no-surprises stay Sopa properties are known for across East Africa.',
  ...
  },
  {
    ...
    description: 'Inside the park itself, historically known for its flamingo-lined shoreline and resident rhino population.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Lake Nakuru National Park, Kenya',
    description: 'Set on high ground above the lake with genuinely panoramic views, and the same dependable Sopa standard found at their other East African properties.',
  ...
  },
  {
    ...
    description: 'A private hilltop camp directly above the Mara River crossing points — one of the best-placed camps on the mountain for travelers timing their trip to the crossings themselves.',
  ...
  },
  {
    ...
    featuredIn: [{ label: '10 Days Tanzania Luxury Family Safari', href: '/safaris/10-days-luxury-family' }, { label: '7 Days Gems of the North', href: '/safaris/7-days-gems-of-north' }, { label: '8 Days Great Northern Migration', href: '/safaris/8-days-great-northern-migration' }, { label: '8-Day Wildebeest River Crossing Safari', href: '/safaris/8-days-flight-migration' }],
  },
  {
    slug: 'lemala-osonjoi',
    name: 'Lemala Osonjoi',
    ...
    description: 'A private tented camp close to the descent road, putting guests on the crater floor before most other camps have finished breakfast.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Zanzibar Island',
    description: 'A simple, well-placed guesthouse for travelers extending onto Zanzibar’s beaches without extending the budget.',
  ...
  },
  {
    ...
    description: 'A classic tented camp run simply and honestly, positioned for the early starts that make the difference on a Mara-ecosystem game drive.',
    ...
    featuredIn: [{ label: '8 Days Great Northern Migration', href: '/safaris/8-days-great-northern-migration' }, { label: '8-Day Wildebeest River Crossing Safari', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    description: 'A tented lodge close to the Kenya-Tanzania border area, positioned specifically for the migration’s river-crossing season.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenya',
    description: 'A hilltop Serena lodge with sweeping views over the reserve’s plains and river below.',
    amenities: ['Free WiFi', 'Swimming Pool', 'Full-Service Restaurant', 'Scenic Views'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Northern Serengeti',
    description: 'A mobile tented camp that relocates with the migration itself through the northern Serengeti and Mara border.',
    ...
    featuredIn: [{ label: 'Tanzania Photographic Safari — Tarangire, Ngorongoro Crater & Serengeti', href: '/safaris/tanzania-photographic-safari' }, { label: '8-Day Wildebeest River Crossing Safari', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Masai Mara, Kenya',
    description: 'A large, well-established lodge close to the migration’s river-crossing corridor — solid Sopa reliability with a genuinely strong location behind it.',
  ...
  },
  {
    ...
    description: 'A tented camp near Lake Masek, right in the heart of the wildebeest calving season each year.',
  ...
  },
  {
    ...
    description: 'A small tented camp on Lake Tanganyika’s shore, the practical, comfortable base for chimpanzee trekking in Gombe.',
  ...
  },
  {
    ...
    description: 'Overlooking Mikumi’s open floodplain — one of the most accessible parks on the southern circuit, with a lodge to match its ease.',
    amenities: ['Swimming Pool', 'Scenic Views', 'Full-Service Restaurant'],
  ...
  },
  {
    ...
    description: 'An eco-lodge on the edge of Nyungwe Forest, close to the trailheads for chimpanzee trekking through one of Africa\'s oldest montane rainforests.',
    amenities: ['Full-Service Restaurant', 'Wildlife Views', 'Forest Views'],
    ...
    featuredIn: [{ label: 'Rwanda Primate Safari & Zanzibar Beach Escape', href: '/safaris/12-days-rwanda-primates' }],
    needsPhotography: true,
  },
  {
    ...
    tier: 'reserve',
    location: 'Ndutu, Southern Serengeti',
    description: 'A seasonal tented camp timed precisely to the wildebeest calving season each year.',
    amenities: ['En-Suite Rooms', 'Wildlife Views'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Ndutu, Southern Serengeti',
    description: 'A permanent stone-and-thatch lodge of 34 cottages overlooking Lake Ndutu, positioned for year-round access to the resident predators who never leave when the migration moves on.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Karatu, Ngorongoro Highlands',
    description: 'A working coffee farm turned lodge among banana groves on the crater rim — relaxed and homely by design, not aiming to be anything grander.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, Ngorongoro Highlands',
    description: 'A mid-range lodge on the highlands with easy access to the crater descent road for early game drives.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Ngorongoro Conservation Area',
    description: 'Set directly on the crater rim, among the closest properties to the descent road with genuine, unobstructed crater views.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Ngorongoro Conservation Area',
    description: 'A stone-built Serena lodge cut into the crater’s forested rim, with rooms that look straight down into the Ngorongoro floor.',
    amenities: ['Scenic Views', 'Full-Service Restaurant', 'En-Suite Rooms'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Nungwi, Zanzibar',
    description: 'A beachfront property on Zanzibar’s northern tip, known among guests for calm swimming water and reliably good sunsets.',
    ...
    featuredIn: [{ label: '7 Days Crown Jewels Safari', href: '/safaris/7-days-crown-jewels' }, { label: '9-Day Honeymoon Safari & Zanzibar Beach Escape', href: '/safaris/9-day-honeymoon-safari-zanzibar' }, { label: '10 Days Tanzania Safari & Zanzibar Beach', href: '/safaris/10-day-safari-zanzibar' }, { label: 'Rwanda Primate Safari & Zanzibar Beach Escape', href: '/safaris/12-days-rwanda-primates' }],
  },
  {
    slug: 'ol-tukai-lodge',
    name: 'Ol Tukai Lodge',
    ...
    description: 'Inside the park itself, with some of the most consistently reliable Kilimanjaro views of any property in Amboseli — a real point of difference at this price point.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Nyungwe Forest, Rwanda',
    description: 'A globally recognized ultra-luxury brand set inside a working tea plantation on Nyungwe’s edge — built around chimpanzee trekking and canopy-walk access rather than gorillas.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'West Kilimanjaro',
    description: 'A Maasai-owned lodge at Kilimanjaro’s foot, with a premium Kisiwa Boma suite category alongside its standard rooms — a distinct property from the separately positioned Africa Amini Original Maasai Lodge.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Zanzibar Island',
    description: 'An all-inclusive beachfront resort, the standard closing stop for safaris extending onto the island.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Ruaha National Park',
    description: 'Scattered along the Great Ruaha River, in Tanzania’s largest national park and one of its most genuinely under-visited.',
    amenities: ['Scenic Views', 'Wildlife Views', 'Full-Service Restaurant'],
    ...
    featuredIn: [{ label: '10 Days Southern Tanzania Secrets', href: '/safaris/10-days-southern-secrets' }, { label: '11 Days Southern Wildlife & Spice Isles', href: '/safaris/11-days-southern-spice' }, { label: '7 Days Southern Circuit — Ruaha & Nyerere', href: '/safaris/7-day-southern-circuit' }],
  },
  {
    ...
    description: 'A riverside camp on the Rufiji, the base for both game drives and boat safaris in the same trip.',
  ...
  },
  {
    ...
    description: 'Overlooking Lake Ihema in Akagera, Rwanda’s own Big Five destination and a genuinely different landscape from the volcanoes.',
    amenities: ['Scenic Views', 'Wildlife Views'],
  ...
  },
  {
    ...
    description: 'On the Ewaso Nyiro River, home to species found almost nowhere else in Kenya — reticulated giraffe, Grevy’s zebra, gerenuk.',
    amenities: ['Scenic Views', 'Wildlife Views'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Nyerere National Park (Selous)',
    description: 'Built into the rocks above the Rufiji River and reached only by light aircraft — remote in a way few properties at this tier manage.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Lake Nakuru National Park, Kenya',
    description: 'On high ground inside the park, with wide views over the lake and the wildlife it draws.',
    amenities: ['Free WiFi', 'Swimming Pool', 'Full-Service Restaurant', 'Scenic Views'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Nyerere National Park (Selous)',
    description: 'A Serena lodge above the Rufiji River rapids, combining game drives with river-based activities in the same stay.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Central Serengeti',
    description: 'A private camp built deliberately for a smaller, more exclusive footprint in the ecosystem than the larger central-Serengeti properties.',
    ...
    featuredIn: [{ label: '10-Day Ultimate Great Migration — Mara River-Crossing Safari', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '10 Days Tanzania Safari & Zanzibar Beach', href: '/safaris/10-day-safari-zanzibar' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Central Serengeti',
    description: 'A classic tented camp under acacia cover, right in the game-rich heart of the plains — solid access without the premium price tag.',
    ...
    featuredIn: [{ label: '5 Days Highlights Safari', href: '/safaris/5-days-highlights-safari' }, { label: '7 Days Serengeti & Ngorongoro Safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 Days Great Northern Migration', href: '/safaris/8-days-great-northern-migration' }, { label: '8-Day Wildebeest River Crossing Safari', href: '/safaris/8-days-flight-migration' }, { label: '10 Days Tanzania Safari & Zanzibar Beach', href: '/safaris/10-day-safari-zanzibar' }, { label: '5-Day Kilimanjaro Extension Safari', href: '/safaris/kilimanjaro-extension-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Central Serengeti',
    description: 'A straightforward tented camp offering real access to the central plains, priced for travelers who’d rather spend on more days than a fancier tent.',
    amenities: ['En-Suite Rooms', 'Full-Service Restaurant', 'Wildlife Views'],
    ...
    featuredIn: [{ label: '12 Days Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '8-Day Honeymoon Safari — Bush Lovers', href: '/safaris/8-days-honeymoon-safari' }],
  },
  {
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Tarangire National Park',
    description: 'A private tented camp raised on stilts above the Tarangire treeline, in elephant country year-round.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'A private villa property, a more personal alternative to a standard hotel stay before or after the bush.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Central Serengeti',
    description: 'A tented camp in the plains with a premium suite category alongside its standard tents.',
    ...
    featuredIn: [{ label: '11 Days Rwanda Tanzania Safari', href: '/safaris/11-days-rwanda-tanzania' }, { label: '12 Days Tanzania Kenya Expedition', href: '/safaris/12-days-tanzania-kenya' }, { label: '12-Day Tanzania Safari for Seniors, Anniversaries & Groups', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '5 Days Highlights Safari', href: '/safaris/5-days-highlights-safari' }, { label: '5 Days Serengeti Fly-In Safari', href: '/safaris/5-day-serengeti-fly-in' }, { label: '7 Days Crown Jewels Safari', href: '/safaris/7-days-crown-jewels' }, { label: '7 Days Flight Over Ndutu Migration', href: '/safaris/7-days-flight-ndutu' }, { label: '7 Days Gems of the North', href: '/safaris/7-days-gems-of-north' }, { label: '7 Days Serengeti & Ngorongoro Safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8-Day Honeymoon Safari — Bush Lovers', href: '/safaris/8-days-honeymoon-safari' }, { label: '9-Day Honeymoon Safari & Zanzibar Beach Escape', href: '/safaris/9-day-honeymoon-safari-zanzibar' }, { label: 'Kilimanjaro Lemosho Climb & 5-Day Highlights Safari', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }, { label: 'Tanzania Photographic Safari — Tarangire, Ngorongoro Crater & Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    ...
    description: 'Inside Ol Pejeta, home to Kenya’s largest black rhino sanctuary and the world’s last northern white rhinos — a genuinely rare wildlife credential.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Tarangire National Park',
    description: 'A straightforward tented camp on the Tarangire circuit, well placed for the park\'s dense elephant herds without a resort price tag.',
    amenities: ['En-Suite Rooms', 'Wildlife Views', 'Full-Service Restaurant'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Tarangire National Park',
    description: 'An elevated luxury camp on the Tarangire circuit, part of the Elewana Collection, with treetop-level views over one of Africa\'s densest elephant landscapes.',
    amenities: ['Swimming Pool', 'Scenic Views', 'Spa', 'Wildlife Views'],
  ...
  },
  {
    ...
    description: 'A conservancy lodge bordering Amboseli, built around a community conservation program alongside its own Kilimanjaro views.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, Ngorongoro Highlands',
    description: 'A colonial-style coffee estate manor near the crater rim, pairing period architecture with a kitchen that’s genuinely worth the reputation.',
    ...
    featuredIn: [{ label: '10 Days Tanzania Luxury Family Safari', href: '/safaris/10-days-luxury-family' }, { label: '10 Days Tanzania Safari & Zanzibar Beach', href: '/safaris/10-day-safari-zanzibar' }, { label: '7 Days Crown Jewels Safari', href: '/safaris/7-days-crown-jewels' }, { label: 'Highlights of Kenya & Tanzania Safari', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    slug: 'tloma-lodge',
    name: 'Tloma Lodge',
    tier: 'reserve',
    location: 'Karatu, Ngorongoro Highlands',
    description: 'A garden lodge on a former coffee farm outside Karatu, relaxed and close to the crater descent road.',
  ...
  },
  {
    ...
    description: 'A budget-friendly camp in the highlands, the sensible choice for travelers prioritizing value on the crater leg of a longer trip.',
    amenities: ['Full-Service Restaurant', 'Garden Grounds'],
    ...
    featuredIn: [{ label: '5 Days Highlights Safari', href: '/safaris/5-days-highlights-safari' }, { label: '8-Day Wildebeest River Crossing Safari', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Rwanda',
    description: 'A central Kigali hotel, comfortable and well-located before or after Rwanda’s national parks.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Zanzibar Island',
    description: 'A Serena property on Zanzibar Island, the arrival stop where Rwanda\'s primate trekking gives way to a run of unscheduled beach days.',
    amenities: ['Swimming Pool', 'Beachfront', 'Full-Service Restaurant'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Tarangire region',
    description: 'A tented camp on the Tarangire circuit, dependable guiding and wildlife viewing at a genuinely mid-range price.',
    amenities: ['Full-Service Restaurant', 'Free WiFi', 'Wildlife Views'],
