...
export const accommodations: Accommodation[] = [
  {
    ...
    description: 'Um acampamento de tendas de luxo totalmente móvel que acompanha a própria Grande Migração — você não persegue as manadas, simplesmente acorda onde elas estiverem naquele momento.',
  ...
  },
  {
    ...
    description: 'Uma lodge gerida por Massais nas encostas ocidentais do Kilimanjaro, construída em torno de um intercâmbio cultural genuíno com a comunidade envolvente, e não uma versão encenada dele.',
  ...
  },
  {
    ...
    description: 'A única lodge permanente dentro do próprio Lago Manyara, com suites em estilo casa na árvore erguidas no dossel da floresta freática — um ponto de vista genuinamente diferente sobre o parque, muito distinto de qualquer coisa na sua margem.',
  ...
  },
  {
    ...
    description: 'Situada na escarpa de Oloololo, com uma vista sobre toda a planície da Mara que se tornou um dos miradouros mais fotografados da África Oriental — e com boas razões para isso.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'Uma plantação de café em atividade perto do aeroporto, que transforma uma primeira ou última noite de mera formalidade numa verdadeira pausa relaxante.',
  ...
  },
  {
    ...
    description: 'Vilas abobadadas na floresta, instaladas num anfiteatro vulcânico recuperado, a uma curta distância de carro dos pontos de partida do trekking de gorilas — uma das lodges mais aclamadas construídas em África nesta década.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parque Nacional de Tarangire',
    description: 'Um acampamento simples que investe o seu dinheiro onde mais importa no circuito de Tarangire: guias sólidos, uma cozinha bem gerida e um preço justo, em vez de um orçamento de resort.',
  ...
  },
  {
    ...
    description: 'Um hotel urbano à beira-mar na Península de Msasani — genuinamente confortável, e a paragem padrão de uma noite a caminho do circuito sul ou no regresso deste.',
    ...
    featuredIn: [{ label: '5 Dias de Trekking Privado de Chimpanzés em Gombe', href: '/safaris/5-day-gombe-chimpanzee-trekking' }, { label: '7 Dias Circuito Sul — Ruaha & Nyerere', href: '/safaris/7-day-southern-circuit' }, { label: 'Safari Definitivo na Tanzânia & Trekking de Chimpanzés em Gombe', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
    ...
    description: 'Um resort tudo incluído à beira-mar na costa de Nungwi, em Zanzibar, a paragem final de nível Wilderness Reserve do itinerário de 10 Dias de Safari na Tanzânia & Praia de Zanzibar.',
    amenities: ['Tudo Incluído', 'Piscina', 'Frente de Praia', 'Restaurante de Serviço Completo'],
    ...
    featuredIn: [{ label: '10 Dias de Safari na Tanzânia & Praia de Zanzibar', href: '/safaris/10-day-safari-zanzibar' }],
  ...
  },
  {
    ...
    description: 'Uma base simples e sem luxos em Kigali, para viajantes que preferem gastar o seu orçamento nas etapas de trekking de gorilas e primatas da viagem, em vez da primeira e última noites na cidade.',
  ...
  },
  {
    ...
    description: 'Um hotel de confiança e bem localizado em Nairobi — o tipo de paragem prática, de primeira ou última noite, que cumpre bem a sua função antes ou depois de os parques tomarem conta da viagem.',
    amenities: ['Wi-Fi Gratuito', 'Piscina', 'Restaurante de Serviço Completo'],
  ...
  },
  {
    ...
    description: 'Construído em torno de uma nascente natural que atrai elefantes e outra vida selvagem mesmo junto à propriedade — um acampamento de gama média com uma vantagem na observação de vida selvagem que a maioria dos acampamentos de gama média não tem.',
    ...
    featuredIn: [{ label: 'Safari Fotográfico e de Aventura de 7 Dias na Tanzânia', href: '/safaris/7-day-photography-adventure-safari' }, { label: '10 Dias de Safari na Tanzânia & Praia de Zanzibar', href: '/safaris/10-day-safari-zanzibar' }],
  },
  {
    ...
    description: 'Um verdadeiro resort com spa na margem do Naivasha — um autêntico dia de pausa a meio da rotina do Vale do Rift, e não apenas mais uma lodge entre game drives.',
  ...
  },
  {
    ...
    description: 'Construída em torno do seu próprio poço de água no coração do Serengeti, onde a vida selvagem passa regularmente mesmo por baixo do terraço — o padrão Four Seasons, no meio das planícies.',
    ...
    featuredIn: [{ label: '12 Dias Ruanda, Tanzânia & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: 'Safari de 12 Dias na Natureza Selvagem, Encontros Culturais & Caminhada de um Dia ao Kilimanjaro', href: '/safaris/12-days-wild-wilderness' }],
  },
  {
    slug: 'gibbs-farm',
    name: 'Gibb\'s Farm',
    ...
    description: 'Uma propriedade agrícola biológica de longa tradição abaixo da borda da cratera, que continua a cultivar o seu próprio café e produtos hortícolas, amplamente considerada uma das melhores cozinhas da Tanzânia — sem qualificativos, não apenas entre lodges.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Quénia',
    description: 'O primeiro acampamento de tendas de luxo da Mara, em funcionamento contínuo desde 1972, nas margens do Rio Mara, num dos corredores de vida selvagem mais fiáveis da reserva — um ícone, não uma opção económica.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'A própria submarca de luxo da Meliá, perto do aeroporto — instalações completas de resort e um requinte genuíno para viajantes que procuram mais conforto antes ou depois do mato.',
  ...
  },
  {
    ...
    description: 'Situado diretamente na escarpa, aliando vistas amplas sobre o vale a instalações completas de golfe e spa que a maioria das propriedades de safári simplesmente não oferece.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Nairobi, Quénia',
    description: 'Um hotel boutique de estilo colonial em Karen, integrado na reconhecida Hemingways Collection — genuinamente confortável, e não apenas conveniente, em qualquer uma das pontas de um safari no Quénia.',
  ...
  },
  {
    ...
    description: 'Um acampamento na orla da floresta, vocacionado para caminhadas e observação de primatas, num dos parques menos visitados — e mais recompensadores — da Tanzânia, para viajantes que procuram algo além do circuito habitual.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Dar es Salaam',
    description: 'Um hotel de serviço completo à beira-mar, utilizado como uma paragem de trânsito confortável nos itinerários do circuito sul — uma opção upper-upscale sólida, do mesmo nível de marca que o Radisson Blu.',
    amenities: ['Piscina', 'Restaurante de Serviço Completo', 'Wi-Fi Gratuito'],
  ...
  },
  {
    ...
    description: 'Um acampamento privado sobre um afloramento rochoso acima do Rio Ruaha, num dos parques maiores e menos concorridos da Tanzânia.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parque Nacional dos Vulcões, Ruanda',
    description: 'Uma lodge económica mesmo junto ao limite do Parque Nacional dos Vulcões, pensada de propósito para as partidas matinais que uma manhã de trekking de gorilas exige.',
    ...
    featuredIn: [{ label: '4 Dias de Trekking de Gorilas no Ruanda', href: '/safaris/4-day-rwanda-gorilla-trekking' }, { label: 'Safari de Primatas no Ruanda & Escapadela à Praia de Zanzibar', href: '/safaris/12-days-rwanda-primates' }],
  },
  {
    slug: 'kahawa-house',
    name: 'Kahawa House',
    tier: 'trail',
    location: 'Arusha',
    description: 'Uma casa de hóspedes descontraída numa plantação de café em atividade nos arredores de Arusha — uma primeira ou última noite genuinamente tranquila e bem gerida, antes ou depois do mato.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kilimanjaro Ocidental',
    description: 'Um acampamento de tendas em terreno privado aos pés do Kilimanjaro, conhecido pelas manadas residentes de elefantes que atravessam o próprio acampamento e por um pano de fundo montanhoso que dispensa adjetivos.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Quénia',
    description: 'O acampamento mais acessível da própria &Beyond na Mara — o padrão total da andBeyond em hospitalidade e localização, a um preço visivelmente mais suave do que as suas propriedades emblemáticas.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Ruanda',
    description: 'Um hotel no centro de Kigali, com o padrão 5 estrelas consistente da Serena — uma paragem noturna genuinamente confortável antes ou depois do trekking de gorilas nos Virunga, e não uma opção económica de recurso.',
    amenities: ['Wi-Fi Gratuito', 'Piscina', 'Restaurante de Serviço Completo'],
  ...
  },
  {
    ...
    description: 'Uma lodge de colina com vistas genuínas sobre o Lago Tanganica, servindo de porta de entrada para uma das experiências mais remotas e recompensadoras da Tanzânia: o trekking de chimpanzés em Gombe e Mahale.',
    ...
    featuredIn: [{ label: '5 Dias de Trekking Privado de Chimpanzés em Gombe', href: '/safaris/5-day-gombe-chimpanzee-trekking' }, { label: 'Safari Definitivo na Tanzânia & Trekking de Chimpanzés em Gombe', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Parque Nacional dos Vulcões, Ruanda',
    description: 'Uma casa de hóspedes simples junto ao portão do Parque Nacional dos Vulcões, pensada especificamente para as partidas matinais que o trekking de gorilas exige.',
    ...
    featuredIn: [{ label: '11 Dias Safari Ruanda-Tanzânia', href: '/safaris/11-days-rwanda-tanzania' }, { label: '12 Dias Ruanda, Tanzânia & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }],
  },
  {
    ...
    description: 'Um acampamento de tendas na escarpa do Vale do Rift, com uma vista que fala por si — o fundo do vale estende-se lá em baixo até onde a vista alcança.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Lago Eyasi',
    description: 'Um pequeno acampamento de tendas junto ao Lago Eyasi, a base habitual e mais bem posicionada para visitas à comunidade de caçadores-recolectores hadzabe.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, Terras Altas do Ngorongoro',
    description: 'Uma antiga plantação de café com amplas varandas voltadas para a escarpa do Vale do Rift e uma cozinha genuinamente digna de nota, perto da estrada da borda da cratera.',
  ...
  },
  {
    ...
    description: 'Uma lodge de tendas de confiança, utilizada tanto na etapa de Tarangire como na do centro do Serengeti em vários dos nossos itinerários — guiamento sólido a um preço justo, sempre.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Centro do Serengeti',
    description: 'Um acampamento de tendas no coração das planícies, com acesso direto a algumas das zonas de observação de vida selvagem mais fiáveis do ecossistema durante todo o ano.',
    ...
    featuredIn: [{ label: '5 Dias Safari de Destaques', href: '/safaris/5-days-highlights-safari' }, { label: 'Escalada do Kilimanjaro via Lemosho & Safari de Destaques de 5 Dias', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Parque Nacional de Tarangire',
    description: 'Uma lodge de tendas na margem do Lago Burunge, no limite de Tarangire, mais conhecida entre os hóspedes pelas suas vistas do pôr do sol sobre a água.',
  ...
  },
  {
    ...
    description: 'Um acampamento de tendas da Serena junto a um lago do Vale do Rift mais tranquilo do que os seus vizinhos mais movimentados.',
  ...
  },
  {
    ...
    description: 'Uma propriedade Serena à beira-lago, normalmente a última paragem de um itinerário no Ruanda, depois de concluídas as etapas de trekking de primatas.',
    amenities: ['Piscina', 'Vistas Panorâmicas', 'Restaurante de Serviço Completo'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Lago Naivasha, Quénia',
    description: 'Um resort fiável à beira-lago, bem posicionado para passeios de barco a Crescent Island e safaris a pé — o tipo de estadia confortável e sem surpresas pela qual as propriedades Sopa são conhecidas em toda a África Oriental.',
  ...
  },
  {
    ...
    description: 'Dentro do próprio parque, historicamente conhecida pela sua orla ladeada de flamingos e pela população residente de rinocerontes.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parque Nacional do Lago Nakuru, Quénia',
    description: 'Situada em terreno elevado acima do lago, com vistas genuinamente panorâmicas, e o mesmo padrão fiável da Sopa que se encontra nas suas restantes propriedades da África Oriental.',
  ...
  },
  {
    ...
    description: 'Um acampamento privado no topo de uma colina, mesmo acima dos pontos de travessia do Rio Mara — um dos acampamentos mais bem posicionados da região para viajantes que ajustam a viagem às próprias travessias.',
  ...
  },
  {
    ...
    featuredIn: [{ label: '10 Dias de Safari de Luxo em Família na Tanzânia', href: '/safaris/10-days-luxury-family' }, { label: '7 Dias Joias do Norte', href: '/safaris/7-days-gems-of-north' }, { label: '8 Dias Grande Migração do Norte', href: '/safaris/8-days-great-northern-migration' }, { label: 'Safari de 8 Dias — Travessia do Rio dos Nhus', href: '/safaris/8-days-flight-migration' }],
  },
  {
    slug: 'lemala-osonjoi',
    name: 'Lemala Osonjoi',
    ...
    description: 'Um acampamento privado de tendas próximo da estrada de descida, que leva os hóspedes ao fundo da cratera antes de a maioria dos outros acampamentos ter sequer terminado o pequeno-almoço.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Ilha de Zanzibar',
    description: 'Uma casa de hóspedes simples e bem localizada, para viajantes que prolongam a viagem até às praias de Zanzibar sem prolongar o orçamento.',
  ...
  },
  {
    ...
    description: 'Um acampamento de tendas clássico, gerido de forma simples e honesta, posicionado para as partidas matinais que fazem a diferença num game drive no ecossistema da Mara.',
    ...
    featuredIn: [{ label: '8 Dias Grande Migração do Norte', href: '/safaris/8-days-great-northern-migration' }, { label: 'Safari de 8 Dias — Travessia do Rio dos Nhus', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    description: 'Uma lodge de tendas próxima da zona fronteiriça entre o Quénia e a Tanzânia, posicionada especificamente para a época de travessias do rio durante a migração.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Quénia',
    description: 'Uma lodge Serena no cimo de uma colina, com vistas amplas sobre as planícies da reserva e o rio lá em baixo.',
    amenities: ['Wi-Fi Gratuito', 'Piscina', 'Restaurante de Serviço Completo', 'Vistas Panorâmicas'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Norte do Serengeti',
    description: 'Um acampamento de tendas móvel que se desloca com a própria migração, através do norte do Serengeti e da zona fronteiriça com a Mara.',
    ...
    featuredIn: [{ label: 'Safari Fotográfico na Tanzânia — Tarangire, Cratera do Ngorongoro & Serengeti', href: '/safaris/tanzania-photographic-safari' }, { label: 'Safari de 8 Dias — Travessia do Rio dos Nhus', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Masai Mara, Quénia',
    description: 'Uma lodge grande e bem estabelecida, próxima do corredor de travessia do rio durante a migração — a fiabilidade sólida da Sopa, apoiada por uma localização genuinamente forte.',
  ...
  },
  {
    ...
    description: 'Um acampamento de tendas perto do Lago Masek, mesmo no coração da época anual de nascimentos dos nhus.',
  ...
  },
  {
    ...
    description: 'Um pequeno acampamento de tendas na margem do Lago Tanganica, a base prática e confortável para o trekking de chimpanzés em Gombe.',
  ...
  },
  {
    ...
    description: 'Com vista para a planície aluvial aberta de Mikumi — um dos parques mais acessíveis do circuito sul, com uma lodge à altura dessa facilidade.',
    amenities: ['Piscina', 'Vistas Panorâmicas', 'Restaurante de Serviço Completo'],
  ...
  },
  {
    ...
    description: 'Uma eco-lodge na margem da Floresta de Nyungwe, perto dos pontos de partida para o trekking de chimpanzés através de uma das florestas tropicais de montanha mais antigas de África.',
    amenities: ['Restaurante de Serviço Completo', 'Observação de Vida Selvagem', 'Vistas da Floresta'],
    ...
    featuredIn: [{ label: 'Safari de Primatas no Ruanda & Escapadela à Praia de Zanzibar', href: '/safaris/12-days-rwanda-primates' }],
    needsPhotography: true,
  },
  {
    ...
    tier: 'reserve',
    location: 'Ndutu, Sul do Serengeti',
    description: 'Um acampamento de tendas sazonal, sincronizado com precisão com a época anual de nascimentos dos nhus.',
    amenities: ['Quartos com Casa de Banho Privativa', 'Observação de Vida Selvagem'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Ndutu, Sul do Serengeti',
    description: 'Uma lodge permanente de pedra e colmo, com 34 cottages, com vista para o Lago Ndutu, posicionada para acesso durante todo o ano aos predadores residentes que nunca partem quando a migração segue caminho.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Karatu, Terras Altas do Ngorongoro',
    description: 'Uma plantação de café em atividade transformada em lodge, entre bananais na borda da cratera — descontraída e acolhedora por opção, sem pretensões de ser mais do que isso.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, Terras Altas do Ngorongoro',
    description: 'Uma lodge de gama média nas terras altas, com acesso fácil à estrada de descida à cratera para game drives matinais.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Área de Conservação do Ngorongoro',
    description: 'Situada diretamente na borda da cratera, entre as propriedades mais próximas da estrada de descida, com vistas genuínas e desimpedidas sobre a cratera.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Área de Conservação do Ngorongoro',
    description: 'Uma lodge Serena de pedra, escavada na borda florestada da cratera, com quartos que olham diretamente para o fundo do Ngorongoro.',
    amenities: ['Vistas Panorâmicas', 'Restaurante de Serviço Completo', 'Quartos com Casa de Banho Privativa'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Nungwi, Zanzibar',
    description: 'Uma propriedade à beira-mar na ponta norte de Zanzibar, conhecida entre os hóspedes pelas águas calmas para nadar e por pôres do sol seguramente bonitos.',
    ...
    featuredIn: [{ label: '7 Dias Safari Joias da Coroa', href: '/safaris/7-days-crown-jewels' }, { label: 'Safari de Lua de Mel de 9 Dias & Escapadela à Praia de Zanzibar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }, { label: '10 Dias de Safari na Tanzânia & Praia de Zanzibar', href: '/safaris/10-day-safari-zanzibar' }, { label: 'Safari de Primatas no Ruanda & Escapadela à Praia de Zanzibar', href: '/safaris/12-days-rwanda-primates' }],
  },
  {
    slug: 'ol-tukai-lodge',
    name: 'Ol Tukai Lodge',
    ...
    description: 'Dentro do próprio parque, com algumas das vistas do Kilimanjaro mais consistentemente fiáveis de entre todas as propriedades de Amboseli — uma verdadeira diferença a este nível de preço.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Floresta de Nyungwe, Ruanda',
    description: 'Uma marca de luxo ultra reconhecida mundialmente, instalada numa plantação de chá em atividade na margem de Nyungwe — construída em torno do trekking de chimpanzés e do acesso ao passadiço nas copas das árvores, e não dos gorilas.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kilimanjaro Ocidental',
    description: 'Uma lodge de propriedade Maasai aos pés do Kilimanjaro, com uma categoria de suíte premium Kisiwa Boma para além dos quartos standard — uma propriedade distinta da Africa Amini Original Maasai Lodge, posicionada em separado.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Ruanda',
    description: 'Um hotel internacional de serviço completo no centro de Kigali, uma paragem de entrada confortável antes ou depois do trekking de primatas no Ruanda.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Ilha de Zanzibar',
    description: 'Um resort tudo incluído à beira-mar, a paragem final habitual para safaris que se prolongam até à ilha.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Parque Nacional de Ruaha',
    description: 'Espalhada ao longo do Grande Rio Ruaha, no maior parque nacional da Tanzânia e um dos genuinamente menos visitados.',
    amenities: ['Vistas Panorâmicas', 'Observação de Vida Selvagem', 'Restaurante de Serviço Completo'],
    ...
    featuredIn: [{ label: '10 Dias Segredos do Sul da Tanzânia', href: '/safaris/10-days-southern-secrets' }, { label: '11 Dias Vida Selvagem do Sul & Ilhas das Especiarias', href: '/safaris/11-days-southern-spice' }, { label: '7 Dias Circuito Sul — Ruaha & Nyerere', href: '/safaris/7-day-southern-circuit' }],
  },
  {
    ...
    description: 'Um acampamento à beira-rio no Rufiji, a base tanto para game drives como para safaris de barco na mesma viagem.',
  ...
  },
  {
    ...
    description: 'Com vista para o Lago Ihema, em Akagera, o próprio destino Big Five do Ruanda e uma paisagem genuinamente diferente da dos vulcões.',
    amenities: ['Vistas Panorâmicas', 'Observação de Vida Selvagem'],
  ...
  },
  {
    ...
    description: 'Junto ao Rio Ewaso Nyiro, refúgio de espécies que quase não se encontram em mais lado nenhum do Quénia — girafa-reticulada, zebra-de-grevy, gerenuk.',
    amenities: ['Vistas Panorâmicas', 'Observação de Vida Selvagem'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parque Nacional de Nyerere (Selous)',
    description: 'Construído nas rochas acima do Rio Rufiji e acessível apenas por avioneta — remoto de uma forma que poucas propriedades deste nível conseguem igualar.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Parque Nacional do Lago Nakuru, Quénia',
    description: 'Em terreno elevado dentro do parque, com vistas amplas sobre o lago e a vida selvagem que este atrai.',
    amenities: ['Wi-Fi Gratuito', 'Piscina', 'Restaurante de Serviço Completo', 'Vistas Panorâmicas'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Parque Nacional de Nyerere (Selous)',
    description: 'Uma lodge Serena sobre os rápidos do Rio Rufiji, que combina game drives com atividades fluviais na mesma estadia.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Centro do Serengeti',
    description: 'Um acampamento privado, pensado deliberadamente para ter uma presença mais pequena e exclusiva no ecossistema do que as propriedades maiores do centro do Serengeti.',
    ...
    featuredIn: [{ label: 'Safari de 10 Dias – A Grande Migração Definitiva — Travessia do Rio Mara', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '10 Dias de Safari na Tanzânia & Praia de Zanzibar', href: '/safaris/10-day-safari-zanzibar' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Centro do Serengeti',
    description: 'Um acampamento de tendas clássico sob a copa de acácias, mesmo no coração das planícies ricas em vida selvagem — bom acesso sem o preço premium.',
    ...
    featuredIn: [{ label: '5 Dias Safari de Destaques', href: '/safaris/5-days-highlights-safari' }, { label: '7 Dias Safari Serengeti & Ngorongoro', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 Dias Grande Migração do Norte', href: '/safaris/8-days-great-northern-migration' }, { label: 'Safari de 8 Dias — Travessia do Rio dos Nhus', href: '/safaris/8-days-flight-migration' }, { label: '10 Dias de Safari na Tanzânia & Praia de Zanzibar', href: '/safaris/10-day-safari-zanzibar' }, { label: 'Safari de Extensão ao Kilimanjaro de 5 Dias', href: '/safaris/kilimanjaro-extension-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Centro do Serengeti',
    description: 'Um acampamento de tendas simples, com acesso real às planícies centrais, com um preço pensado para viajantes que preferem gastar em mais dias de safari do que numa tenda mais sofisticada.',
    amenities: ['Quartos com Casa de Banho Privativa', 'Restaurante de Serviço Completo', 'Observação de Vida Selvagem'],
    ...
    featuredIn: [{ label: '12 Dias Ruanda, Tanzânia & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: 'Safari de Lua de Mel de 8 Dias — Para Amantes da Natureza', href: '/safaris/8-days-honeymoon-safari' }],
  },
  {
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'Uma propriedade de vila privada, uma alternativa mais pessoal a uma estadia de hotel convencional, antes ou depois do mato.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Centro do Serengeti',
    description: 'Um acampamento de tendas nas planícies, com uma categoria de suíte premium para além das tendas standard.',
  ...
  },
  {
    ...
    description: 'Dentro de Ol Pejeta, que alberga o maior santuário de rinocerontes-negros do Quénia e os últimos rinocerontes-brancos-do-norte do mundo — uma credencial de vida selvagem genuinamente rara.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parque Nacional de Tarangire',
    description: 'Um acampamento de tendas simples no circuito de Tarangire, bem posicionado para as densas manadas de elefantes do parque, sem o preço de um resort.',
    amenities: ['Quartos com Casa de Banho Privativa', 'Observação de Vida Selvagem', 'Restaurante de Serviço Completo'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Parque Nacional de Tarangire',
    description: 'Um acampamento de luxo elevado no circuito de Tarangire, parte da Elewana Collection, com vistas ao nível das copas das árvores sobre uma das paisagens com maior densidade de elefantes de África.',
    amenities: ['Piscina', 'Vistas Panorâmicas', 'Spa', 'Observação de Vida Selvagem'],
  ...
  },
  {
    ...
    description: 'Uma lodge de reserva na fronteira de Amboseli, construída em torno de um programa de conservação comunitária, além das suas próprias vistas do Kilimanjaro.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, Terras Altas do Ngorongoro',
    description: 'Uma mansão de estilo colonial numa plantação de café perto da borda da cratera, que alia arquitetura de época a uma cozinha que está genuinamente à altura da sua reputação.',
    ...
    featuredIn: [{ label: '10 Dias de Safari de Luxo em Família na Tanzânia', href: '/safaris/10-days-luxury-family' }, { label: '10 Dias de Safari na Tanzânia & Praia de Zanzibar', href: '/safaris/10-day-safari-zanzibar' }, { label: '7 Dias Safari Joias da Coroa', href: '/safaris/7-days-crown-jewels' }, { label: 'Safari de Destaques do Quénia & Tanzânia', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    slug: 'tloma-lodge',
    name: 'Tloma Lodge',
    tier: 'reserve',
    location: 'Karatu, Terras Altas do Ngorongoro',
    description: 'Uma lodge de jardim numa antiga plantação de café nos arredores de Karatu, descontraída e próxima da estrada de descida à cratera.',
  ...
  },
  {
    ...
    description: 'Um acampamento económico nas terras altas, a escolha sensata para viajantes que privilegiam o custo-benefício na etapa da cratera de uma viagem mais longa.',
    amenities: ['Restaurante de Serviço Completo', 'Jardins'],
    ...
    featuredIn: [{ label: '5 Dias Safari de Destaques', href: '/safaris/5-days-highlights-safari' }, { label: 'Safari de 8 Dias — Travessia do Rio dos Nhus', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Ruanda',
    description: 'Um hotel no centro de Kigali, confortável e bem localizado antes ou depois dos parques nacionais do Ruanda.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Ilha de Zanzibar',
    description: 'Uma propriedade Serena na Ilha de Zanzibar, a paragem de chegada onde o trekking de primatas no Ruanda dá lugar a uma sequência de dias de praia sem horários.',
    amenities: ['Piscina', 'Frente de Praia', 'Restaurante de Serviço Completo'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Região de Tarangire',
    description: 'Um acampamento de tendas no circuito de Tarangire, com guiamento fiável e boa observação de vida selvagem, a um preço genuinamente intermédio.',
    amenities: ['Restaurante de Serviço Completo', 'Wi-Fi Gratuito', 'Observação de Vida Selvagem'],
