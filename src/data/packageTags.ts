...
export const packageTags: Record<string, string[]> = {
  ...
  '10-day-safari-zanzibar': ['bigfive', 'beach', 'honeymoon', 'family', 'luxury'],
  'kilimanjaro-extension-safari': ['trekking', 'bigfive', 'classic'],
  ...
  '7-days-crown-jewels': ['bigfive', 'honeymoon', 'family', 'classic', 'luxury'],
  'rwanda-primates-zanzibar-seniors-groups': ['gorilla', 'beach', 'honeymoon', 'family'],
  ...
  'ultimate-tanzania-safari': ['bigfive', 'trekking', 'remote', 'classic'],
  ...
  '12-days-rwanda-primates': ['gorilla', 'beach', 'honeymoon'],
  ...
  '14-days-kilimanjaro-lemosho-safari': ['trekking', 'bigfive', 'classic'],
