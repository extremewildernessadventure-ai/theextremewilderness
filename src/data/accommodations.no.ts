...
export const accommodations: Accommodation[] = [
  {
    ...
    tier: 'sovereign',
    location: 'Nordlige Serengeti',
    description: 'En helt mobil luksusteltleir som følger selve den store migrasjonen — du jager ikke flokkene, du våkner ganske enkelt opp der de befinner seg akkurat nå.',
    amenities: ['Luksuriøse teltsuiter', 'Rom med eget bad', 'Beliggenhet på migrasjonsruten', 'Restaurant med full service'],
    ...
    featuredIn: [{ label: 'Høydepunkter i Kenya og Tanzania-safari', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    ...
    description: 'En masaidrevet lodge på Kilimanjaros vestlige skråninger, bygget rundt ekte kulturell utveksling med lokalsamfunnet omkring, snarere enn en iscenesatt utgave av det.',
    amenities: ['Panoramautsikt', 'Kulturelle opplevelser'],
    ...
    featuredIn: [{ label: '12-dagers villmarkssafari, kulturmøter og Kilimanjaro-dagsvandring', href: '/safaris/12-days-wild-wilderness' }],
  },
  {
    slug: 'andbeyond-lake-manyara-tree-lodge',
    name: 'andBeyond Lake Manyara Tree Lodge',
    tier: 'sovereign',
    location: 'Lake Manyara nasjonalpark',
    description: 'Den eneste permanente lodgen inne i selve Lake Manyara, med trehussuiter hevet opp i grunnvannsskogens trekroner — et genuint annerledes utsiktspunkt over parken enn noe som helst i utkanten av den.',
    amenities: ['Panoramautsikt', 'Utsikt til dyreliv', 'Trehussuiter', 'Beliggenhet i skogens trekroner', 'Rom med eget bad', 'Restaurant med full service'],
    ...
    featuredIn: [{ label: '12 dager Tanzania-Kenya-ekspedisjon', href: '/safaris/12-days-tanzania-kenya' }, { label: '7 dager: Perler i nord', href: '/safaris/7-days-gems-of-north' }, { label: 'Høydepunkter i Kenya og Tanzania-safari', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    slug: 'angama-mara',
    name: 'Angama Mara',
    ...
    description: 'Tronende på Oloololo-skrenten med utsikt over hele Mara-sletten — et utsiktspunkt som er blitt et av de mest fotograferte i Øst-Afrika, av gode grunner.',
    amenities: ['Svømmebasseng', 'Panoramautsikt', 'Spa', 'Beliggenhet på migrasjonsruten'],
    ...
    featuredIn: [{ label: '5 dager Kenya-safari — Hell’s Gate, Lake Nakuru og Masai Mara', href: '/safaris/5-day-kenya-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'En aktiv kaffeplantasje nær flyplassen som gjør den første eller siste natten om fra en formalitet til en genuint avslappet opplevelse.',
    amenities: ['Gratis wi-fi', 'Svømmebasseng', 'Panoramautsikt', 'Hageanlegg', 'Restaurant med full service'],
    ...
    featuredIn: [{ label: '10 dager Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '10 dager Tanzania luksus-familiesafari', href: '/safaris/10-days-luxury-family' }, { label: '10-dagers ultimate migrasjonssafari — elvekryssinger ved Mara-elven', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '12 dager: Rwanda, Tanzania og Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '12-dagers Tanzania-safari for seniorer, jubileer og grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '7 dager Crown Jewels-safari', href: '/safaris/7-days-crown-jewels' }, { label: '7 dager: Flytur over Ndutu-migrasjonen', href: '/safaris/7-days-flight-ndutu' }, { label: '7 dager: Perler i nord', href: '/safaris/7-days-gems-of-north' }, { label: '7 dager Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '7-dagers fotografi- og eventyrsafari i Tanzania', href: '/safaris/7-day-photography-adventure-safari' }, { label: '8-dagers safari til gnuenes elvekryssing', href: '/safaris/8-days-flight-migration' }, { label: '8 dager: Den store nordlige migrasjonen', href: '/safaris/8-days-great-northern-migration' }, { label: 'Kilimanjaro Lemosho-bestigning og 5-dagers høydepunktssafari', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }],
  },
  {
    slug: 'bisate-lodge',
    name: 'Bisate Lodge',
    tier: 'sovereign',
    location: 'Volcanoes nasjonalpark, Rwanda',
    description: 'Kuppelformede skogvillaer bygget inn i et restaurert vulkansk amfiteater, en kort kjøretur fra utgangspunktene for gorillatrekking — en av de mest anerkjente lodgene bygget i Afrika dette tiåret.',
    amenities: ['Panoramautsikt', 'Spa', 'Utsikt til dyreliv'],
    ...
    featuredIn: [{ label: '12 dager: Rwanda, Tanzania og Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }],
  },
  {
    ...
    description: 'En teltlodge ved grensen til Tarangire, plassert for tidlig tilgang til et av Afrikas tettest befolkede elefantlandskaper.',
    amenities: ['Restaurant med full service', 'Gratis wi-fi', 'Utsikt til dyreliv'],
    ...
    featuredIn: [{ label: 'Tanzania fotosafari — Tarangire, Ngorongoro-krateret og Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Tarangire nasjonalpark',
    description: 'En ukomplisert leir som bruker pengene der de betyr mest på Tarangire-ruten: solid guiding, et velfungerende kjøkken og en rimelig pris fremfor et resortbudsjett.',
    amenities: ['Restaurant med full service', 'Gratis wi-fi'],
    ...
    featuredIn: [{ label: '10-dagers ultimate migrasjonssafari — elvekryssinger ved Mara-elven', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }],
  },
  {
    ...
    description: 'Et byhotell direkte ved stranden på Msasani-halvøya — genuint komfortabelt, og det faste overnattingsstoppet på vei til eller fra den sørlige safariruten.',
    amenities: ['Svømmebasseng', 'Restaurant med full service', 'Gratis wi-fi'],
    ...
    featuredIn: [{ label: '5 dager: Privat sjimpansetrekking i Gombe', href: '/safaris/5-day-gombe-chimpanzee-trekking' }, { label: '7 dager på den sørlige safariruten — Ruaha & Nyerere', href: '/safaris/7-day-southern-circuit' }, { label: 'Den ultimate Tanzania-safarien og sjimpansetrekking i Gombe', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
    ...
    description: 'Et all-inclusive strandresort på Zanzibars Nungwi-kyst, det avsluttende stoppet i Wilderness Reserve-nivået på reiseplanen 10 dager Tanzania-safari & Zanzibar-strand.',
    amenities: ['All-inclusive', 'Svømmebasseng', 'Direkte ved stranden', 'Restaurant med full service'],
    ...
    featuredIn: [{ label: '10 dager Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }],
  ...
  },
  {
    ...
    description: 'En enkel base i Kigali uten dikkedarer for reisende som heller vil bruke budsjettet på turens gorillatrekking og primatetapper enn på den første og siste natten i byen.',
    amenities: ['Gratis wi-fi', 'Svømmebasseng', 'Restaurant med full service'],
  ...
  },
  {
    ...
    description: 'Et pålitelig, godt beliggende inngangsporthotell i Nairobi — den typen praktiske første eller siste stopp som gjør sin ene jobb godt før eller etter at parkene tar over.',
    amenities: ['Gratis wi-fi', 'Svømmebasseng', 'Restaurant med full service'],
    ...
    featuredIn: [{ label: '10 dagers Kenya- og Tanzania-safari', href: '/safaris/10-day-kenya-tanzania-safari' }],
  },
  {
    ...
    description: 'Bygget rundt en naturlig kilde som trekker elefanter og annet dyreliv rett forbi eiendommen — en leir i mellomklassen med et fortrinn innen dyrelivsopplevelser som de fleste leirer i mellomklassen ikke har.',
    amenities: ['Svømmebasseng', 'Panoramautsikt', 'Restaurant med full service'],
    ...
    featuredIn: [{ label: '7-dagers fotografi- og eventyrsafari i Tanzania', href: '/safaris/7-day-photography-adventure-safari' }, { label: '10 dager Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }],
  },
  {
    ...
    description: 'Et ekte spa-resort ved bredden av Naivasha — en ekte rolig dag lagt inn midt i en hverdag i Rift Valley-dalen, ikke bare enda en lodge mellom game drive-turer.',
    amenities: ['Spa', 'Svømmebasseng', 'Panoramautsikt', 'Gratis wi-fi'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Sentrale Serengeti',
    description: 'Bygget rundt sitt eget vannhull i hjertet av Serengeti, der dyrelivet jevnlig passerer rett under terrassen — Four Seasons-standarden, midt ute på slettene.',
    amenities: ['Svømmebasseng', 'Spa', 'Panoramautsikt'],
    ...
    featuredIn: [{ label: '12 dager: Rwanda, Tanzania og Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '12-dagers villmarkssafari, kulturmøter og Kilimanjaro-dagsvandring', href: '/safaris/12-days-wild-wilderness' }],
  },
  {
    slug: 'gibbs-farm',
    name: "Gibb's Farm",
    tier: 'sovereign',
    location: 'Karatu, Ngorongoro-høylandet',
    description: 'En mangeårig økologisk gård under kraterranden, som fortsatt dyrker sin egen kaffe og sine egne avlinger, og som bredt anses som et av Tanzanias fineste kjøkken, punktum — ikke bare blant lodger.',
    amenities: ['Spa', 'Panoramautsikt', 'Økologisk fra gård til bord'],
    ...
    featuredIn: [{ label: '10-dagers ultimate migrasjonssafari — elvekryssinger ved Mara-elven', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '12 dager: Rwanda, Tanzania og Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '12-dagers Tanzania-safari for seniorer, jubileer og grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '12-dagers villmarkssafari, kulturmøter og Kilimanjaro-dagsvandring', href: '/safaris/12-days-wild-wilderness' }, { label: '5 dager Serengeti fly-in safari', href: '/safaris/5-day-serengeti-fly-in' }, { label: '7 dager Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 dager: Den store nordlige migrasjonen', href: '/safaris/8-days-great-northern-migration' }, { label: '8-dagers bryllupsreisesafari — for bushelskere', href: '/safaris/8-days-honeymoon-safari' }, { label: '9 dager bryllupsreise-safari og strandopphold på Zanzibar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }],
  },
  {
    slug: 'governors-camp',
    name: 'Governors Camp',
    tier: 'reserve',
    location: 'Masai Mara, Kenya',
    description: 'Den opprinnelige luksusteltleiren i Mara, i kontinuerlig drift siden 1972, på bredden av Mara-elven i en av reservatets mest pålitelige dyrelivskorridorer — et ikon, ikke et budsjettstopp.',
    amenities: ['Gratis wi-fi', 'Svømmebasseng', 'Restaurant med full service', 'Utsikt over Mara-elven'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'Meliás eget luksus-undermerke, tett på flyplassen — fulle resortfasiliteter og ekte raffinement for reisende som ønsker mer komfort før eller etter bushen.',
    amenities: ['Gratis wi-fi', 'Svømmebasseng', 'Spa'],
    ...
    featuredIn: [{ label: '10 dager Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '10 dager Tanzania luksus-familiesafari', href: '/safaris/10-days-luxury-family' }, { label: '12 dager: Rwanda, Tanzania og Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '12-dagers villmarkssafari, kulturmøter og Kilimanjaro-dagsvandring', href: '/safaris/12-days-wild-wilderness' }, { label: '7 dager Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '7-dagers fotografi- og eventyrsafari i Tanzania', href: '/safaris/7-day-photography-adventure-safari' }, { label: '8 dager: Den store nordlige migrasjonen', href: '/safaris/8-days-great-northern-migration' }, { label: '8-dagers safari til gnuenes elvekryssing', href: '/safaris/8-days-flight-migration' }, { label: 'Southern Edition: Tanzanias kalvingssesong-migrasjonssafari — Ndutu & Ngorongoro-krateret', href: '/safaris/7-days-migration-southern' }, { label: 'Tanzania fotosafari — Tarangire, Ngorongoro-krateret og Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    slug: 'great-rift-valley-lodge-and-golf-resort',
    name: 'Great Rift Valley Lodge & Golf Resort',
    tier: 'sovereign',
    location: 'Rift Valley-dalen, Kenya',
    description: 'Beliggende rett på skrenten, og kombinerer vidstrakt utsikt over dalen med fulle golf- og spafasiliteter som de fleste safarianlegg rett og slett ikke tilbyr.',
    amenities: ['Svømmebasseng', 'Panoramautsikt', 'Spa', 'Utsikt over Rift Valley-dalen'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Nairobi, Kenya',
    description: 'Et boutiquehotell i kolonistil i Karen, del av den globalt anerkjente Hemingways Collection — genuint komfortabelt fremfor bare praktisk, i begge ender av en Kenya-safari.',
    amenities: ['Svømmebasseng', 'Spa', 'Restaurant med full service', 'Gratis wi-fi'],
    ...
    featuredIn: [{ label: '11 dager: Kenya uten sidestykke', href: '/safaris/11-days-kenya-undisputed' }, { label: '12 dager Tanzania-Kenya-ekspedisjon', href: '/safaris/12-days-tanzania-kenya' }, { label: 'Autentisk, eksklusivt Kenya — Amboseli, Samburu og Masai Mara', href: '/safaris/authentic-exclusive-kenya' }, { label: 'Klassisk Kenya-safari — Masai Mara, Rift Valley og Amboseli', href: '/safaris/classic-kenya-safari' }, { label: 'Høydepunkter i Kenya og Tanzania-safari', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    slug: 'hondo-hondo-udzungwa-forest-camp',
    name: 'Hondo Hondo Udzungwa Forest Camp',
    tier: 'reserve',
    location: 'Udzungwa Mountains nasjonalpark',
    description: 'En leir i skogkanten bygget for vandring og primatsporing i en av Tanzanias minst besøkte og mest givende parker, for reisende som vil ha noe utover standardruten.',
    amenities: ['Hageanlegg', 'Panoramautsikt'],
    ...
    featuredIn: [{ label: '10 dager: Sør-Tanzanias hemmeligheter', href: '/safaris/10-days-southern-secrets' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Dar es Salaam',
    description: 'Et fullservicehotell ved vannet, brukt som et komfortabelt transittstopp på reiseplaner langs den sørlige safariruten — et sterkt valg i den øvre klassen, på samme merkenivå som Radisson Blu.',
    amenities: ['Svømmebasseng', 'Restaurant med full service', 'Gratis wi-fi'],
    ...
    featuredIn: [{ label: '7 dager på den sørlige safariruten — Ruaha & Nyerere', href: '/safaris/7-day-southern-circuit' }],
  },
  {
    slug: 'ikuka-camp',
    name: 'Ikuka Camp',
    tier: 'sovereign',
    location: 'Ruaha nasjonalpark',
    description: 'En privat leir på en steinete utløper over Ruaha-elven, i en av Tanzanias største og minst overfylte parker.',
    amenities: ['Panoramautsikt', 'Utsikt til dyreliv', 'Restaurant med full service'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Volcanoes nasjonalpark, Rwanda',
    description: 'En budsjettvennlig lodge rett ved grensen til Volcanoes nasjonalpark, bevisst plassert for de tidlige avgangene en morgen med gorillatrekking krever.',
    amenities: ['Restaurant med full service', 'Hageanlegg'],
    ...
    featuredIn: [{ label: '4 dager: Gorillatrekking i Rwanda', href: '/safaris/4-day-rwanda-gorilla-trekking' }, { label: 'Primatsafari i Rwanda og strandopphold på Zanzibar', href: '/safaris/12-days-rwanda-primates' }],
  },
  {
    slug: 'kahawa-house',
    name: 'Kahawa House',
    tier: 'trail',
    location: 'Arusha',
    description: 'Et avslappet gjestehus på en aktiv kaffeplantasje utenfor Arusha — en genuint rolig og veldrevet første eller siste natt før eller etter bushen.',
    amenities: ['Gratis wi-fi', 'Restaurant med full service', 'Hageanlegg'],
    ...
    featuredIn: [{ label: '10 dager Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '10 dagers Kenya- og Tanzania-safari', href: '/safaris/10-day-kenya-tanzania-safari' }, { label: '10-dagers ultimate migrasjonssafari — elvekryssinger ved Mara-elven', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '12 dager: Rwanda, Tanzania og Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '12-dagers Tanzania-safari for seniorer, jubileer og grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '12-dagers villmarkssafari, kulturmøter og Kilimanjaro-dagsvandring', href: '/safaris/12-days-wild-wilderness' }, { label: '4 dager Tarangire, Ngorongoro og Lake Eyasi', href: '/safaris/4-day-tarangire-ngorongoro-lake-eyasi' }, { label: '5 dager Serengeti fly-in safari', href: '/safaris/5-day-serengeti-fly-in' }, { label: '5-dagers komfortsafari i Tanzania', href: '/safaris/5-day-comfort-tanzania-safari' }, { label: '5-dagers Kilimanjaro-forlengelsessafari', href: '/safaris/kilimanjaro-extension-safari' }, { label: '6-dagers komfortsafari i Tanzania', href: '/safaris/6-day-comfort-tanzania-safari' }, { label: '7 dager Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 dager: Den store nordlige migrasjonen', href: '/safaris/8-days-great-northern-migration' }, { label: '8-dagers bryllupsreisesafari — for bushelskere', href: '/safaris/8-days-honeymoon-safari' }, { label: '8-dagers safari til gnuenes elvekryssing', href: '/safaris/8-days-flight-migration' }, { label: 'Kilimanjaro Lemosho-bestigning og 5-dagers høydepunktssafari', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }, { label: 'Southern Edition: Tanzanias kalvingssesong-migrasjonssafari — Ndutu & Ngorongoro-krateret', href: '/safaris/7-days-migration-southern' }, { label: 'Tanzania fotosafari — Tarangire, Ngorongoro-krateret og Serengeti', href: '/safaris/tanzania-photographic-safari' }, { label: 'Den ultimate Tanzania-safarien og sjimpansetrekking i Gombe', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
    slug: 'kambi-ya-tembo',
    name: 'Kambi ya Tembo',
    tier: 'reserve',
    location: 'Vestlige Kilimanjaro',
    description: 'En teltleir på privat grunn ved foten av Kilimanjaro, kjent for de fastboende elefantflokkene som passerer rett gjennom leiren, og en fjellkulisse som ikke trenger noen utsmykning.',
    amenities: ['Panoramautsikt', 'Utsikt til dyreliv'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenya',
    description: '&Beyonds egen mer tilgjengelige Mara-leir — den fulle andBeyond-standarden for gjestfrihet og beliggenhet, til en merkbart mildere pris enn deres signatureiendommer.',
    amenities: ['Utsikt til dyreliv', 'Panoramautsikt', 'Svømmebasseng', 'Spa', 'Beliggenhet på migrasjonsruten', 'Restaurant med full service'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Rwanda',
    description: 'Et sentralt hotell i Kigali med Serenas konsekvente 5-stjerners standard — et genuint komfortabelt overnattingsstopp før eller etter gorillatrekking i Virunga-fjellene, ikke en budsjettløsning.',
    amenities: ['Gratis wi-fi', 'Svømmebasseng', 'Restaurant med full service'],
  ...
  },
  {
    ...
    name: 'Kigoma Hilltop',
    tier: 'trail',
    location: 'Kigoma, Tanganyikasjøen',
    description: 'En lodge på en bakkeskråning med ekte utsikt over Tanganyikasjøen, som fungerer som inngangsport til en av Tanzanias mest avsidesliggende og givende opplevelser: sjimpansetrekking i Gombe og Mahale.',
    amenities: ['Panoramautsikt', 'Restaurant med full service'],
    ...
    featuredIn: [{ label: '5 dager: Privat sjimpansetrekking i Gombe', href: '/safaris/5-day-gombe-chimpanzee-trekking' }, { label: 'Den ultimate Tanzania-safarien og sjimpansetrekking i Gombe', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
    slug: 'kilindi-zanzibar',
    name: 'Kilindi Zanzibar',
    tier: 'sovereign',
    location: 'Zanzibar-øya',
    description: 'Kuppelformede private pavilonger bygget inn i skråningen over Det indiske hav, hver med sitt eget plunge pool — et bevisst temposkifte etter dager i bushen.',
    amenities: ['Svømmebasseng', 'Spa', 'Direkte ved stranden', 'All-inclusive', 'Panoramautsikt'],
    ...
    featuredIn: [{ label: '10 dager Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '11 dager: Sørlig dyreliv og krydderøyene', href: '/safaris/11-days-southern-spice' }, { label: '12 dager: Rwanda, Tanzania og Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '9 dager bryllupsreise-safari og strandopphold på Zanzibar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Volcanoes nasjonalpark, Rwanda',
    description: 'Et ukomplisert gjestehus ved porten til Volcanoes nasjonalpark, bygget spesifikt rundt de tidlige avgangene en morgen med gorillatrekking krever.',
    amenities: ['Panoramautsikt', 'Hageanlegg', 'Rom med eget bad', 'Restaurant med full service'],
    ...
    featuredIn: [{ label: '11 dager: Rwanda og Tanzania-safari', href: '/safaris/11-days-rwanda-tanzania' }, { label: '12 dager: Rwanda, Tanzania og Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }],
  },
  {
    ...
    description: 'En teltleir på Rift Valley-dalens skrent, med en utsikt som taler for seg selv — dalbunnen strekker seg ut nedenfor, så langt øyet rekker.',
    amenities: ['Gratis wi-fi', 'Restaurant med full service', 'Utsikt over Rift Valley-dalen', 'Svømmebasseng'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Lake Eyasi',
    description: 'En liten teltleir ved Lake Eyasi, den vanlige og best plasserte basen for besøk hos hadzabe-folkets jeger-sanker-samfunn.',
    amenities: ['Panoramautsikt', 'Hageanlegg'],
    ...
    featuredIn: [{ label: '11 dager: Rwanda og Tanzania-safari', href: '/safaris/11-days-rwanda-tanzania' }],
  },
  {
    slug: 'kitela-lodge',
    name: 'Kitela Lodge',
    tier: 'reserve',
    location: 'Karatu, Ngorongoro-høylandet',
    description: 'En tidligere kaffeplantasje med brede verandaer vendt mot Rift Valley-dalens skrent og et kjøkken som virkelig er verdt å snakke om, tett på veien til kraterranden.',
    amenities: ['Svømmebasseng', 'Panoramautsikt', 'Restaurant med full service', 'Hageanlegg'],
    ...
    featuredIn: [{ label: '10 dager Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '10 dager Tanzania luksus-familiesafari', href: '/safaris/10-days-luxury-family' }, { label: '11 dager: Rwanda og Tanzania-safari', href: '/safaris/11-days-rwanda-tanzania' }, { label: '12 dager: Rwanda, Tanzania og Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '12 dager Tanzania-Kenya-ekspedisjon', href: '/safaris/12-days-tanzania-kenya' }, { label: '5 dager høydepunktsafari', href: '/safaris/5-days-highlights-safari' }, { label: '5 dager Serengeti fly-in safari', href: '/safaris/5-day-serengeti-fly-in' }, { label: '7 dager Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 dager: Den store nordlige migrasjonen', href: '/safaris/8-days-great-northern-migration' }, { label: 'Kilimanjaro Lemosho-bestigning og 5-dagers høydepunktssafari', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }],
  },
  {
    slug: 'kubukubu-tented-lodge',
    name: 'Kubukubu Tented Lodge',
    tier: 'reserve',
    location: 'Sentrale Serengeti / Tarangire',
    description: 'En pålitelig teltlodge som brukes på både Tarangire- og det sentrale Serengeti-benet av flere av våre reiseplaner — solid guiding til en rimelig pris, hver gang.',
    amenities: ['Svømmebasseng', 'Panoramautsikt', 'Restaurant med full service', 'Gratis wi-fi', 'All-inclusive', 'Rom med eget bad'],
    ...
    featuredIn: [{ label: '10 dager Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '10 dager Tanzania luksus-familiesafari', href: '/safaris/10-days-luxury-family' }, { label: '10 dagers Kenya- og Tanzania-safari', href: '/safaris/10-day-kenya-tanzania-safari' }, { label: '10-dagers ultimate migrasjonssafari — elvekryssinger ved Mara-elven', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '12 dager: Rwanda, Tanzania og Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '12-dagers Tanzania-safari for seniorer, jubileer og grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '12-dagers villmarkssafari, kulturmøter og Kilimanjaro-dagsvandring', href: '/safaris/12-days-wild-wilderness' }, { label: '5 dager Serengeti fly-in safari', href: '/safaris/5-day-serengeti-fly-in' }, { label: '5-dagers komfortsafari i Tanzania', href: '/safaris/5-day-comfort-tanzania-safari' }, { label: '6-dagers komfortsafari i Tanzania', href: '/safaris/6-day-comfort-tanzania-safari' }, { label: '7 dager Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8-dagers safari til gnuenes elvekryssing', href: '/safaris/8-days-flight-migration' }, { label: '8 dager: Den store nordlige migrasjonen', href: '/safaris/8-days-great-northern-migration' }, { label: '9 dager bryllupsreise-safari og strandopphold på Zanzibar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }, { label: 'Høydepunkter i Kenya og Tanzania-safari', href: '/safaris/kenya-tanzania-highlights-safari' }, { label: 'Tanzania fotosafari — Tarangire, Ngorongoro-krateret og Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    slug: 'la-palme-hotel',
    name: 'La Palme Hotel',
    ...
    description: 'En komfortabel, sentral base i Musanze før du drar ut for å spore gorillaer i Volcanoes.',
    amenities: ['Gratis wi-fi', 'Restaurant med full service', 'Hageanlegg'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Sentrale Serengeti',
    description: 'En teltleir i hjertet av slettene, med kort avstand til noe av økosystemets mest pålitelige dyrelivsopplevelser hele året.',
    amenities: ['Panoramautsikt', 'Restaurant med full service', 'Utsikt til dyreliv'],
    ...
    featuredIn: [{ label: '5 dager høydepunktsafari', href: '/safaris/5-days-highlights-safari' }, { label: 'Kilimanjaro Lemosho-bestigning og 5-dagers høydepunktssafari', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Tarangire nasjonalpark',
    description: 'En teltlodge ved bredden av Lake Burunge, på grensen til Tarangire, best kjent blant gjestene for sin solnedgangsutsikt rett over vannet.',
    amenities: ['Restaurant med full service', 'Hageanlegg', 'Svømmebasseng', 'Gratis wi-fi', 'Utsikt over sjøen'],
    ...
    featuredIn: [{ label: '8 dager: Den store nordlige migrasjonen', href: '/safaris/8-days-great-northern-migration' }, { label: '12-dagers Tanzania-safari for seniorer, jubileer og grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '5-dagers komfortsafari i Tanzania', href: '/safaris/5-day-comfort-tanzania-safari' }, { label: '5-dagers Kilimanjaro-forlengelsessafari', href: '/safaris/kilimanjaro-extension-safari' }, { label: '6-dagers komfortsafari i Tanzania', href: '/safaris/6-day-comfort-tanzania-safari' }],
  },
  {
    ...
    description: 'En Serena-teltleir ved en roligere innsjø i Rift Valley-dalen enn dens travlere naboer.',
    amenities: ['Panoramautsikt', 'Restaurant med full service', 'Utsikt over sjøen', 'Gratis wi-fi'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kivusjøen, Rwanda',
    description: 'Et Serena-anlegg ved sjøen, som regel det avsluttende stoppet på en Rwanda-reiseplan når primattrekkingens etapper er unnagjort.',
    amenities: ['Svømmebasseng', 'Panoramautsikt', 'Restaurant med full service'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Lake Naivasha, Kenya',
    description: 'Et pålitelig resort ved sjøen, godt plassert for båtturer til Crescent Island og gåsafarier — den typen komfortable opphold uten overraskelser som Sopas eiendommer er kjent for i hele Øst-Afrika.',
    amenities: ['Gratis wi-fi', 'Svømmebasseng', 'Restaurant med full service', 'Utsikt over sjøen'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Lake Nakuru nasjonalpark, Kenya',
    description: 'Inne i selve parken, historisk kjent for sin flamingokantede strandlinje og fastboende neshornbestand.',
    amenities: ['Panoramautsikt', 'Restaurant med full service', 'Gratis wi-fi'],
    ...
    featuredIn: [{ label: '11 dager: Kenya uten sidestykke', href: '/safaris/11-days-kenya-undisputed' }, { label: '12 dager Tanzania-Kenya-ekspedisjon', href: '/safaris/12-days-tanzania-kenya' }, { label: '5 dager Kenya-safari — Hell’s Gate, Lake Nakuru og Masai Mara', href: '/safaris/5-day-kenya-safari' }, { label: 'Klassisk Kenya-safari — Masai Mara, Rift Valley og Amboseli', href: '/safaris/classic-kenya-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Lake Nakuru nasjonalpark, Kenya',
    description: 'Beliggende høyt over sjøen med genuint panoramautsikt, og den samme pålitelige Sopa-standarden som finnes på deres andre østafrikanske eiendommer.',
    amenities: ['Gratis wi-fi', 'Svømmebasseng', 'Restaurant med full service', 'Panoramautsikt'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Nordlige Serengeti, Kogatende',
    description: 'En privat leir på en bakketopp rett over Mara-elvens krysningssteder — en av de best plasserte leirene på høydedraget for reisende som timer reisen sin etter selve krysningene.',
    amenities: ['Svømmebasseng', 'Panoramautsikt', 'Utsikt til dyreliv', 'Spa'],
    ...
    featuredIn: [{ label: '10-dagers ultimate migrasjonssafari — elvekryssinger ved Mara-elven', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '8 dager: Den store nordlige migrasjonen', href: '/safaris/8-days-great-northern-migration' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Tarangire nasjonalpark',
    description: 'En privat teltleir med utsikt over Tarangire-elven, i et av Afrikas tettest befolkede elefantlandskaper utenfor regntiden.',
    amenities: ['All-inclusive', 'Spa', 'Panoramautsikt', 'Utsikt til dyreliv'],
    ...
    featuredIn: [{ label: '10 dager Tanzania luksus-familiesafari', href: '/safaris/10-days-luxury-family' }, { label: '7 dager: Perler i nord', href: '/safaris/7-days-gems-of-north' }, { label: '8 dager: Den store nordlige migrasjonen', href: '/safaris/8-days-great-northern-migration' }, { label: '8-dagers safari til gnuenes elvekryssing', href: '/safaris/8-days-flight-migration' }],
  },
  {
    slug: 'lemala-osonjoi',
    name: 'Lemala Osonjoi',
    tier: 'sovereign',
    location: 'Ngorongoro naturvernområde',
    description: 'En privat teltleir tett på nedkjøringsveien, som får gjestene ned på kraterbunnen før de fleste andre leirer er ferdige med frokosten.',
    amenities: ['Spa', 'Panoramautsikt', 'Restaurant med full service'],
    ...
    featuredIn: [{ label: '10 dager Tanzania luksus-familiesafari', href: '/safaris/10-days-luxury-family' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Zanzibar-øya',
    description: 'Et enkelt, godt beliggende gjestehus for reisende som forlenger turen til Zanzibars strender uten å forlenge budsjettet.',
    amenities: ['Restaurant med full betjening', 'Rett ved stranden'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Nordlige Serengeti / Mara-grensen, Tanzania',
    description: 'En klassisk teltleir drevet enkelt og ærlig, plassert for de tidlige starttidspunktene som gjør forskjellen på en game drive i Mara-økosystemet.',
    amenities: ['Rom med eget bad', 'Utsikt til dyreliv'],
    ...
    featuredIn: [{ label: '8 dager: Den store nordlige migrasjonen', href: '/safaris/8-days-great-northern-migration' }, { label: '8-dagers safari til gnuenes elvekryssing', href: '/safaris/8-days-flight-migration' }],
  },
  {
    slug: 'mara-mara-tented-lodge',
    name: 'Mara Mara Tented Lodge',
    tier: 'reserve',
    location: 'Nordlige Serengeti / grensen til Masai Mara',
    description: 'En lodge med telt nær grenseområdet mellom Kenya og Tanzania, plassert spesifikt for migrasjonens elvekrysningssesong.',
    amenities: ['Utsikt til dyreliv', 'Panoramautsikt', 'Restaurant med full betjening'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenya',
    description: 'En Serena-lodge på en høyde, med vid utsikt over reservatets sletter og elven nedenfor.',
    amenities: ['Gratis wifi', 'Svømmebasseng', 'Restaurant med full betjening', 'Panoramautsikt'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Nordlige Serengeti',
    description: 'En mobil teltleir som flytter seg med selve migrasjonen gjennom nordlige Serengeti og grensen til Mara.',
    amenities: ['Utsikt til dyreliv', 'Panoramautsikt'],
    ...
    featuredIn: [{ label: 'Tanzania fotosafari — Tarangire, Ngorongoro-krateret og Serengeti', href: '/safaris/tanzania-photographic-safari' }, { label: '8-dagers safari til gnuenes elvekryssing', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Masai Mara, Kenya',
    description: 'En stor, veletablert lodge nær migrasjonens elvekrysningskorridor — solid Sopa-pålitelighet kombinert med en genuint sterk beliggenhet.',
    amenities: ['Gratis wifi', 'Svømmebasseng', 'Restaurant med full betjening', 'Utsikt over Mara-elven', 'Beliggenhet på migrasjonsruten'],
    ...
    featuredIn: [{ label: '10 dagers Kenya- og Tanzania-safari', href: '/safaris/10-day-kenya-tanzania-safari' }, { label: '5 dager Kenya-safari — Hell’s Gate, Lake Nakuru og Masai Mara', href: '/safaris/5-day-kenya-safari' }],
  },
  {
    slug: 'masek-tented-lodge',
    name: 'Masek Tented Lodge',
    tier: 'reserve',
    location: 'Ndutu, sørlige Serengeti',
    description: 'En teltleir ved Lake Masek, midt i hjertet av gnuenes kalvingssesong hvert år.',
    amenities: ['Panoramautsikt', 'Utsikt til dyreliv', 'Rom med eget bad'],
    ...
    featuredIn: [{ label: '7 dager: Flytur over Ndutu-migrasjonen', href: '/safaris/7-days-flight-ndutu' }, { label: '7-dagers fotografi- og eventyrsafari i Tanzania', href: '/safaris/7-day-photography-adventure-safari' }],
  },
  {
    slug: 'mbalimbali-gombe-tented-camp',
    name: 'Mbalimbali Gombe Tented Camp',
    tier: 'trail',
    location: 'Gombe Stream nasjonalpark',
    description: 'En liten teltleir ved bredden av Tanganyikasjøen, den praktiske og komfortable basen for sjimpansetrekking i Gombe.',
    amenities: ['Utsikt til dyreliv', 'Rom med eget bad'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Mikumi nasjonalpark',
    description: 'Med utsikt over Mikumis åpne flomslette — en av de mest lettilgjengelige parkene på den sørlige safariruten, med en lodge som matcher denne enkelheten.',
    amenities: ['Svømmebasseng', 'Panoramautsikt', 'Restaurant med full betjening'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Nyungwe-skogen, Rwanda',
    description: 'En økolodge i utkanten av Nyungwe-skogen, nær utgangspunktene for sjimpansetrekking gjennom en av Afrikas eldste montane regnskoger.',
    amenities: ['Restaurant med full betjening', 'Utsikt til dyreliv', 'Utsikt over skogen'],
    ...
    featuredIn: [{ label: 'Primatsafari i Rwanda og strandopphold på Zanzibar', href: '/safaris/12-days-rwanda-primates' }],
    needsPhotography: true,
  },
  {
    ...
    tier: 'reserve',
    location: 'Ndutu, sørlige Serengeti',
    description: 'En sesongbasert teltleir tidsbestemt nøyaktig etter gnuenes kalvingssesong hvert år.',
    amenities: ['Rom med eget bad', 'Utsikt til dyreliv'],
    ...
    featuredIn: [{ label: 'Southern Edition: Tanzanias kalvingssesong-migrasjonssafari — Ndutu & Ngorongoro-krateret', href: '/safaris/7-days-migration-southern' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Ndutu, sørlige Serengeti',
    description: 'En permanent lodge i stein og strå med 34 hytter og utsikt over Lake Ndutu, plassert for helårlig tilgang til de stedegne rovdyrene som aldri drar når migrasjonen trekker videre.',
    amenities: ['Rom med eget bad', 'Utsikt til dyreliv', 'Restaurant med full betjening', 'Panoramautsikt'],
    ...
    featuredIn: [{ label: '8 dager fotosafari utenfor allfarvei', href: '/safaris/off-the-beaten-track-photography-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Karatu, Ngorongoro-høylandet',
    description: 'En aktiv kaffegård forvandlet til en lodge blant bananlunder på kraterranden — avslappet og hjemmekoselig av natur, uten ambisjoner om å være noe mer storslått.',
    amenities: ['Restaurant med full betjening', 'Hageanlegg', 'Gratis wifi', 'Høylandshager', 'Aktiv gårdsdrift', 'Svømmebasseng'],
    ...
    featuredIn: [{ label: '10 dagers Kenya- og Tanzania-safari', href: '/safaris/10-day-kenya-tanzania-safari' }, { label: '10-dagers ultimate migrasjonssafari — elvekryssinger ved Mara-elven', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '12-dagers Tanzania-safari for seniorer, jubileer og grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '12-dagers villmarkssafari, kulturmøter og Kilimanjaro-dagsvandring', href: '/safaris/12-days-wild-wilderness' }, { label: '4 dager Tarangire, Ngorongoro og Lake Eyasi', href: '/safaris/4-day-tarangire-ngorongoro-lake-eyasi' }, { label: '5 dager høydepunktsafari', href: '/safaris/5-days-highlights-safari' }, { label: '5-dagers komfortsafari i Tanzania', href: '/safaris/5-day-comfort-tanzania-safari' }, { label: '6-dagers komfortsafari i Tanzania', href: '/safaris/6-day-comfort-tanzania-safari' }, { label: '7 dager Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 dager: Den store nordlige migrasjonen', href: '/safaris/8-days-great-northern-migration' }, { label: '9 dager bryllupsreise-safari og strandopphold på Zanzibar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }, { label: 'Høydepunkter i Kenya og Tanzania-safari', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, Ngorongoro-høylandet',
    description: 'En lodge i mellomklassen i høylandet, med enkel tilgang til nedkjøringsveien til krateret for tidlig game drive.',
    amenities: ['Panoramautsikt', 'Restaurant med full betjening', 'Rom med eget bad'],
    ...
    featuredIn: [{ label: '10 dager Tanzania luksus-familiesafari', href: '/safaris/10-days-luxury-family' }, { label: '7-dagers fotografi- og eventyrsafari i Tanzania', href: '/safaris/7-day-photography-adventure-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Ngorongoro naturvernområde',
    description: 'Ligger direkte på kraterranden, blant de eiendommene som ligger nærmest nedkjøringsveien, med ekte og uhindret utsikt over krateret.',
    amenities: ['Panoramautsikt', 'Spa', 'Restaurant med full betjening', 'Rom med eget bad'],
    ...
    featuredIn: [{ label: '12-dagers villmarkssafari, kulturmøter og Kilimanjaro-dagsvandring', href: '/safaris/12-days-wild-wilderness' }, { label: '5 dager høydepunktsafari', href: '/safaris/5-days-highlights-safari' }, { label: '7-dagers fotografi- og eventyrsafari i Tanzania', href: '/safaris/7-day-photography-adventure-safari' }, { label: '8-dagers safari til gnuenes elvekryssing', href: '/safaris/8-days-flight-migration' }, { label: 'Kilimanjaro Lemosho-bestigning og 5-dagers høydepunktssafari', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }, { label: 'Southern Edition: Tanzanias kalvingssesong-migrasjonssafari — Ndutu & Ngorongoro-krateret', href: '/safaris/7-days-migration-southern' }, { label: 'Tanzania fotosafari — Tarangire, Ngorongoro-krateret og Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Ngorongoro naturvernområde',
    description: 'En Serena-lodge bygget i stein, hugget inn i kraterets skogkledde rand, med rom som ser rett ned i Ngorongoro-krateret.',
    amenities: ['Panoramautsikt', 'Restaurant med full betjening', 'Rom med eget bad'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Nungwi, Zanzibar',
    description: 'En strandeiendom på nordspissen av Zanzibar, kjent blant gjestene for rolig badevann og pålitelig fine solnedganger.',
    amenities: ['Svømmebasseng', 'Panoramautsikt', 'Restaurant med full betjening', 'Gratis wifi'],
    ...
    featuredIn: [{ label: '7 dager Crown Jewels-safari', href: '/safaris/7-days-crown-jewels' }, { label: '9 dager bryllupsreise-safari og strandopphold på Zanzibar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }, { label: '10 dager Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: 'Primatsafari i Rwanda og strandopphold på Zanzibar', href: '/safaris/12-days-rwanda-primates' }],
  },
  {
    slug: 'ol-tukai-lodge',
    name: 'Ol Tukai Lodge',
    tier: 'trail',
    location: 'Amboseli nasjonalpark, Kenya',
    description: 'Inne i selve parken, med noen av de mest pålitelige Kilimanjaro-utsiktene av alle eiendommer i Amboseli — en reell forskjell på dette prisnivået.',
    amenities: ['Panoramautsikt', 'Utsikt til dyreliv', 'Svømmebasseng', 'Gratis wifi', 'Restaurant med full betjening', 'Utsikt til Kilimanjaro'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Nyungwe-skogen, Rwanda',
    description: 'En globalt anerkjent ultraluksuriøs merkevare plassert inne på en aktiv teplantasje i utkanten av Nyungwe — bygget rundt sjimpansetrekking og tilgang til hengebro i trekronene, snarere enn gorillaer.',
    amenities: ['Panoramautsikt', 'Spa', 'Restaurant med full betjening'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Vestlige Kilimanjaro',
    description: 'En masai-eid lodge ved foten av Kilimanjaro, med en eksklusiv Kisiwa Boma-suitekategori i tillegg til standardrommene — en egen eiendom, atskilt fra den separat plasserte Africa Amini Original Maasai Lodge.',
    amenities: ['Restaurant med full betjening', 'Hageanlegg', 'Panoramautsikt'],
    ...
    featuredIn: [{ label: '12-dagers Tanzania-safari for seniorer, jubileer og grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Rwanda',
    description: 'Et internasjonalt fullservicehotell i sentrale Kigali, et komfortabelt inngangsstopp før eller etter Rwandas primattrekking.',
    amenities: ['Svømmebasseng', 'Restaurant med full betjening', 'Gratis wifi', 'Spa'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Zanzibar-øya',
    description: 'Et all-inclusive strandresort, det vanlige avsluttende stoppet for safarier som forlenges til øya.',
    amenities: ['All-inclusive', 'Rett ved stranden', 'Svømmebasseng', 'Panoramautsikt'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Ruaha nasjonalpark',
    description: 'Spredt langs Great Ruaha-elven, i Tanzanias største nasjonalpark og en av de aller minst besøkte.',
    amenities: ['Panoramautsikt', 'Utsikt til dyreliv', 'Restaurant med full betjening'],
    ...
    featuredIn: [{ label: '10 dager: Sør-Tanzanias hemmeligheter', href: '/safaris/10-days-southern-secrets' }, { label: '11 dager: Sørlig dyreliv og krydderøyene', href: '/safaris/11-days-southern-spice' }, { label: '7 dager på den sørlige safariruten — Ruaha & Nyerere', href: '/safaris/7-day-southern-circuit' }],
  },
  {
    slug: 'rufiji-river-camp',
    name: 'Rufiji River Camp',
    tier: 'reserve',
    location: 'Nyerere nasjonalpark (Selous)',
    description: 'En elvebredd-leir ved Rufiji, basen for både game drive og båtsafari på samme reise.',
    amenities: ['Utsikt til dyreliv', 'Restaurant med full betjening', 'Panoramautsikt'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Akagera nasjonalpark, Rwanda',
    description: 'Med utsikt over Lake Ihema i Akagera, Rwandas eget Big Five-reisemål og et helt annet landskap enn vulkanene.',
    amenities: ['Panoramautsikt', 'Utsikt til dyreliv'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Samburu nasjonalreservat, Kenya',
    description: 'Ved Ewaso Nyiro-elven, hjem til arter som knapt finnes andre steder i Kenya — nettgiraff, Grevys sebra, gerenuk.',
    amenities: ['Panoramautsikt', 'Utsikt til dyreliv'],
    ...
    featuredIn: [{ label: '11 dager: Kenya uten sidestykke', href: '/safaris/11-days-kenya-undisputed' }, { label: 'Autentisk, eksklusivt Kenya — Amboseli, Samburu og Masai Mara', href: '/safaris/authentic-exclusive-kenya' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Nyerere nasjonalpark (Selous)',
    description: 'Bygget inn i klippene over Rufiji-elven og kun tilgjengelig med småfly — avsides på en måte få eiendommer i denne klassen klarer.',
    amenities: ['Restaurant med full betjening', 'Panoramautsikt', 'Gratis wifi', 'Utsikt til dyreliv'],
    ...
    featuredIn: [{ label: '2 dagers Nyerere-safari fra Zanzibar', href: '/safaris/2-day-selous-safari-from-zanzibar' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Lake Nakuru nasjonalpark, Kenya',
    description: 'På høyereliggende grunn inne i parken, med vid utsikt over sjøen og dyrelivet den tiltrekker.',
    amenities: ['Gratis wifi', 'Svømmebasseng', 'Restaurant med full betjening', 'Panoramautsikt'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Nyerere nasjonalpark (Selous)',
    description: 'En Serena-lodge over stryket i Rufiji-elven, som kombinerer game drive med elvebaserte aktiviteter i samme opphold.',
    amenities: ['All-inclusive', 'Svømmebasseng', 'Utsikt til dyreliv'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Sentrale Serengeti',
    description: 'En privat leir bevisst bygget for et mindre og mer eksklusivt fotavtrykk i økosystemet enn de større eiendommene i sentrale Serengeti.',
    amenities: ['Svømmebasseng', 'Panoramautsikt', 'Spa'],
    ...
    featuredIn: [{ label: '10-dagers ultimate migrasjonssafari — elvekryssinger ved Mara-elven', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '10 dager Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Sentrale Serengeti',
    description: 'En klassisk teltleir under akasieskygge, midt i slettenes viltrike hjerte — solid tilgang uten den høye prisen.',
    amenities: ['Rom med eget bad', 'Restaurant med full betjening', 'Utsikt til dyreliv'],
    ...
    featuredIn: [{ label: '5 dager høydepunktsafari', href: '/safaris/5-days-highlights-safari' }, { label: '7 dager Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 dager: Den store nordlige migrasjonen', href: '/safaris/8-days-great-northern-migration' }, { label: '8-dagers safari til gnuenes elvekryssing', href: '/safaris/8-days-flight-migration' }, { label: '10 dager Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '5-dagers Kilimanjaro-forlengelsessafari', href: '/safaris/kilimanjaro-extension-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Sentrale Serengeti',
    description: 'En enkel og grei teltleir med reell tilgang til de sentrale slettene, priset for reisende som heller vil bruke pengene på flere dager enn på et flottere telt.',
    amenities: ['Rom med eget bad', 'Restaurant med full betjening', 'Utsikt til dyreliv'],
    ...
    featuredIn: [{ label: '12 dager: Rwanda, Tanzania og Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '8-dagers bryllupsreisesafari — for bushelskere', href: '/safaris/8-days-honeymoon-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Ndutu, sørlige Serengeti',
    description: 'En sesongbasert mobil leir satt opp på Ndutu-stedet hvert år for å følge gnuenes kalvingssesong.',
    amenities: ['Rom med eget bad', 'Panoramautsikt', 'Utsikt til dyreliv'],
    ...
    featuredIn: [{ label: '7-dagers fotografi- og eventyrsafari i Tanzania', href: '/safaris/7-day-photography-adventure-safari' }, { label: 'Southern Edition: Tanzanias kalvingssesong-migrasjonssafari — Ndutu & Ngorongoro-krateret', href: '/safaris/7-days-migration-southern' }, { label: 'Tanzania fotosafari — Tarangire, Ngorongoro-krateret og Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Tarangire nasjonalpark',
    description: 'En privat teltleir hevet på stolper over Tarangires trekronelinje, i elefantland hele året.',
    amenities: ['Panoramautsikt', 'Utsikt til dyreliv', 'Luksuriøse teltsuiter', 'Restaurant med full betjening', 'Svømmebasseng'],
    ...
    featuredIn: [{ label: '10-dagers ultimate migrasjonssafari — elvekryssinger ved Mara-elven', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '7-dagers fotografi- og eventyrsafari i Tanzania', href: '/safaris/7-day-photography-adventure-safari' }, { label: '8-dagers bryllupsreisesafari — for bushelskere', href: '/safaris/8-days-honeymoon-safari' }, { label: 'Tanzania fotosafari — Tarangire, Ngorongoro-krateret og Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'En privat villaeiendom, et mer personlig alternativ til et vanlig hotellopphold før eller etter tiden i bushen.',
    amenities: ['Svømmebasseng', 'Spa', 'Panoramautsikt', 'Gratis wifi'],
    ...
    featuredIn: [{ label: '5 dager Serengeti fly-in safari', href: '/safaris/5-day-serengeti-fly-in' }, { label: '8-dagers bryllupsreisesafari — for bushelskere', href: '/safaris/8-days-honeymoon-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Sentrale Serengeti',
    description: 'En teltleir på slettene med en eksklusiv suitekategori i tillegg til standardteltene.',
    amenities: ['Gratis wifi', 'Panoramautsikt', 'Restaurant med full betjening', 'Spa', 'Utsikt til dyreliv', 'Luksuriøse teltsuiter'],
    ...
    featuredIn: [{ label: '11 dager: Rwanda og Tanzania-safari', href: '/safaris/11-days-rwanda-tanzania' }, { label: '12 dager Tanzania-Kenya-ekspedisjon', href: '/safaris/12-days-tanzania-kenya' }, { label: '12-dagers Tanzania-safari for seniorer, jubileer og grupper', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: '5 dager høydepunktsafari', href: '/safaris/5-days-highlights-safari' }, { label: '5 dager Serengeti fly-in safari', href: '/safaris/5-day-serengeti-fly-in' }, { label: '7 dager Crown Jewels-safari', href: '/safaris/7-days-crown-jewels' }, { label: '7 dager: Flytur over Ndutu-migrasjonen', href: '/safaris/7-days-flight-ndutu' }, { label: '7 dager: Perler i nord', href: '/safaris/7-days-gems-of-north' }, { label: '7 dager Serengeti & Ngorongoro-safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8-dagers bryllupsreisesafari — for bushelskere', href: '/safaris/8-days-honeymoon-safari' }, { label: '9 dager bryllupsreise-safari og strandopphold på Zanzibar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }, { label: 'Kilimanjaro Lemosho-bestigning og 5-dagers høydepunktssafari', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }, { label: 'Tanzania fotosafari — Tarangire, Ngorongoro-krateret og Serengeti', href: '/safaris/tanzania-photographic-safari' }],
  },
  {
    slug: 'sweetwaters-serena-camp',
    name: 'Sweetwaters Serena Camp',
    tier: 'reserve',
    location: 'Ol Pejeta-reservatet, Kenya',
    description: 'Inne i Ol Pejeta, hjem til Kenyas største svarte neshornreservat og verdens siste nordlige hvite neshorn — en genuint sjelden dyrelivsreferanse.',
    amenities: ['Utsikt til dyreliv', 'Svømmebasseng'],
    ...
    featuredIn: [{ label: '11 dager: Kenya uten sidestykke', href: '/safaris/11-days-kenya-undisputed' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Tarangire nasjonalpark',
    description: 'En enkel og grei teltleir på Tarangire-ruten, godt plassert for parkens tette elefantflokker uten en feriestedspris.',
    amenities: ['Rom med eget bad', 'Utsikt til dyreliv', 'Restaurant med full betjening'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Tarangire nasjonalpark',
    description: 'En hevet luksusleir på Tarangire-ruten, en del av Elewana Collection, med utsikt fra trekronehøyde over et av Afrikas tetteste elefantlandskap.',
    amenities: ['Svømmebasseng', 'Panoramautsikt', 'Spa', 'Utsikt til dyreliv'],
  ...
  },
  {
    ...
    description: 'En reservatlodge som grenser til Amboseli, bygget rundt et lokalt naturvernprogram i tillegg til sin egen utsikt til Kilimanjaro.',
    amenities: ['Svømmebasseng', 'Spa', 'Utsikt til Kilimanjaro', 'Naturvernprogram'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, Ngorongoro-høylandet',
    description: 'Et herregårdshus i kolonistil på en kaffeplantasje nær kraterranden, som forener tidsriktig arkitektur med et kjøkken som virkelig lever opp til ryktet.',
    amenities: ['Panoramautsikt', 'Restaurant med full betjening', 'Rom med eget bad', 'Svømmebasseng', 'Spa', 'Arkitektur fra kolonitiden'],
    ...
    featuredIn: [{ label: '10 dager Tanzania luksus-familiesafari', href: '/safaris/10-days-luxury-family' }, { label: '10 dager Tanzania-safari & Zanzibar-strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '7 dager Crown Jewels-safari', href: '/safaris/7-days-crown-jewels' }, { label: 'Høydepunkter i Kenya og Tanzania-safari', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    slug: 'tloma-lodge',
    name: 'Tloma Lodge',
    tier: 'reserve',
    location: 'Karatu, Ngorongoro-høylandet',
    description: 'En hagelodge på en tidligere kaffegård utenfor Karatu, avslappet og nær nedkjøringsveien til krateret.',
    amenities: ['Gratis wifi', 'Restaurant med full betjening', 'Hageanlegg', 'Økologisk fra gård til bord'],
    ...
    featuredIn: [{ label: '12 dager: Rwanda, Tanzania og Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '7 dager: Flytur over Ndutu-migrasjonen', href: '/safaris/7-days-flight-ndutu' }, { label: '7 dager: Perler i nord', href: '/safaris/7-days-gems-of-north' }, { label: '8-dagers bryllupsreisesafari — for bushelskere', href: '/safaris/8-days-honeymoon-safari' }],
  },
  {
    slug: 'tortils-ngorongoro-camp',
    name: 'Tortils Ngorongoro Camp',
    tier: 'trail',
    location: 'Ngorongoro-høylandet',
    description: 'En rimelig leir i høylandet, det fornuftige valget for reisende som prioriterer verdi på krateretappen av en lengre reise.',
    amenities: ['Restaurant med full betjening', 'Hageanlegg'],
    ...
    featuredIn: [{ label: '5 dager høydepunktsafari', href: '/safaris/5-days-highlights-safari' }, { label: '8-dagers safari til gnuenes elvekryssing', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Rwanda',
    description: 'Et sentralt hotell i Kigali, komfortabelt og godt plassert før eller etter Rwandas nasjonalparker.',
    amenities: ['Gratis wifi', 'Restaurant med full betjening', 'Panoramautsikt'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Zanzibar-øya',
    description: 'En Serena-eiendom på Zanzibar-øya, ankomststoppet der Rwandas primattrekking gir plass til en rekke uplanlagte stranddager.',
    amenities: ['Svømmebasseng', 'Rett ved stranden', 'Restaurant med full betjening'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Tarangire-regionen',
    description: 'En teltleir på Tarangire-ruten, med pålitelig guiding og dyrelivsobservasjon til en genuint prisgunstig middelklassepris.',
    amenities: ['Restaurant med full betjening', 'Gratis wifi', 'Utsikt til dyreliv'],
    ...
    featuredIn: [{ label: '8-dagers bryllupsreisesafari — for bushelskere', href: '/safaris/8-days-honeymoon-safari' }],
  },
]
