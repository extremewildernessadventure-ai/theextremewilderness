...
export const packages: SafariPackage[] = [
  ...
  },
  {
    ...
    metaDescription: "שישה ימים בין טרנגירה, נגורונגורו והסרנגטי, ולאחר מכן שלושה לילות בחוף נונגווי שבזנזיבר. 10 ימים, 9 לילות. החל מ-4,413.96$ לאדם.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "ספארי פרטי במעגל הדרומי דרך ניירה ורואהה — אחת ההתבודדויות הכי פחות צפופות באפריקה. שתי רמות, בכביש או בטיסה פנימית, החל מ-4,320$ לאדם.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "המעגל היבשתי החתום של EWA Safari Outfitters — סיורי לילה בטרנגירה, מכתש נגורונגורו וספארי בכדור פורח בסרנגטי. שתי רמות, החל מ-5,334.38$ לאדם.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "ספארי פרטי בקצב משפחתי בטנזניה לשני דורות — ארושה, טרנגירה, נגורונגורו והסרנגטי. שתי רמות, החל מ-6,025$ לאדם.",
    overview: [
...
},
{
  ...
  metaDescription: "חיות בר במעגל הצפוני וטרק שימפנזים בגומבה, המתנהלים כמסלול רצוף אחד — שילוב נדיר בשוק הספארי הטנזני. 11 ימים, החל מ-5,908.96 דולר לאדם.",
  overview: [
...
},
{
  ...
  metaDescription: "טיסה ישירה אל מעברי נהר מארה, ולאחר מכן תנועה דרומה דרך הסרנגטי ומכתש נגורונגורו. שלוש דרגות, החל מ-3,852.29 דולר לאדם.",
  overview: [
...
},
{
  ...
  metaDescription: "טרק שימפנזים, גורילות וקופי זהב ברואנדה, ולאחריהם ארבעה לילות על חופי זנזיבר. הזמנה אחת חלקה, החל מ-7,742.08 דולר לאדם.",
  overview: [
...
},
{
  ...
  metaDescription: "משלחת פרטית ומודרכת למעקב אחר שימפנזים פראיים בנחל גומבה — אחד ממפגשי חיות הבר הנדירים ביותר באפריקה. חמישה ימים, החל מ-4,206.25 דולר לאדם.",
  overview: [
  ...
  },
  {
    ...
    metaDescription: "ספארי צילום והרפתקאות פרטי ומודרך דרך טרנגירה, מכתש נגורונגורו ושדות ההמלטה של נדוטו. לצלמים ולמחפשי ספארי אותנטי, החל מ-$4,597 לאדם.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "טפסו לפסגת קילימנג'רו במסלול למושו, ולאחר מכן טוסו ישירות אל סרנגטי ומכתש נגורונגורו. 14 ימים, הזמנה אחת רציפה. החל מ-$6,607.58 לאדם.",
    overview: [
  ...
  // ─── 5-Day Kilimanjaro Extension Safari ──────────────────────────────────────
  {
    ...
    metaDescription: "רק ירדתם מההר? המשיכו ישירות אל טרנגירה, סרנגטי ומכתש נגורונגורו — איסוף ממושי, ללא צורך לטוס הביתה קודם. החל מ-$2,118.96 לאדם.",
    overview: [
  ...
  },
  {
    ...
    metaDescription: "שימפנזים, גורילות וקופי זהב ברואנדה, ולאחר מכן ארבעה לילות שלווים על חופי זנזיבר — נבנה עבור גמלאים, זוגות יום נישואין וקבוצות. החל מ-7,742 דולר לאדם.",
    overview: [
