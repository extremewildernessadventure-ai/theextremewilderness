...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    description:
      "Five days across Tarangire, Central Serengeti, and the Ngorongoro Crater, paced exactly right for two — never rushed, always private. Then four unhurried nights on Zanzibar's Nungwi coast to close it out. Every detail, from candlelit dinners to honeymoon amenities at your lodge, is arranged before you land.",
    image: '/images/gallery/honey.webp',
    durationLabel: '9 days',
    highlights: ['Private guide & vehicle throughout', 'Ngorongoro Crater Big Five', '4 nights on Nungwi Beach, Zanzibar', 'Honeymoon touches on request (cake, flowers, private dinner)'],
    priceFrom: '$3,847',
    badge: 'Romance',
    badgeColor: 'bg-gold text-brand',
    landscape: true,
  },
  {
    ...
    description:
      "Most safaris show you the animals. This one shows you the people who've shared this land with them the longest. Tarangire's elephant herds and the Ngorongoro Crater's Big Five, paired with a respectful, guide-led afternoon among the Hadzabe — one of the last hunter-gatherer communities on Earth — and the Datoga blacksmiths at Lake Eyasi.",
    image: '/images/gallery/maa1.webp',
    durationLabel: '4 days',
    highlights: ['Hadzabe hunter-gatherer community visit', 'Datoga blacksmith tradition', 'Ngorongoro Crater Big Five', 'Community-led, ethical visit protocols'],
    priceFrom: '$1,250',
    badge: 'Authentic',
    badgeColor: 'bg-brand-secondary text-white',
    landscape: true,
  },
  {
    ...
    description:
      'Fly directly from Arusha into the heart of Central Serengeti, trading a full day on the road for a full day of game viewing. Two nights deep in prime predator territory, a guided descent into the Ngorongoro Crater, and a stop at Lake Manyara — all in five efficient, high-density days.',
    image: '/images/gallery/Central-Serengeti-1.webp',
    durationLabel: '5 days',
    highlights: ['Direct flight into Central Serengeti', 'Two full days in prime predator territory', 'Ngorongoro Crater descent', 'Ideal for shorter trips, maximum wildlife time'],
    priceFrom: '$2,475',
  ...
  },
  {
    ...
    description:
      "Tanzania is one of Africa's great birding destinations — from Lake Manyara's flamingo-lined shores to the Serengeti's raptors and the Rufiji River's fish eagles. Paced slower and timed around dawn and dusk activity, this itinerary is built for travelers who want to look closer, not just wider.",
    image: '/images/gallery/nakuru.webp',
    durationLabel: 'Tailor-made',
    highlights: ['Over 1,000 recorded species countrywide', 'Specialist birding guide', 'Lake Manyara flamingos & Serengeti raptors', 'Combinable with any safari or Nyerere boat safari'],
    priceFrom: '',
    badge: 'Specialist',
    badgeColor: 'bg-brand text-white',
    landscape: true,
