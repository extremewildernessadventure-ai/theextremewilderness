...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    title: 'Perfekte Hochzeitsreise: Safari & Sansibar',
  ...
  },
  {
    ...
    category: 'Kultur-Safari',
    title: 'Tarangire, Ngorongoro & Hadzabe Erlebnis',
  ...
  },
  {
    ...
    category: 'Vogelbeobachtungs-Safari',
    title: 'Tansania Vogelbeobachtungs-Safari',
    tagline: 'Über 1.000 Arten. Eine andere Art, die Wildnis zu sehen.',
    description:
      'Tansania ist eines der großen Vogelbeobachtungsziele Afrikas — von den flamingogesäumten Ufern des Manyara-Sees über die Greifvögel der Serengeti bis zu den Schreiseeadlern am Rufiji-Fluss. Langsamer getaktet und auf die Aktivität in der Morgen- und Abenddämmerung abgestimmt, ist diese Route für Reisende gemacht, die genauer hinschauen wollen, nicht nur weiter.',
    image: '/images/gallery/nakuru.webp',
    durationLabel: 'Maßgeschneidert',
    highlights: ['Über 1.000 erfasste Arten landesweit', 'Spezialisierter Vogel-Guide', 'Flamingos am Manyara-See & Greifvögel der Serengeti', 'Mit jeder Safari oder der Nyerere-Bootssafari kombinierbar'],
    priceFrom: '',
    badge: 'Spezialist',
    badgeColor: 'bg-brand text-white',
    landscape: true,
