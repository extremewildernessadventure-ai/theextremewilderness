...
export const accommodations: Accommodation[] = [
  {
    ...
    description: 'Un campamento de lona de lujo totalmente móvil que se desplaza con la propia Gran Migración: aquí no hay que perseguir a las manadas, basta con despertar allí donde estén en ese momento.',
  ...
  },
  {
    ...
    description: 'Un lodge gestionado por los propios maasái en las laderas occidentales del Kilimanjaro, concebido en torno a un intercambio cultural auténtico con la comunidad vecina, y no a una versión escenificada de ella.',
  ...
  },
  {
    ...
    description: 'El único lodge permanente dentro del propio Lago Manyara, con suites tipo casa en el árbol elevadas hasta el dosel del bosque de aguas subterráneas: una perspectiva del parque realmente distinta a la de cualquier alojamiento situado en su periferia.',
  ...
  },
  {
    ...
    description: 'Encaramado al escarpado de Oloololo, con una vista que abarca toda la llanura del Mara y que se ha convertido en uno de los miradores más fotografiados de África Oriental, y con razón.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'Una finca de café en activo junto al aeropuerto que convierte la primera o la última noche del viaje en algo más que un simple trámite: en una parada realmente relajada.',
  ...
  },
  {
    ...
    description: 'Villas con cúpula integradas en un anfiteatro volcánico reforestado, a pocos minutos en coche de los puntos de salida del trekking de gorilas: uno de los lodges más aclamados que se han construido en África en la última década.',
  ...
  },
  {
    ...
    description: 'Un lodge de lona en el límite de Tarangire, situado para acceder temprano a uno de los paisajes con mayor densidad de elefantes de África.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parque Nacional de Tarangire',
    description: 'Un campamento sin artificios que invierte justo donde importa en el circuito de Tarangire: guías competentes, una cocina bien llevada y un precio justo en lugar de un presupuesto de resort.',
  ...
  },
  {
    ...
    description: 'Un hotel urbano frente al mar en la península de Msasani: realmente cómodo y la parada nocturna habitual de camino al circuito sur o de regreso de él.',
    ...
    featuredIn: [{ label: '5 Días Trekking Privado de Chimpancés en Gombe', href: '/safaris/5-day-gombe-chimpanzee-trekking' }, { label: '7 Días Circuito Sur — Ruaha y Nyerere', href: '/safaris/7-day-southern-circuit' }, { label: 'Safari Definitivo por Tanzania y Trekking de Chimpancés en Gombe', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
    ...
    description: 'Un resort todo incluido frente a la playa en la costa de Nungwi, en Zanzíbar, la parada final de categoría Wilderness Reserve del itinerario 10 Días Safari y Playas de Zanzíbar.',
    amenities: ['Todo Incluido', 'Piscina', 'Frente a la Playa', 'Restaurante de Servicio Completo'],
    ...
    featuredIn: [{ label: '10 Días Safari y Playas de Zanzíbar', href: '/safaris/10-day-safari-zanzibar' }],
  ...
  },
  {
    ...
    description: 'Una base sencilla y sin florituras en Kigali, para viajeros que prefieren destinar su presupuesto a los tramos de trekking de gorilas y primates antes que a la primera y la última noche en la ciudad.',
  ...
  },
  {
    ...
    description: 'Un hotel de entrada fiable y bien ubicado en Nairobi: esa primera o última parada práctica que cumple su única función a la perfección, antes o después de que tomen el relevo los parques.',
    amenities: ['WiFi Gratis', 'Piscina', 'Restaurante de Servicio Completo'],
  ...
  },
  {
    ...
    description: 'Construido en torno a un manantial natural que atrae a elefantes y a otra fauna hasta el borde mismo de la propiedad: un campamento de gama media con una ventaja para la observación de animales que pocos de su categoría ofrecen.',
    ...
    featuredIn: [{ label: 'Safari Fotográfico y de Aventura de 7 Días en Tanzania', href: '/safaris/7-day-photography-adventure-safari' }, { label: '10 Días Safari y Playas de Zanzíbar', href: '/safaris/10-day-safari-zanzibar' }],
  },
  {
    ...
    description: 'Un auténtico resort con spa a orillas del Naivasha: un día de verdadera pausa integrado en mitad de la rutina del Valle del Rift, y no simplemente otro lodge entre game drives.',
  ...
  },
  {
    ...
    description: 'Construido en torno a su propio abrevadero en pleno corazón del Serengeti, donde la fauna pasa a diario justo por debajo de la terraza: el estándar Four Seasons en mitad de las llanuras.',
    ...
    featuredIn: [{ label: '12 Días Ruanda, Tanzania y Zanzíbar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: 'Safari de Naturaleza Salvaje de 12 Días, Encuentros Culturales y Caminata de un Día al Kilimanjaro', href: '/safaris/12-days-wild-wilderness' }],
  },
  {
    slug: 'gibbs-farm',
    name: 'Gibb\'s Farm',
    ...
    description: 'Una veterana finca orgánica bajo el borde del cráter que sigue cultivando su propio café y sus hortalizas, y a la que se considera una de las mejores cocinas de Tanzania sin más, no solo entre los lodges.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenia',
    description: 'El campamento de lona de lujo original del Mara, en funcionamiento ininterrumpido desde 1972, a orillas del Río Mara y en uno de los corredores de fauna más fiables de la reserva: un icono, no una parada económica.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'La marca de lujo propia de Meliá, a poca distancia del aeropuerto: instalaciones completas de resort y un acabado realmente cuidado para quienes buscan algo más de comodidad antes o después de la sabana.',
  ...
  },
  {
    ...
    description: 'Situado directamente sobre el escarpado, combina amplias vistas del valle con unas instalaciones completas de golf y spa que la mayoría de las propiedades de safari sencillamente no ofrece.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Nairobi, Kenia',
    description: 'Un hotel boutique de estilo colonial en el barrio de Karen, parte de la reconocida Hemingways Collection: realmente cómodo, y no solo práctico, tanto al principio como al final de un safari por Kenia.',
  ...
  },
  {
    ...
    description: 'Un campamento al borde del bosque, pensado para el senderismo y el rastreo de primates en uno de los parques menos visitados y más gratificantes de Tanzania, para viajeros que buscan algo más allá del circuito habitual.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Dar es Salaam',
    description: 'Un hotel de servicio completo en el paseo marítimo, utilizado como cómoda parada de tránsito en los itinerarios del circuito sur: una sólida opción de gama alta, del mismo nivel de marca que Radisson Blu.',
    amenities: ['Piscina', 'Restaurante de Servicio Completo', 'WiFi Gratis'],
  ...
  },
  {
    ...
    description: 'Un campamento privado sobre un afloramiento rocoso por encima del Río Ruaha, en uno de los parques más extensos y menos concurridos de Tanzania.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parque Nacional de los Volcanes, Ruanda',
    description: 'Un lodge económico justo en el límite del Parque Nacional de los Volcanes, situado deliberadamente para las salidas tempranas que exige una mañana de trekking de gorilas.',
    ...
    featuredIn: [{ label: '4 Días Trekking de Gorilas en Ruanda', href: '/safaris/4-day-rwanda-gorilla-trekking' }, { label: 'Safari de Primates en Ruanda y Escapada a la Playa de Zanzíbar', href: '/safaris/12-days-rwanda-primates' }],
  },
  {
    slug: 'kahawa-house',
    name: 'Kahawa House',
    tier: 'trail',
    location: 'Arusha',
    description: 'Una casa de huéspedes de ambiente relajado en una finca de café en activo a las afueras de Arusha: una primera o última noche realmente tranquila y bien atendida, antes o después de la sabana.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kilimanjaro Occidental',
    description: 'Un campamento de lona en terreno privado a los pies del Kilimanjaro, conocido por las manadas de elefantes residentes que atraviesan el propio campamento y por un telón de fondo montañoso que no necesita adornos.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenia',
    description: 'El campamento más asequible de &Beyond en el Mara: todo el estándar de hospitalidad y de ubicación de andBeyond a un precio notablemente más contenido que el de sus propiedades emblemáticas.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Ruanda',
    description: 'Un hotel céntrico en Kigali con el estándar constante de cinco estrellas de Serena: una parada nocturna realmente cómoda antes o después del trekking de gorilas en los Virunga, y no un simple relleno económico.',
    amenities: ['WiFi Gratis', 'Piscina', 'Restaurante de Servicio Completo'],
  ...
  },
  {
    ...
    description: 'Un lodge en ladera con auténticas vistas al Lago Tanganica, que funciona como puerta de entrada a una de las experiencias más remotas y gratificantes de Tanzania: el trekking de chimpancés en Gombe y Mahale.',
    ...
    featuredIn: [{ label: '5 Días Trekking Privado de Chimpancés en Gombe', href: '/safaris/5-day-gombe-chimpanzee-trekking' }, { label: 'Safari Definitivo por Tanzania y Trekking de Chimpancés en Gombe', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
    ...
    description: 'Pabellones privados con cúpula encastrados en la ladera sobre el Océano Índico, cada uno con su propia piscina de inmersión: un cambio de ritmo deliberado tras varios días en la sabana.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Parque Nacional de los Volcanes, Ruanda',
    description: 'Una casa de huéspedes sencilla junto a la puerta del Parque Nacional de los Volcanes, concebida específicamente en torno a las salidas tempranas que exige una mañana de trekking de gorilas.',
    ...
    featuredIn: [{ label: '11 Días Safari Ruanda Tanzania', href: '/safaris/11-days-rwanda-tanzania' }, { label: '12 Días Ruanda, Tanzania y Zanzíbar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }],
  },
  {
    ...
    description: 'Un campamento de lona sobre el escarpado del Valle del Rift con unas vistas que hablan por sí solas: el fondo del valle se extiende abajo hasta donde alcanza la mirada.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Lago Eyasi',
    description: 'Un pequeño campamento de lona junto al Lago Eyasi, la base habitual y mejor situada para las visitas a la comunidad de cazadores-recolectores hadzabe.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, tierras altas del Ngorongoro',
    description: 'Una antigua finca de café con amplias terrazas orientadas al escarpado del Valle del Rift y una cocina de la que merece la pena hablar, cerca de la carretera del borde del cráter.',
  ...
  },
  {
    ...
    description: 'Un lodge de lona fiable que utilizamos tanto en el tramo de Tarangire como en el del centro del Serengeti de varios de nuestros itinerarios: guiado sólido a un precio justo, siempre.',
  ...
  },
  {
    ...
    description: 'Una base cómoda y céntrica en Musanze antes de partir a rastrear gorilas en el Parque Nacional de los Volcanes.',
    amenities: ['WiFi Gratis', 'Restaurante de Servicio Completo', 'Jardines'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Centro del Serengeti',
    description: 'Un campamento de lona en pleno corazón de las llanuras, con acceso inmediato a algunas de las zonas de observación de fauna más fiables del ecosistema durante todo el año.',
    ...
    featuredIn: [{ label: '5 Días Safari de los Momentos Estelares', href: '/safaris/5-days-highlights-safari' }, { label: 'Ascenso al Kilimanjaro por la Ruta Lemosho y Safari de 5 Días de los Momentos Estelares', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Parque Nacional de Tarangire',
    description: 'Un lodge de lona a la orilla misma del Lago Burunge, en el límite de Tarangire, célebre entre los huéspedes por sus atardeceres vistos de frente sobre el agua.',
    ...
    featuredIn: [{ label: '8 Días Gran Migración del Norte', href: '/safaris/8-days-great-northern-migration' }, { label: 'Safari de 12 Días en Tanzania para Mayores, Aniversarios y Grupos', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: 'Safari de Confort 5 Días en Tanzania', href: '/safaris/5-day-comfort-tanzania-safari' }, { label: 'Safari de Extensión al Kilimanjaro de 5 Días', href: '/safaris/kilimanjaro-extension-safari' }, { label: 'Safari de Confort 6 Días en Tanzania', href: '/safaris/6-day-comfort-tanzania-safari' }],
  },
  {
    ...
    description: 'Un campamento de lona de Serena a orillas de un lago del Valle del Rift más tranquilo que sus concurridos vecinos.',
  ...
  },
  {
    ...
    description: 'Una propiedad de Serena a orillas del lago, habitualmente la última parada de un itinerario por Ruanda una vez completados los tramos de trekking de primates.',
    amenities: ['Piscina', 'Vistas Panorámicas', 'Restaurante de Servicio Completo'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Lago Naivasha, Kenia',
    description: 'Un resort fiable a orillas del lago, bien situado para las excursiones en barco a la Isla Crescent y los safaris a pie: esa estancia cómoda y sin sorpresas por la que se conoce a las propiedades Sopa en toda África Oriental.',
  ...
  },
  {
    ...
    description: 'Dentro del propio parque, históricamente conocido por su orilla bordeada de flamencos y por su población residente de rinocerontes.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parque Nacional del Lago Nakuru, Kenia',
    description: 'En terreno elevado sobre el lago, con vistas verdaderamente panorámicas y el mismo estándar fiable de Sopa que caracteriza a sus demás propiedades de África Oriental.',
  ...
  },
  {
    ...
    description: 'Un campamento privado en lo alto de una colina, justo por encima de los puntos de cruce del Río Mara: uno de los mejor situados de la zona para quienes planifican el viaje en torno a los cruces.',
  ...
  },
  {
    ...
    featuredIn: [{ label: '10 Días Safari Familiar de Lujo en Tanzania', href: '/safaris/10-days-luxury-family' }, { label: '7 Días Las Joyas del Norte', href: '/safaris/7-days-gems-of-north' }, { label: '8 Días Gran Migración del Norte', href: '/safaris/8-days-great-northern-migration' }, { label: 'Safari de 8 Días del Cruce del Río de los Ñus', href: '/safaris/8-days-flight-migration' }],
  },
  {
    slug: 'lemala-osonjoi',
    name: 'Lemala Osonjoi',
    ...
    description: 'Un campamento privado de lona cerca de la carretera de descenso, que sitúa a sus huéspedes en el fondo del cráter antes de que la mayoría de los demás campamentos haya terminado de desayunar.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Isla de Zanzíbar',
    description: 'Una casa de huéspedes sencilla y bien ubicada para quienes prolongan el viaje hasta las playas de Zanzíbar sin prolongar el presupuesto.',
  ...
  },
  {
    ...
    description: 'Un campamento de lona clásico, de gestión sencilla y honesta, situado para las salidas tempranas que marcan la diferencia en un game drive dentro del ecosistema del Mara.',
    ...
    featuredIn: [{ label: '8 Días Gran Migración del Norte', href: '/safaris/8-days-great-northern-migration' }, { label: 'Safari de 8 Días del Cruce del Río de los Ñus', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    description: 'Un lodge de lona próximo a la zona fronteriza entre Kenia y Tanzania, situado específicamente para la temporada de cruces de río de la migración.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenia',
    description: 'Un lodge de Serena en lo alto de una colina, con amplias vistas sobre las llanuras de la reserva y el río que discurre más abajo.',
    amenities: ['WiFi Gratis', 'Piscina', 'Restaurante de Servicio Completo', 'Vistas Panorámicas'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Norte del Serengeti',
    description: 'Un campamento de lona móvil que se traslada siguiendo a la propia migración por el norte del Serengeti y la zona fronteriza con el Mara.',
    ...
    featuredIn: [{ label: 'Safari Fotográfico en Tanzania — Tarangire, Cráter del Ngorongoro y Serengeti', href: '/safaris/tanzania-photographic-safari' }, { label: 'Safari de 8 Días del Cruce del Río de los Ñus', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Masai Mara, Kenia',
    description: 'Un lodge amplio y consolidado, cercano al corredor de cruces de río de la migración: la fiabilidad sólida de Sopa respaldada por una ubicación realmente buena.',
  ...
  },
  {
    ...
    description: 'Un campamento de lona cerca del Lago Masek, en pleno epicentro de la temporada anual de partos de los ñus.',
  ...
  },
  {
    ...
    description: 'Un pequeño campamento de lona a orillas del Lago Tanganica, la base práctica y cómoda para el trekking de chimpancés en Gombe.',
  ...
  },
  {
    ...
    description: 'Con vistas a la llanura aluvial abierta de Mikumi, uno de los parques más accesibles del circuito sur, y con un lodge a la altura de esa comodidad.',
    amenities: ['Piscina', 'Vistas Panorámicas', 'Restaurante de Servicio Completo'],
  ...
  },
  {
    ...
    description: 'Un eco-lodge al borde del Bosque de Nyungwe, cerca de los puntos de salida del trekking de chimpancés que se adentra en una de las selvas tropicales de montaña más antiguas de África.',
    amenities: ['Restaurante de Servicio Completo', 'Vistas de Fauna', 'Vistas al Bosque'],
    ...
    featuredIn: [{ label: 'Safari de Primates en Ruanda y Escapada a la Playa de Zanzíbar', href: '/safaris/12-days-rwanda-primates' }],
    needsPhotography: true,
  },
  {
    ...
    tier: 'reserve',
    location: 'Ndutu, sur del Serengeti',
    description: 'Un campamento de lona estacional, ajustado con precisión a la temporada anual de partos de los ñus.',
    amenities: ['Habitaciones con Baño Privado', 'Vistas de Fauna'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Ndutu, sur del Serengeti',
    description: 'Un lodge permanente de piedra y paja, con 34 cabañas asomadas al Lago Ndutu, situado para acceder durante todo el año a los depredadores residentes que nunca se marchan cuando la migración sigue su camino.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Karatu, tierras altas del Ngorongoro',
    description: 'Una finca de café en activo reconvertida en lodge, entre platanares en el borde del cráter: relajada y hogareña por vocación, sin pretender ser nada más grandioso.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, tierras altas del Ngorongoro',
    description: 'Un lodge de gama media en las tierras altas, con fácil acceso a la carretera de descenso al cráter para los game drives tempranos.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Área de Conservación del Ngorongoro',
    description: 'Situado directamente sobre el borde del cráter, entre las propiedades más cercanas a la carretera de descenso y con auténticas vistas despejadas al cráter.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Área de Conservación del Ngorongoro',
    description: 'Un lodge de Serena construido en piedra y excavado en el borde boscoso del cráter, con habitaciones que miran directamente hacia el fondo del Ngorongoro.',
    amenities: ['Vistas Panorámicas', 'Restaurante de Servicio Completo', 'Habitaciones con Baño Privado'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Nungwi, Zanzíbar',
    description: 'Una propiedad frente a la playa en la punta norte de Zanzíbar, conocida entre los huéspedes por sus aguas tranquilas para el baño y unos atardeceres que rara vez decepcionan.',
    ...
    featuredIn: [{ label: '7 Días Safari Joyas de la Corona', href: '/safaris/7-days-crown-jewels' }, { label: 'Safari de Luna de Miel 9 Días y Escapada a la Playa de Zanzíbar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }, { label: '10 Días Safari y Playas de Zanzíbar', href: '/safaris/10-day-safari-zanzibar' }, { label: 'Safari de Primates en Ruanda y Escapada a la Playa de Zanzíbar', href: '/safaris/12-days-rwanda-primates' }],
  },
  {
    slug: 'ol-tukai-lodge',
    name: 'Ol Tukai Lodge',
    ...
    description: 'Dentro del propio parque, con algunas de las vistas al Kilimanjaro más constantes y fiables de cuantas propiedades hay en Amboseli: una diferencia real para esta franja de precio.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Bosque de Nyungwe, Ruanda',
    description: 'Una marca de ultralujo de reconocimiento internacional instalada en una plantación de té en activo al borde de Nyungwe, concebida en torno al trekking de chimpancés y al acceso al paseo por el dosel arbóreo más que a los gorilas.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kilimanjaro Occidental',
    description: 'Un lodge de propiedad maasái a los pies del Kilimanjaro, con una categoría premium de suites Kisiwa Boma junto a sus habitaciones estándar; se trata de una propiedad distinta del Africa Amini Original Maasai Lodge, posicionado por separado.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Isla de Zanzíbar',
    description: 'Un resort todo incluido frente a la playa, la parada final habitual de los safaris que se prolongan hasta la isla.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Parque Nacional de Ruaha',
    description: 'Repartido a lo largo del Gran Río Ruaha, en el parque nacional más extenso de Tanzania y uno de los que menos visitantes recibe de verdad.',
    amenities: ['Vistas Panorámicas', 'Vistas de Fauna', 'Restaurante de Servicio Completo'],
    ...
    featuredIn: [{ label: '10 Días Secretos del Sur de Tanzania', href: '/safaris/10-days-southern-secrets' }, { label: '11 Días Fauna del Sur e Islas de las Especias', href: '/safaris/11-days-southern-spice' }, { label: '7 Días Circuito Sur — Ruaha y Nyerere', href: '/safaris/7-day-southern-circuit' }],
  },
  {
    ...
    description: 'Un campamento a orillas del Rufiji, base tanto para los game drives como para los safaris en barco dentro del mismo viaje.',
  ...
  },
  {
    ...
    description: 'Con vistas al Lago Ihema, en Akagera, el destino de Los Cinco Grandes de Ruanda y un paisaje realmente distinto al de los volcanes.',
    amenities: ['Vistas Panorámicas', 'Vistas de Fauna'],
  ...
  },
  {
    ...
    description: 'A orillas del Río Ewaso Nyiro, hogar de especies que apenas se ven en ningún otro punto de Kenia: jirafa reticulada, cebra de Grevy o gerenuk.',
    amenities: ['Vistas Panorámicas', 'Vistas de Fauna'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parque Nacional de Nyerere (Selous)',
    description: 'Construido entre las rocas sobre el Río Rufiji y accesible únicamente en avioneta: remoto de una forma que pocas propiedades de su categoría logran.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Parque Nacional del Lago Nakuru, Kenia',
    description: 'En terreno elevado dentro del parque, con amplias vistas sobre el lago y la fauna que atrae.',
    amenities: ['WiFi Gratis', 'Piscina', 'Restaurante de Servicio Completo', 'Vistas Panorámicas'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Parque Nacional de Nyerere (Selous)',
    description: 'Un lodge de Serena sobre los rápidos del Río Rufiji, que combina game drives con actividades fluviales en una misma estancia.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Centro del Serengeti',
    description: 'Un campamento privado concebido deliberadamente para dejar una huella menor y más exclusiva en el ecosistema que las grandes propiedades del centro del Serengeti.',
    ...
    featuredIn: [{ label: 'Safari 10 Días Gran Migración Definitiva — Cruce del Río Mara', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '10 Días Safari y Playas de Zanzíbar', href: '/safaris/10-day-safari-zanzibar' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Centro del Serengeti',
    description: 'Un campamento de lona clásico al abrigo de las acacias, en pleno corazón de unas llanuras rebosantes de fauna: buen acceso sin la etiqueta de precio premium.',
    ...
    featuredIn: [{ label: '5 Días Safari de los Momentos Estelares', href: '/safaris/5-days-highlights-safari' }, { label: '7 Días Safari Serengeti y Ngorongoro', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 Días Gran Migración del Norte', href: '/safaris/8-days-great-northern-migration' }, { label: 'Safari de 8 Días del Cruce del Río de los Ñus', href: '/safaris/8-days-flight-migration' }, { label: '10 Días Safari y Playas de Zanzíbar', href: '/safaris/10-day-safari-zanzibar' }, { label: 'Safari de Extensión al Kilimanjaro de 5 Días', href: '/safaris/kilimanjaro-extension-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Centro del Serengeti',
    description: 'Un campamento de lona sin complicaciones que ofrece un acceso real a las llanuras centrales, con un precio pensado para quienes prefieren invertir en más días de viaje que en una tienda más lujosa.',
    amenities: ['Habitaciones con Baño Privado', 'Restaurante de Servicio Completo', 'Vistas de Fauna'],
    ...
    featuredIn: [{ label: '12 Días Ruanda, Tanzania y Zanzíbar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '8 Días Safari de Luna de Miel — Amantes de la Sabana', href: '/safaris/8-days-honeymoon-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Ndutu, sur del Serengeti',
    description: 'Un campamento móvil estacional que se instala cada año en el emplazamiento de Ndutu para seguir la temporada de partos de los ñus.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Parque Nacional de Tarangire',
    description: 'Un campamento privado de lona elevado sobre pilotes por encima de las copas de los árboles de Tarangire, en territorio de elefantes durante todo el año.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'Una villa privada, una alternativa más personal a la estancia hotelera convencional antes o después de la sabana.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Centro del Serengeti',
    description: 'Un campamento de lona en las llanuras, con una categoría premium de suites junto a sus tiendas estándar.',
  ...
  },
  {
    ...
    description: 'Dentro de Ol Pejeta, hogar del mayor santuario de rinoceronte negro de Kenia y de los últimos rinocerontes blancos del norte que quedan en el mundo: una credencial faunística verdaderamente excepcional.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parque Nacional de Tarangire',
    description: 'Un campamento de lona sin artificios en el circuito de Tarangire, bien situado para las densas manadas de elefantes del parque y sin la etiqueta de precio de un resort.',
    amenities: ['Habitaciones con Baño Privado', 'Vistas de Fauna', 'Restaurante de Servicio Completo'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Parque Nacional de Tarangire',
    description: 'Un campamento de lujo elevado en el circuito de Tarangire, parte de la Elewana Collection, con vistas a la altura de las copas de los árboles sobre uno de los paisajes con mayor densidad de elefantes de África.',
    amenities: ['Piscina', 'Vistas Panorámicas', 'Spa', 'Vistas de Fauna'],
  ...
  },
  {
    ...
    description: 'Un lodge de conservación colindante con Amboseli, articulado en torno a un programa de conservación comunitaria además de sus propias vistas al Kilimanjaro.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, tierras altas del Ngorongoro',
    description: 'Una mansión de estilo colonial en una finca de café cerca del borde del cráter, que une arquitectura de época con una cocina que hace honor a su reputación.',
    ...
    featuredIn: [{ label: '10 Días Safari Familiar de Lujo en Tanzania', href: '/safaris/10-days-luxury-family' }, { label: '10 Días Safari y Playas de Zanzíbar', href: '/safaris/10-day-safari-zanzibar' }, { label: '7 Días Safari Joyas de la Corona', href: '/safaris/7-days-crown-jewels' }, { label: 'Safari Destacados de Kenya y Tanzania', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    slug: 'tloma-lodge',
    name: 'Tloma Lodge',
    tier: 'reserve',
    location: 'Karatu, tierras altas del Ngorongoro',
    description: 'Un lodge ajardinado en una antigua finca de café a las afueras de Karatu, de ambiente relajado y cerca de la carretera de descenso al cráter.',
  ...
  },
  {
    ...
    description: 'Un campamento económico en las tierras altas, la opción sensata para quienes priorizan la relación calidad-precio en el tramo del cráter de un viaje más largo.',
    amenities: ['Restaurante de Servicio Completo', 'Jardines'],
    ...
    featuredIn: [{ label: '5 Días Safari de los Momentos Estelares', href: '/safaris/5-days-highlights-safari' }, { label: 'Safari de 8 Días del Cruce del Río de los Ñus', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Ruanda',
    description: 'Un hotel céntrico en Kigali, cómodo y bien ubicado antes o después de los parques nacionales de Ruanda.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Isla de Zanzíbar',
    description: 'Una propiedad de Serena en la isla de Zanzíbar, la parada de llegada donde el trekking de primates en Ruanda da paso a una sucesión de días de playa sin agenda.',
    amenities: ['Piscina', 'Frente a la Playa', 'Restaurante de Servicio Completo'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Región de Tarangire',
    description: 'Un campamento de lona en el circuito de Tarangire, con guiado fiable y buena observación de fauna a un precio realmente de gama media.',
    amenities: ['Restaurante de Servicio Completo', 'WiFi Gratis', 'Vistas de Fauna'],
