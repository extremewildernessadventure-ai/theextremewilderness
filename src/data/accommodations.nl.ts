...
export const accommodations: Accommodation[] = [
  {
    ...
    description: 'Een volledig mobiel luxe tentenkamp dat de Grote Trek zelf volgt, zodat gasten wakker worden waar de kuddes zich op dat moment bevinden.',
  ...
  },
  {
    ...
    description: 'Een door Masai gerunde lodge op de westelijke hellingen van de Kilimanjaro, gebouwd rond een oprechte culturele uitwisseling met de omliggende gemeenschap.',
  ...
  },
  {
    ...
    description: 'Boomhutachtige suites hoog in het bladerdak van het grondwaterbos, diep in Lake Manyara zelf in plaats van aan de rand ervan.',
  ...
  },
  {
    ...
    description: 'Gelegen aan de rand van het Oloololo-escarpement, met een weids uitzicht over de volledige Mara-vlakte — een van de meest gefotografeerde uitzichtpunten van Oost-Afrika.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: 'Een actieve koffieplantage aan de rand van Arusha, dichtbij het vliegveld, die een ontspannen eerste of laatste nacht biedt voor of na de bush.',
  ...
  },
  {
    ...
    description: 'Koepelvormige bosvilla\'s gebouwd in een hersteld vulkanisch amfitheater, op korte rijafstand van de startpunten voor gorilla-trekking.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Tarangire Nationaal Park',
    description: 'Een eenvoudig, goed gerund kamp op de Tarangire-route voor reizigers die solide begeleiding willen zonder het premium prijskaartje.',
  ...
  },
  {
    ...
    description: 'Een stadshotel aan het strand op het Msasani-schiereiland, meestal gebruikt als comfortabele overnachtingsstop op weg naar of van de zuidelijke route.',
    ...
    featuredIn: [{ label: '5 Dagen Privé Chimpansee-trekking in Gombe', href: '/safaris/5-day-gombe-chimpanzee-trekking' }, { label: '7 Dagen Zuidelijke Route — Ruaha & Nyerere', href: '/safaris/7-day-southern-circuit' }],
  },
  {
    ...
    description: 'Een eenvoudige, budgetvriendelijke uitvalsbasis in Kigali voor reizigers voor wie de prijs voorop staat tijdens de gorilla-trekking- en primaten-etappes van een Rwanda-reis.',
  ...
  },
  {
    ...
    description: 'Een betrouwbaar hotel in Nairobi dat dient als vertrekpunt voor de reis naar Kenia\'s parken en reservaten.',
    amenities: ['Gratis wifi', 'Zwembad', 'Restaurant met volledige bediening'],
  ...
  },
  {
    ...
    description: 'Een kamp in het middensegment, gebouwd rond een natuurlijke bron die olifanten en ander wild vlak langs de accommodatie laat trekken.',
    ...
    featuredIn: [{ label: '7-Daagse Fotografie- en Avonturensafari Tanzania', href: '/safaris/7-day-photography-adventure-safari' }],
  },
  {
    ...
    description: 'Een spa-resort aan de oevers van het Naivashameer, dat tussen de game drive-dagen in de Rift Valley een echte adempauze biedt.',
  ...
  },
  {
    ...
    description: 'Een lodge gebouwd rond een eigen drinkplaats midden in de Serengeti, waar geregeld wild voorbijtrekt onder het terras.',
    ...
    featuredIn: [{ label: '10 Dagen Safari & Zanzibar Strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '12 Dagen Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '12-Daagse Wildernissafari, Culturele Ontmoetingen & Kilimanjaro Dagwandeling', href: '/safaris/12-days-wild-wilderness' }],
  },
  {
    slug: 'gibbs-farm',
    name: 'Gibb\'s Farm',
    ...
    description: 'Een al lang bestaand biologisch landgoed onder de kraterrand, dat nog altijd zijn eigen koffie en groenten teelt en algemeen wordt beschouwd als een van de beste keukens van Tanzania.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Masai Mara, Kenia',
    description: 'Een klassiek tentenkamp aan de oevers van de Mara-rivier, in een van de betrouwbaarste wildcorridors van het reservaat.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Arusha',
    description: 'Een verzorgd stadshotel in Arusha met volledige resortfaciliteiten voor reizigers die meer comfort willen voor of na hun safari.',
  ...
  },
  {
    ...
    description: 'Een resort direct aan het escarpement van de Rift Valley, dat weidse uitzichten over het dal combineert met volledige golf- en spafaciliteiten.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Nairobi, Kenia',
    description: 'Een boetiekhotel in koloniale stijl in de Nairobi-voorstad Karen, een werkelijk comfortabele uitvalsbasis aan beide zijden van een Kenia-safari.',
  ...
  },
  {
    ...
    description: 'Een kamp aan de bosrand, gebouwd voor wandelingen en het spoor volgen van primaten in de Udzungwa Mountains, een van de minst bezochte parken van Tanzania.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Dar es Salaam',
    description: 'Een stadshotel met volledige service aan de waterkant van Dar es Salaam, gebruikt als comfortabele tussenstop op reisroutes langs de zuidelijke route.',
    amenities: ['Zwembad', 'Restaurant met volledige bediening', 'Gratis wifi'],
  ...
  },
  {
    ...
    description: 'Een privékamp op een rotsachtige uitloper met uitzicht op de Ruaha-rivier, in een van de grootste en minst drukke parken van Tanzania.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Volcanoes Nationaal Park, Rwanda',
    description: 'Een budgetvriendelijke lodge dicht bij de grens van Volcanoes Nationaal Park, ideaal gelegen voor een vroege start op gorilla-trekkingdagen.',
    ...
    featuredIn: [{ label: '4 Dagen Rwanda Gorilla-trekking', href: '/safaris/4-day-rwanda-gorilla-trekking' }],
  },
  {
    slug: 'kahawa-house',
    name: 'Kahawa House',
    tier: 'trail',
    location: 'Arusha',
    description: 'Een ontspannen guesthouse op een actieve koffieplantage net buiten Arusha, een rustige eerste of laatste nacht voor of na de bush.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Westelijke Kilimanjaro',
    description: 'Een tentenkamp op privéterrein aan de voet van de Kilimanjaro, bekend om zijn vaste olifantenkuddes en het bergachtige decor.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenia',
    description: 'Een tentenkamp aan de westrand van de Mara, dicht bij het Oloololo-escarpement en binnen bereik van de rivieroversteekplaatsen.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Kigali, Rwanda',
    description: 'Een centraal gelegen hotel in Kigali, gebruikt als comfortabele overnachtingsstop voor of na gorilla-trekking in de Virunga\'s.',
    amenities: ['Gratis wifi', 'Zwembad', 'Restaurant met volledige bediening'],
  ...
  },
  {
    ...
    description: 'Een lodge op een heuvel met uitzicht op het Tanganyikameer, het vertrekpunt voor chimpansee-trekking in Gombe en Mahale.',
    ...
    featuredIn: [{ label: '5 Dagen Privé Chimpansee-trekking in Gombe', href: '/safaris/5-day-gombe-chimpanzee-trekking' }],
  },
  {
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Volcanoes Nationaal Park, Rwanda',
    description: 'Een eenvoudig guesthouse dicht bij de toegangspoort van Volcanoes Nationaal Park, ingericht voor vroege vertrekken naar gorilla-trekking.',
    ...
    featuredIn: [{ label: '11 Dagen Rwanda-Tanzania Safari', href: '/safaris/11-days-rwanda-tanzania' }, { label: '12 Dagen Rwanda Primaten-ervaring', href: '/safaris/12-days-rwanda-primates' }, { label: '12 Dagen Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }],
  },
  {
    ...
    description: 'Een tentenkamp op het escarpement van de Rift Valley met uitzicht op Lake Manyara, met vergezichten die zich uitstrekken over de bodem van het dal.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Eyasimeer',
    description: 'Een klein tentenkamp aan het Eyasimeer, de gebruikelijke uitvalsbasis voor bezoeken aan de Hadzabe-jagers-verzamelaarsgemeenschap.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, Ngorongoro-hoogland',
    description: 'Een voormalige koffieplantagelodge met brede veranda\'s gericht op het escarpement van de Rift Valley en een goed aangeschreven keuken, dicht bij de weg langs de kraterrand.',
  ...
  },
  {
    ...
    description: 'Een betrouwbare tentenlodge die wordt gebruikt op zowel de Tarangire- als de centrale Serengeti-etappe van diverse reisroutes, gewaardeerd om solide begeleiding tegen een eerlijke prijs.',
  ...
  },
  {
    ...
    description: 'Een comfortabele, centrale uitvalsbasis in Musanze voor het vertrek naar de gorilla\'s in Vulkanen Nationaal Park.',
    amenities: ['Gratis wifi', 'Restaurant met volledige bediening', 'Tuinaanleg'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Centrale Serengeti',
    description: 'Een tentenkamp in de centrale vlaktes van de Serengeti, met directe toegang tot enkele van de meest betrouwbare wildobservatiegebieden van het ecosysteem, het hele jaar door.',
    ...
    featuredIn: [{ label: '5 Dagen Hoogtepuntensafari', href: '/safaris/5-days-highlights-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Tarangire Nationaal Park',
    description: 'Een tentenlodge met uitzicht op het Burungemeer aan de grens van Tarangire, populair om de zonsondergangen over het water.',
  ...
  },
  {
    ...
    description: 'Een tentenkamp aan de oevers van het Elementaitameer, een rustiger alternatief voor de drukkere meren van de Rift Valley.',
  ...
  },
  {
    ...
    description: 'Een hotel aan het Kivumeer, meestal de afsluitende stop van een Rwanda-reisroute na de primaten-trekking-etappes.',
    amenities: ['Zwembad', 'Panoramisch uitzicht', 'Restaurant met volledige bediening'],
    ...
    featuredIn: [{ label: '12 Dagen Rwanda Primaten-ervaring', href: '/safaris/12-days-rwanda-primates' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Naivashameer, Kenia',
    description: 'Een resort aan het Naivashameer, uitstekend gelegen voor boottochten en wandelsafari\'s op het nabijgelegen Crescent Island.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Nakurumeer Nationaal Park, Kenia',
    description: 'Een lodge op hoger gelegen terrein boven het Nakurumeer, met panoramisch uitzicht over het meer en het omliggende park.',
  ...
  },
  {
    ...
    description: 'Een privékamp op een heuveltop boven de rivieroversteekplaatsen van de Mara, gebouwd voor reizigers die hun reis afstemmen op de rivieroversteken.',
  ...
  },
  {
    ...
    description: 'Een privé-tentenkamp dicht bij de afdaalweg naar Ngorongoro, die gasten al voor zonsopgang op de kraterbodem brengt.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Eiland Zanzibar',
    description: 'Een eenvoudig, goed gelegen guesthouse voor reizigers die hun Tanzania-safari met een kleiner budget verlengen naar de stranden van Zanzibar.',
    ...
    featuredIn: [{ label: '10 Dagen Safari & Zanzibar Strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '12 Dagen Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }],
  },
  {
    ...
    description: 'Een klassiek tentenkamp binnen het ecosysteem van de Masai Mara, eenvoudig gerund en ideaal gelegen voor vroege game drives.',
    ...
    featuredIn: [{ label: '8 Dagen Grote Noordelijke Trek', href: '/safaris/8-days-great-northern-migration' }],
  },
  {
    ...
    description: 'Een tentenlodge dicht bij het grensgebied tussen Kenia en Tanzania, ideaal gelegen voor het rivieroversteekseizoen van de trek.',
    ...
    featuredIn: [{ label: '10-Daagse Ultieme Grote Trek — Mara-Rivieroversteeksafari', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '8 Dagen Vlucht naar de Trek', href: '/safaris/8-days-flight-migration' }, { label: '8 Dagen Grote Noordelijke Trek', href: '/safaris/8-days-great-northern-migration' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenia',
    description: 'Een lodge op een heuveltop midden in de Masai Mara, met weidse uitzichten over de vlaktes en de rivier van het reservaat.',
    amenities: ['Gratis wifi', 'Zwembad', 'Restaurant met volledige bediening', 'Panoramisch uitzicht'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Masai Mara, Kenia',
    description: 'Een grote, gevestigde lodge binnen het ecosysteem van de Mara, dicht bij de rivieroversteekcorridor van de trek.',
  ...
  },
  {
    ...
    description: 'Een tentenkamp bij het Masekmeer in het Ndutu-gebied, jaarlijks het hart van het kalfsseizoen van de gnoes.',
  ...
  },
  {
    ...
    description: 'Een klein tentenkamp aan de oever van het Tanganyikameer, de uitvalsbasis voor chimpansee-trekking in Gombe Stream.',
  ...
  },
  {
    ...
    description: 'Een lodge met uitzicht op de open overstromingsvlakte van Mikumi, een van de best bereikbare parken op de zuidelijke route van Tanzania.',
    amenities: ['Zwembad', 'Panoramisch uitzicht', 'Restaurant met volledige bediening'],
    ...
    featuredIn: [{ label: '10 Dagen Geheimen van Zuid-Tanzania', href: '/safaris/10-days-southern-secrets' }, { label: '12 Dagen De Grote Safari', href: '/safaris/12-days-grand-safari' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Ndutu, Zuidelijke Serengeti',
    description: 'Een seizoensgebonden tentenkamp in het Ndutu-gebied, jaarlijks getimed op het kalfsseizoen van de gnoes.',
    amenities: ['Kamers met eigen badkamer', 'Dierenobservatie'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Karatu, Ngorongoro-hoogland',
    description: 'Een actieve koffieboerderij die is omgebouwd tot lodge, gelegen tussen bananenplantages op de bosrijke kraterrand — ontspannen en huiselijk in plaats van formeel.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, Ngorongoro-hoogland',
    description: 'Een lodge in het middensegment in het Ngorongoro-hoogland, met gemakkelijke toegang tot de afdaalweg naar de krater voor vroege game drives.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Ngorongoro-natuurgebied',
    description: 'Een lodge direct aan de kraterrand, een van de accommodaties die het dichtst bij de afdaalweg liggen, met een echt kraterzicht.',
  ...
  },
  {
    ...
    featuredIn: [{ label: '7 Dagen Kroonjuwelen Safari', href: '/safaris/7-days-crown-jewels' }, { label: '9-Daagse Huwelijksreissafari & Zanzibar Strandvakantie', href: '/safaris/9-day-honeymoon-safari-zanzibar' }],
  },
  {
    slug: 'ol-tukai-lodge',
    name: 'Ol Tukai Lodge',
    ...
    description: 'Een lodge midden in Amboseli National Park, met enkele van de meest betrouwbare Kilimanjaro-uitzichten van alle accommodaties in het park.',
  ...
  },
  {
    ...
    description: 'Een lodge aan de rand van het Nyungwe-woud, gericht op chimpansee-trekking en toegang tot het bomenkroonpad in plaats van op gorilla\'s.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Westelijke Kilimanjaro',
    description: 'Een door Masai beheerde lodge aan de voet van de Kilimanjaro, met naast de standaardkamers ook een premium Kisiwa Boma-suitecategorie.',
  ...
  },
  {
    ...
    featuredIn: [{ label: '10 Dagen Safari & Zanzibar Strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '12 Dagen Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: 'Ultieme Tanzania Safari', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
    ...
    featuredIn: [{ label: '10 Dagen Geheimen van Zuid-Tanzania', href: '/safaris/10-days-southern-secrets' }, { label: '11 Dagen Zuidelijke Wildernis & Kruideneilanden', href: '/safaris/11-days-southern-spice' }, { label: '12 Dagen De Grote Safari', href: '/safaris/12-days-grand-safari' }, { label: '7 Dagen Zuidelijke Route — Ruaha & Nyerere', href: '/safaris/7-day-southern-circuit' }],
  },
  {
    ...
    description: 'Een kamp aan de oever van de Rufiji-rivier in Nyerere National Park, de uitvalsbasis voor zowel game drives als bootsafari\'s.',
  ...
  },
  {
    ...
    description: 'Een tentenlodge met uitzicht op het Ihemameer in Akagera, het savannepark van Rwanda en de Big Five-bestemming van het land.',
    amenities: ['Panoramisch uitzicht', 'Dierenobservatie'],
  ...
  },
  {
    ...
    description: 'Een tentenkamp aan de Ewaso Nyiro-rivier in Samburu, thuisbasis van diersoorten die vrijwel nergens anders in Kenia voorkomen.',
    amenities: ['Panoramisch uitzicht', 'Dierenobservatie'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Nyerere Nationaal Park (Selous)',
    description: 'Een kamp gebouwd in de rotsen boven de Rufiji-rivier in het Selous-ecosysteem, bereikbaar per klein vliegtuig.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Nakurumeer Nationaal Park, Kenia',
    description: 'Een lodge op hoger gelegen terrein midden in Lake Nakuru National Park, met weidse uitzichten over het meer en zijn dierenwereld.',
    amenities: ['Gratis wifi', 'Zwembad', 'Restaurant met volledige bediening', 'Panoramisch uitzicht'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Nyerere Nationaal Park (Selous)',
    description: 'Een lodge boven de stroomversnellingen van de Rufiji-rivier in Nyerere National Park, die game drives combineert met activiteiten op het water.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Centrale Serengeti',
    description: 'Een privékamp in de centrale Serengeti, gebouwd voor reizigers die een kleinere, exclusievere voetafdruk in het ecosysteem willen.',
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Centrale Serengeti',
    description: 'Een klassiek tentenkamp onder acaciabomen, midden in de wildrijke centrale vlaktes van de Serengeti.',
    ...
    featuredIn: [{ label: '5 Dagen Hoogtepuntensafari', href: '/safaris/5-days-highlights-safari' }, { label: '7 Dagen Serengeti & Ngorongoro Safari', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 Dagen Grote Noordelijke Trek', href: '/safaris/8-days-great-northern-migration' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Centrale Serengeti',
    description: 'Een eenvoudig tentenkamp in de centrale Serengeti, met solide toegang tot de vlaktes zonder premium prijskaartje.',
    amenities: ['Kamers met eigen badkamer', 'Restaurant met volledige bediening', 'Dierenobservatie'],
    ...
    featuredIn: [{ label: '10 Dagen Safari & Zanzibar Strand', href: '/safaris/10-day-safari-zanzibar' }, { label: '12 Dagen Rwanda, Tanzania & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '8-Daagse Huwelijksreissafari — Voor Bushliefhebbers', href: '/safaris/8-days-honeymoon-safari' }],
  },
  {
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Centrale Serengeti',
    description: 'Een luxe tentenkamp in de vlaktes van de centrale Serengeti, met naast de standaardtenten ook een premium suitecategorie.',
  ...
  },
  {
    ...
    description: 'Een tentenkamp midden in de Ol Pejeta Conservancy, thuisbasis van het grootste zwarte-neushoornreservaat van Kenia en de laatste noordelijke witte neushoorns ter wereld.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, Ngorongoro-hoogland',
    description: 'Een landhuis in koloniale stijl op een koffieplantage nabij de kraterrand, dat historische architectuur combineert met een werkelijk sterke keuken.',
    ...
    featuredIn: [{ label: '10 Dagen Luxe Familiesafari Tanzania', href: '/safaris/10-days-luxury-family' }, { label: '7 Dagen Kroonjuwelen Safari', href: '/safaris/7-days-crown-jewels' }, { label: '8 Dagen Vlucht naar de Trek', href: '/safaris/8-days-flight-migration' }, { label: 'Hoogtepunten van Kenia & Tanzania Safari', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    slug: 'tloma-lodge',
    name: 'Tloma Lodge',
  ...
  },
  {
    ...
    description: 'Een budgetvriendelijk kamp in het Ngorongoro-hoogland voor reizigers voor wie de prijs voorop staat tijdens de kraterfase van hun reis.',
    amenities: ['Restaurant met volledige bediening', 'Tuinaanleg'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Rwanda',
    description: 'Een centraal gelegen hotel in Kigali met een comfortabele, goed gelegen uitvalsbasis voor of na Rwanda\'s nationale parken.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Tarangire-regio',
    description: 'Een tentenkamp op de Tarangire-route met betrouwbare begeleiding en wildobservatie voor een middenklasseprijs.',
    amenities: ['Restaurant met volledige bediening', 'Gratis wifi', 'Dierenobservatie'],
