...
export const accommodations: Accommodation[] = [
  {
    ...
    description: 'Un camp de tentes de luxe entièrement mobile qui suit la Grande Migration elle-même — vous ne poursuivez pas les troupeaux, vous vous réveillez simplement là où ils se trouvent.',
  ...
  },
  {
    ...
    description: "Un lodge géré par des Maasaï sur les versants occidentaux du Kilimandjaro, conçu autour d'un véritable échange culturel avec la communauté environnante plutôt qu'une version mise en scène de celui-ci.",
  ...
  },
  {
    ...
    description: 'Le seul lodge permanent situé au cœur même du lac Manyara, avec des suites en forme de cabanes perchées dans la canopée de la forêt alimentée par la nappe phréatique — un point de vue réellement différent sur le parc que tout ce qui se trouve en périphérie.',
  ...
  },
  {
    ...
    description: "Perché sur l'escarpement d'Oloololo, avec une vue sur l'ensemble de la plaine du Mara devenue l'un des panoramas les plus photographiés d'Afrique de l'Est — et pour cause.",
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: "Une plantation de café en activité près de l'aéroport, qui transforme une première ou dernière nuit de simple formalité en véritable moment de détente.",
  ...
  },
  {
    ...
    description: "Des villas en dôme nichées dans un amphithéâtre volcanique restauré, à quelques minutes de route des départs de trekking des gorilles — l'un des lodges les plus acclamés construits en Afrique cette décennie.",
  ...
  },
  {
    ...
    description: "Un lodge de tentes en bordure de Tarangire, idéalement placé pour un accès matinal à l'un des paysages à éléphants les plus denses d'Afrique.",
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parc national de Tarangire',
    description: "Un camp sans fioritures qui investit là où ça compte vraiment sur le circuit de Tarangire : un guidage solide, une cuisine bien tenue et un prix honnête plutôt qu'un budget de complexe hôtelier.",
  ...
  },
  {
    ...
    description: "Un hôtel urbain en bord de mer sur la péninsule de Msasani — réellement confortable, et l'étape classique en route vers ou depuis le circuit sud.",
    ...
    featuredIn: [{ label: '5 Jours Trekking Privé des Chimpanzés de Gombe', href: '/safaris/5-day-gombe-chimpanzee-trekking' }, { label: '7 Jours Circuit Sud — Ruaha & Nyerere', href: '/safaris/7-day-southern-circuit' }, { label: 'Safari Ultime en Tanzanie & Trekking des Chimpanzés à Gombe', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
    ...
    description: "Un complexe balnéaire tout compris sur la côte de Nungwi à Zanzibar, l'étape finale de niveau Wilderness Reserve du safari de 10 Jours en Tanzanie & Plage de Zanzibar.",
    amenities: ['Tout compris', 'Piscine', 'Bord de mer', 'Restaurant complet'],
    ...
    featuredIn: [{ label: '10 Jours Safari en Tanzanie & Plage de Zanzibar', href: '/safaris/10-day-safari-zanzibar' }],
  ...
  },
  {
    ...
    description: "Une base simple et sans fioritures à Kigali, pour les voyageurs qui préfèrent consacrer leur budget au trekking des gorilles et des primates plutôt qu'aux premières et dernières nuits en ville.",
  ...
  },
  {
    ...
    description: "Un hôtel-porte d'entrée fiable et bien situé à Nairobi — le genre d'étape pratique, en début ou fin de séjour, qui remplit parfaitement son rôle avant que les parcs ne prennent le relais.",
    amenities: ['WiFi gratuit', 'Piscine', 'Restaurant complet'],
  ...
  },
  {
    ...
    description: "Construit autour d'une source naturelle qui attire éléphants et autre faune juste devant la propriété — un camp de milieu de gamme avec un avantage d'observation que peu de camps de sa catégorie possèdent.",
    ...
    featuredIn: [{ label: "Safari Photographique et d'Aventure de 7 Jours en Tanzanie", href: '/safaris/7-day-photography-adventure-safari' }, { label: '10 Jours Safari en Tanzanie & Plage de Zanzibar', href: '/safaris/10-day-safari-zanzibar' }],
  },
  {
    ...
    description: "Un véritable complexe spa sur les rives du lac Naivasha — une vraie journée de ralentissement au cœur d'un programme dans la Vallée du Rift, et non simplement un lodge de plus entre deux game drives.",
  ...
  },
  {
    ...
    description: "Construit autour de son propre point d'eau au cœur du Serengeti, où la faune passe régulièrement juste en contrebas de la terrasse — le standard Four Seasons, en plein milieu des plaines.",
    ...
    featuredIn: [{ label: '12 Jours Rwanda, Tanzanie & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: "Safari Wilderness de 12 Jours, Rencontres Culturelles et Randonnée d'une Journée au Kilimandjaro", href: '/safaris/12-days-wild-wilderness' }],
  },
  {
    slug: 'gibbs-farm',
    name: "Gibb's Farm",
    ...
    description: "Un domaine agricole biologique de longue date, en contrebas du rebord du cratère, qui cultive toujours son propre café et ses propres produits, et largement considéré comme l'une des meilleures tables de Tanzanie, tous établissements confondus, pas seulement parmi les lodges.",
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenya',
    description: "Le tout premier camp de tentes de luxe du Mara, en activité continue depuis 1972, sur les rives de la rivière Mara, dans l'un des corridors fauniques les plus fiables de la réserve — une icône, non une étape économique.",
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: "La propre sous-marque de luxe de Meliá, à proximité de l'aéroport — toutes les installations d'un complexe hôtelier et un vrai raffinement pour les voyageurs qui recherchent davantage de confort avant ou après la brousse.",
  ...
  },
  {
    ...
    description: "Installé directement sur l'escarpement, associant de vastes vues sur la vallée à des installations complètes de golf et de spa que la plupart des établissements de safari n'offrent tout simplement pas.",
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Nairobi, Kenya',
    description: 'Un hôtel-boutique de style colonial à Karen, membre de la Hemingways Collection reconnue mondialement — réellement confortable et pas seulement pratique, en début ou fin de safari au Kenya.',
  ...
  },
  {
    ...
    description: "Un camp en lisière de forêt conçu pour la randonnée et le suivi des primates, dans l'un des parcs les moins visités et les plus gratifiants de Tanzanie, pour les voyageurs en quête de quelque chose au-delà du circuit habituel.",
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Dar es Salaam',
    description: "Un hôtel complet en bord d'eau, utilisé comme étape de transit confortable sur les itinéraires du circuit sud — une solide option haut de gamme, au même niveau de marque que le Radisson Blu.",
    amenities: ['Piscine', 'Restaurant complet', 'WiFi gratuit'],
  ...
  },
  {
    ...
    description: "Un camp privé sur un affleurement rocheux surplombant la rivière Ruaha, dans l'un des parcs les plus vastes et les moins fréquentés de Tanzanie.",
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parc national des Volcans, Rwanda',
    description: "Un lodge économique situé juste à la limite du parc national des Volcans, délibérément placé pour les départs matinaux qu'exige une matinée de trekking des gorilles.",
    ...
    featuredIn: [{ label: '4 Jours Trek des Gorilles au Rwanda', href: '/safaris/4-day-rwanda-gorilla-trekking' }, { label: 'Safari des Primates du Rwanda & Escapade Plage à Zanzibar', href: '/safaris/12-days-rwanda-primates' }],
  },
  {
    slug: 'kahawa-house',
    name: 'Kahawa House',
    tier: 'trail',
    location: 'Arusha',
    description: "Une maison d'hôtes détendue sur une plantation de café en activité aux abords d'Arusha — une première ou dernière nuit réellement calme et bien tenue, avant ou après la brousse.",
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kilimandjaro Ouest',
    description: "Un camp de tentes sur un terrain privé au pied du Kilimandjaro, réputé pour ses troupeaux d'éléphants résidents qui traversent le camp et une toile de fond montagneuse qui n'a besoin d'aucun artifice.",
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenya',
    description: "Le camp le plus accessible d'&Beyond dans le Mara — tout le standard d'hospitalité et d'emplacement andBeyond, à un tarif nettement plus doux que leurs propriétés phares.",
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Rwanda',
    description: 'Un hôtel du centre de Kigali qui porte le standard 5 étoiles constant de Serena — une étape réellement confortable avant ou après le trekking des gorilles dans les Virunga, et non un simple choix par défaut économique.',
    amenities: ['WiFi gratuit', 'Piscine', 'Restaurant complet'],
  ...
  },
  {
    ...
    description: "Un lodge de colline avec une vraie vue sur le lac Tanganyika, servant de porte d'entrée vers l'une des expériences les plus reculées et les plus gratifiantes de Tanzanie : le trekking des chimpanzés à Gombe et à Mahale.",
    ...
    featuredIn: [{ label: '5 Jours Trekking Privé des Chimpanzés de Gombe', href: '/safaris/5-day-gombe-chimpanzee-trekking' }, { label: 'Safari Ultime en Tanzanie & Trekking des Chimpanzés à Gombe', href: '/safaris/ultimate-tanzania-safari' }],
  },
  {
    ...
    description: "Des pavillons privés en dôme nichés à flanc de colline au-dessus de l'océan Indien, chacun doté de sa propre piscine à débordement — un changement de rythme délibéré après des jours passés dans la brousse.",
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Parc national des Volcans, Rwanda',
    description: "Une maison d'hôtes simple et efficace à l'entrée du parc national des Volcans, conçue spécifiquement pour les départs matinaux qu'exige une matinée de trekking des gorilles.",
    ...
    featuredIn: [{ label: '11 Jours Safari Rwanda Tanzanie', href: '/safaris/11-days-rwanda-tanzania' }, { label: '12 Jours Rwanda, Tanzanie & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }],
  },
  {
    ...
    description: "Un camp de tentes sur l'escarpement de la Vallée du Rift, où la vue se suffit à elle-même — le fond de la vallée s'étend en contrebas à perte de vue.",
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Lac Eyasi',
    description: 'Un petit camp de tentes au bord du lac Eyasi, la base habituelle et la mieux placée pour les visites à la communauté de chasseurs-cueilleurs hadzabe.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, hautes terres du Ngorongoro',
    description: "Une ancienne plantation de café aux larges vérandas donnant sur l'escarpement de la Vallée du Rift, avec une cuisine qui mérite vraiment qu'on en parle, à proximité de la route du rebord du cratère.",
  ...
  },
  {
    ...
    description: 'Un lodge de tentes fiable, utilisé aussi bien sur les étapes de Tarangire que du Serengeti central dans plusieurs de nos itinéraires — un guidage solide à un prix honnête, à chaque fois.',
  ...
  },
  {
    ...
    description: 'Une base confortable et centrale à Musanze, avant de partir suivre les gorilles dans les Virunga.',
    amenities: ['WiFi gratuit', 'Restaurant complet', 'Jardins'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Serengeti central',
    description: "Un camp de tentes au cœur des plaines, avec un accès rapproché à certaines des zones d'observation les plus fiables de l'écosystème, toute l'année.",
    ...
    featuredIn: [{ label: '5 Jours Safari des Points Forts', href: '/safaris/5-days-highlights-safari' }, { label: 'Ascension du Kilimandjaro par la Route Lemosho & Safari Highlights de 5 Jours', href: '/safaris/14-days-kilimanjaro-lemosho-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Parc national de Tarangire',
    description: "Un lodge de tentes en bordure du lac Burunge, à la limite de Tarangire, surtout connu des hôtes pour ses vues de coucher de soleil directement sur l'eau.",
    ...
    featuredIn: [{ label: '8 Jours Grande Migration du Nord', href: '/safaris/8-days-great-northern-migration' }, { label: 'Safari de 12 Jours en Tanzanie pour Seniors, Anniversaires et Groupes', href: '/safaris/12-day-seniors-anniversary-groups-safari' }, { label: 'Safari Confort 5 Jours en Tanzanie', href: '/safaris/5-day-comfort-tanzania-safari' }, { label: "Safari d'Extension de 5 Jours Après le Kilimandjaro", href: '/safaris/kilimanjaro-extension-safari' }, { label: 'Safari Confort 6 Jours en Tanzanie', href: '/safaris/6-day-comfort-tanzania-safari' }],
  },
  {
    ...
    description: 'Un camp de tentes Serena sur un lac de la Vallée du Rift plus tranquille que ses voisins plus fréquentés.',
  ...
  },
  {
    ...
    description: "Un établissement Serena au bord du lac, généralement l'étape finale d'un itinéraire au Rwanda une fois les étapes de trekking des primates terminées.",
    amenities: ['Piscine', 'Vue panoramique', 'Restaurant complet'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Lac Naivasha, Kenya',
    description: "Un complexe fiable au bord du lac, bien placé pour les excursions en bateau vers Crescent Island et les safaris à pied — le genre de séjour confortable et sans surprise pour lequel les établissements Sopa sont réputés dans toute l'Afrique de l'Est.",
  ...
  },
  {
    ...
    description: "À l'intérieur même du parc, historiquement connu pour son rivage bordé de flamants roses et sa population résidente de rhinocéros.",
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parc national du lac Nakuru, Kenya',
    description: "Installé en hauteur au-dessus du lac, avec des vues réellement panoramiques, et le même standard Sopa fiable que dans leurs autres établissements d'Afrique de l'Est.",
  ...
  },
  {
    ...
    description: "Un camp privé au sommet d'une colline, directement au-dessus des points de traversée de la rivière Mara — l'un des camps les mieux placés pour les voyageurs qui calent leur voyage sur les traversées elles-mêmes.",
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Parc national de Tarangire',
    description: "Un camp de tentes privé surplombant la rivière Tarangire, dans l'un des paysages à éléphants les plus denses d'Afrique en dehors de la saison des pluies.",
    ...
    featuredIn: [{ label: '10 Jours Safari Familial de Luxe en Tanzanie', href: '/safaris/10-days-luxury-family' }, { label: '7 Jours Les Joyaux du Nord', href: '/safaris/7-days-gems-of-north' }, { label: '8 Jours Grande Migration du Nord', href: '/safaris/8-days-great-northern-migration' }, { label: 'Safari de 8 Jours — Traversée de la Rivière par les Gnous', href: '/safaris/8-days-flight-migration' }],
  },
  {
    slug: 'lemala-osonjoi',
    name: 'Lemala Osonjoi',
    ...
    description: "Un camp de tentes privé proche de la route de descente, qui met ses hôtes au fond du cratère avant que la plupart des autres camps n'aient fini leur petit-déjeuner.",
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Île de Zanzibar',
    description: "Une maison d'hôtes simple et bien placée, pour les voyageurs qui prolongent leur séjour sur les plages de Zanzibar sans faire exploser le budget.",
  ...
  },
  {
    ...
    description: "Un camp de tentes classique, géré simplement et honnêtement, placé pour les départs matinaux qui font toute la différence lors d'un game drive dans l'écosystème du Mara.",
    ...
    featuredIn: [{ label: '8 Jours Grande Migration du Nord', href: '/safaris/8-days-great-northern-migration' }, { label: 'Safari de 8 Jours — Traversée de la Rivière par les Gnous', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    description: 'Un lodge de tentes proche de la zone frontalière entre le Kenya et la Tanzanie, positionné spécifiquement pour la saison des traversées de rivière de la migration.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Masai Mara, Kenya',
    description: "Un lodge Serena au sommet d'une colline, avec de vastes vues sur les plaines de la réserve et la rivière en contrebas.",
    amenities: ['WiFi gratuit', 'Piscine', 'Restaurant complet', 'Vue panoramique'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Nord du Serengeti',
    description: 'Un camp de tentes mobile qui se déplace avec la migration elle-même, à travers le nord du Serengeti et la frontière du Mara.',
    ...
    featuredIn: [{ label: 'Safari Photographique en Tanzanie — Tarangire, Cratère du Ngorongoro & Serengeti', href: '/safaris/tanzania-photographic-safari' }, { label: 'Safari de 8 Jours — Traversée de la Rivière par les Gnous', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Masai Mara, Kenya',
    description: 'Un grand lodge bien établi, proche du corridor de traversée de rivière de la migration — la fiabilité solide de Sopa, portée par un emplacement réellement fort.',
  ...
  },
  {
    ...
    description: 'Un camp de tentes près du lac Masek, en plein cœur de la saison de mise bas des gnous chaque année.',
  ...
  },
  {
    ...
    description: 'Un petit camp de tentes sur les rives du lac Tanganyika, la base pratique et confortable pour le trekking des chimpanzés à Gombe.',
  ...
  },
  {
    ...
    description: "Surplombant la plaine inondable ouverte de Mikumi — l'un des parcs les plus accessibles du circuit sud, avec un lodge à la hauteur de cette facilité.",
    amenities: ['Piscine', 'Vue panoramique', 'Restaurant complet'],
  ...
  },
  {
    ...
    description: "Un éco-lodge en lisière de la forêt de Nyungwe, à proximité des départs de sentiers pour le trekking des chimpanzés à travers l'une des plus anciennes forêts tropicales de montagne d'Afrique.",
    amenities: ['Restaurant complet', 'Vue sur la faune', 'Vue sur la forêt'],
    ...
    featuredIn: [{ label: 'Safari des Primates du Rwanda & Escapade Plage à Zanzibar', href: '/safaris/12-days-rwanda-primates' }],
    needsPhotography: true,
  },
  {
    ...
    tier: 'reserve',
    location: 'Ndutu, sud du Serengeti',
    description: 'Un camp de tentes saisonnier, calé précisément sur la saison de mise bas des gnous chaque année.',
    amenities: ['Chambres avec salle de bain privée', 'Vue sur la faune'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Ndutu, sud du Serengeti',
    description: "Un lodge permanent en pierre et chaume de 34 cottages surplombant le lac Ndutu, positionné pour un accès toute l'année aux prédateurs résidents qui restent lorsque la migration repart.",
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Karatu, hautes terres du Ngorongoro',
    description: 'Une ferme de café en activité devenue lodge parmi les bananeraies du rebord du cratère — détendue et chaleureuse par choix, sans chercher à être plus grandiose.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, hautes terres du Ngorongoro',
    description: 'Un lodge de milieu de gamme sur les hauts plateaux, avec un accès facile à la route de descente du cratère pour les game drives matinaux.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Zone de conservation du Ngorongoro',
    description: 'Installé directement sur le rebord du cratère, parmi les établissements les plus proches de la route de descente, avec de véritables vues dégagées sur le cratère.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Zone de conservation du Ngorongoro',
    description: 'Un lodge Serena en pierre, taillé dans le rebord boisé du cratère, avec des chambres qui plongent directement sur le fond du Ngorongoro.',
    amenities: ['Vue panoramique', 'Restaurant complet', 'Chambres avec salle de bain privée'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Nungwi, Zanzibar',
    description: 'Un établissement en bord de mer à la pointe nord de Zanzibar, réputé parmi les hôtes pour ses eaux de baignade calmes et ses couchers de soleil systématiquement réussis.',
    ...
    featuredIn: [{ label: '7 Jours Safari Joyaux de la Couronne', href: '/safaris/7-days-crown-jewels' }, { label: 'Safari Lune de Miel 9 Jours & Escapade Plage à Zanzibar', href: '/safaris/9-day-honeymoon-safari-zanzibar' }, { label: '10 Jours Safari en Tanzanie & Plage de Zanzibar', href: '/safaris/10-day-safari-zanzibar' }, { label: 'Safari des Primates du Rwanda & Escapade Plage à Zanzibar', href: '/safaris/12-days-rwanda-primates' }],
  },
  {
    slug: 'ol-tukai-lodge',
    name: 'Ol Tukai Lodge',
    ...
    description: "À l'intérieur même du parc, avec l'une des vues sur le Kilimandjaro les plus constamment fiables de tous les établissements d'Amboseli — une vraie différence à ce niveau de prix.",
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Forêt de Nyungwe, Rwanda',
    description: "Une marque d'ultra-luxe reconnue mondialement, installée au sein d'une plantation de thé en activité en lisière de Nyungwe — conçue autour du trekking des chimpanzés et de l'accès à la passerelle de canopée plutôt qu'autour des gorilles.",
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kilimandjaro Ouest',
    description: "Un lodge appartenant à des Maasaï au pied du Kilimandjaro, avec une catégorie de suites premium Kisiwa Boma aux côtés de ses chambres standard — un établissement distinct de l'Africa Amini Original Maasai Lodge, positionné séparément.",
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Rwanda',
    description: "Un hôtel international complet au centre de Kigali, une étape-porte d'entrée confortable avant ou après le trekking des primates au Rwanda.",
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Île de Zanzibar',
    description: "Un complexe balnéaire tout compris en bord de mer, l'étape finale classique pour les safaris qui se prolongent sur l'île.",
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Parc national de Ruaha',
    description: "Disséminé le long de la Grande Rivière Ruaha, dans le plus grand parc national de Tanzanie et l'un des plus réellement sous-visités.",
    amenities: ['Vue panoramique', 'Vue sur la faune', 'Restaurant complet'],
    ...
    featuredIn: [{ label: '10 Jours Secrets du Sud de la Tanzanie', href: '/safaris/10-days-southern-secrets' }, { label: '11 Jours Faune du Sud & Îles aux Épices', href: '/safaris/11-days-southern-spice' }, { label: '7 Jours Circuit Sud — Ruaha & Nyerere', href: '/safaris/7-day-southern-circuit' }],
  },
  {
    ...
    description: "Un camp au bord de la rivière Rufiji, la base pour combiner game drives et safaris en bateau au cours d'un même séjour.",
  ...
  },
  {
    ...
    description: 'Surplombant le lac Ihema à Akagera, la propre destination Big Five du Rwanda et un paysage réellement différent de celui des volcans.',
    amenities: ['Vue panoramique', 'Vue sur la faune'],
  ...
  },
  {
    ...
    description: "Sur la rivière Ewaso Nyiro, qui abrite des espèces que l'on ne trouve presque nulle part ailleurs au Kenya — girafe réticulée, zèbre de Grévy, gérénuk.",
    amenities: ['Vue panoramique', 'Vue sur la faune'],
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parc national de Nyerere (Selous)',
    description: "Construit dans la roche au-dessus de la rivière Rufiji et accessible uniquement par petit avion — un isolement que peu d'établissements de cette catégorie parviennent à offrir.",
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Parc national du lac Nakuru, Kenya',
    description: "En hauteur, à l'intérieur du parc, avec de larges vues sur le lac et la faune qu'il attire.",
    amenities: ['WiFi gratuit', 'Piscine', 'Restaurant complet', 'Vue panoramique'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Parc national de Nyerere (Selous)',
    description: "Un lodge Serena surplombant les rapides de la rivière Rufiji, combinant game drives et activités fluviales au cours d'un même séjour.",
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Serengeti central',
    description: "Un camp privé délibérément conçu pour une empreinte plus restreinte et plus exclusive dans l'écosystème que les grands établissements du Serengeti central.",
    ...
    featuredIn: [{ label: 'Safari 10 Jours Grande Migration Ultime — Traversée de la Rivière Mara', href: '/safaris/10-day-ultimate-great-migration-mara-river-crossing' }, { label: '10 Jours Safari en Tanzanie & Plage de Zanzibar', href: '/safaris/10-day-safari-zanzibar' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Serengeti central',
    description: "Un camp de tentes classique à l'ombre des acacias, en plein cœur des plaines giboyeuses — un accès solide sans le prix des établissements premium.",
    ...
    featuredIn: [{ label: '5 Jours Safari des Points Forts', href: '/safaris/5-days-highlights-safari' }, { label: '7 Jours Safari Serengeti & Ngorongoro', href: '/safaris/7-day-serengeti-ngorongoro' }, { label: '8 Jours Grande Migration du Nord', href: '/safaris/8-days-great-northern-migration' }, { label: 'Safari de 8 Jours — Traversée de la Rivière par les Gnous', href: '/safaris/8-days-flight-migration' }, { label: '10 Jours Safari en Tanzanie & Plage de Zanzibar', href: '/safaris/10-day-safari-zanzibar' }, { label: "Safari d'Extension de 5 Jours Après le Kilimandjaro", href: '/safaris/kilimanjaro-extension-safari' }],
  },
  {
    ...
    tier: 'trail',
    location: 'Serengeti central',
    description: 'Un camp de tentes sans détour offrant un accès réel aux plaines centrales, tarifé pour les voyageurs qui préfèrent investir dans plus de jours plutôt que dans une tente plus sophistiquée.',
    amenities: ['Chambres avec salle de bain privée', 'Restaurant complet', 'Vue sur la faune'],
    ...
    featuredIn: [{ label: '12 Jours Rwanda, Tanzanie & Zanzibar', href: '/safaris/12-days-rwanda-tanzania-zanzibar' }, { label: '8 Jours Safari Lune de Miel — Amoureux de la Brousse', href: '/safaris/8-days-honeymoon-safari' }],
  },
  {
    ...
    tier: 'sovereign',
    location: 'Ndutu, sud du Serengeti',
    description: 'Un camp mobile saisonnier installé chaque année sur le site de Ndutu pour suivre la saison de mise bas des gnous.',
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Parc national de Tarangire',
    description: "Un camp de tentes privé surélevé sur pilotis au-dessus de la cime des arbres de Tarangire, en territoire d'éléphants toute l'année.",
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Arusha',
    description: "Une propriété en villa privée, une alternative plus personnelle à un séjour d'hôtel standard avant ou après la brousse.",
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Serengeti central',
    description: 'Un camp de tentes dans les plaines, avec une catégorie de suites premium aux côtés de ses tentes standard.',
  ...
  },
  {
    ...
    description: "À l'intérieur d'Ol Pejeta, qui abrite le plus grand sanctuaire de rhinocéros noirs du Kenya et les derniers rhinocéros blancs du Nord au monde — une référence faunique réellement rare.",
  ...
  },
  {
    ...
    tier: 'trail',
    location: 'Parc national de Tarangire',
    description: "Un camp de tentes simple et efficace sur le circuit de Tarangire, bien situé pour observer les denses troupeaux d'éléphants du parc, sans le tarif d'un complexe hôtelier.",
    amenities: ['Chambres avec salle de bain privée', 'Vue sur la faune', 'Restaurant complet'],
  ...
  },
  {
    ...
    tier: 'sovereign',
    location: 'Parc national de Tarangire',
    description: "Un camp de luxe surélevé sur le circuit de Tarangire, membre de l'Elewana Collection, offrant une vue à hauteur de cimes sur l'un des paysages à éléphants les plus denses d'Afrique.",
    amenities: ['Piscine', 'Vue panoramique', 'Spa', 'Vue sur la faune'],
  ...
  },
  {
    ...
    description: "Un lodge de réserve communautaire en bordure d'Amboseli, construit autour d'un programme de conservation communautaire, avec ses propres vues sur le Kilimandjaro.",
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Karatu, hautes terres du Ngorongoro',
    description: "Un manoir de style colonial sur une ancienne plantation de café près du rebord du cratère, associant une architecture d'époque à une cuisine qui mérite réellement sa réputation.",
    ...
    featuredIn: [{ label: '10 Jours Safari Familial de Luxe en Tanzanie', href: '/safaris/10-days-luxury-family' }, { label: '10 Jours Safari en Tanzanie & Plage de Zanzibar', href: '/safaris/10-day-safari-zanzibar' }, { label: '7 Jours Safari Joyaux de la Couronne', href: '/safaris/7-days-crown-jewels' }, { label: 'Safari Incontournables Kenya & Tanzanie', href: '/safaris/kenya-tanzania-highlights-safari' }],
  },
  {
    slug: 'tloma-lodge',
    name: 'Tloma Lodge',
    tier: 'reserve',
    location: 'Karatu, hautes terres du Ngorongoro',
    description: 'Un lodge de jardin sur une ancienne plantation de café aux abords de Karatu, détendu et proche de la route de descente du cratère.',
  ...
  },
  {
    ...
    description: "Un camp économique sur les hauts plateaux, le choix raisonnable pour les voyageurs qui privilégient le rapport qualité-prix sur l'étape du cratère d'un voyage plus long.",
    amenities: ['Restaurant complet', 'Jardins'],
    ...
    featuredIn: [{ label: '5 Jours Safari des Points Forts', href: '/safaris/5-days-highlights-safari' }, { label: 'Safari de 8 Jours — Traversée de la Rivière par les Gnous', href: '/safaris/8-days-flight-migration' }],
  },
  {
    ...
    tier: 'reserve',
    location: 'Kigali, Rwanda',
    description: 'Un hôtel du centre de Kigali, confortable et bien situé, avant ou après les parcs nationaux du Rwanda.',
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Île de Zanzibar',
    description: "Un établissement Serena sur l'île de Zanzibar, l'étape d'arrivée où le trekking des primates du Rwanda cède la place à une série de journées de plage sans emploi du temps.",
    amenities: ['Piscine', 'Bord de mer', 'Restaurant complet'],
  ...
  },
  {
    ...
    tier: 'reserve',
    location: 'Région de Tarangire',
    description: 'Un camp de tentes sur le circuit de Tarangire, avec un guidage et une observation de la faune fiables, à un tarif réellement de milieu de gamme.',
    amenities: ['Restaurant complet', 'WiFi gratuit', 'Vue sur la faune'],
