...
export const metadata: Metadata = {
  ...
  description:
    'Get in touch with our Tanzania-based safari experts. We respond within 2 hours with a custom itinerary tailored to your dates, budget, and bucket list.',
  keywords: [
...
const contactCards = [
  ...
  },
  {
    icon: Mail,
    label: 'Email',
    value: 'info@theextremewilderness.com',
  ...
  },
  {
    ...
    label: 'Response Time',
    value: 'Under 2 hours',
    sub: 'During business hours EAT (UTC+3)',
  },
]
      ...
      <section className="relative bg-brand min-h-[60vh] flex items-stretch overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center w-full lg:w-1/2 px-6 sm:px-10 lg:px-16 pt-32 pb-16 lg:py-28">
          ...
          <p className="text-white/70 text-base leading-relaxed mb-8 max-w-md">
            Tell us your dream. Our team responds within 2 hours with a personalised itinerary — no obligation, just honest advice from people who live this every day.
          </p>
            ...
            <div className="space-y-5 lg:sticky lg:top-24">
              ...
              <div className="bg-brand rounded-2xl p-6 text-white">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="font-bold text-white">Prefer WhatsApp?</h3>
                </div>
