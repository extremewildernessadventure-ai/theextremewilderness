...
const TRAVEL_INFO_KEYWORDS: Record<Locale, string[]> = {
  ...
  da: [
    'visum til Tanzania',
    'rejsetips Tanzania',
    'vaccinationer Tanzania',
    'pakkeliste safari',
    'bedste tidspunkt for safari i Tanzania',
    'vejr Serengeti safari',
    'valuta Tanzania',
    'malariaforebyggelse Tanzania',
    'indrejsekrav Tanzania',
    'hvad skal man pakke til safari',
    'rejseforsikring Afrika',
    'gul feber certifikat Tanzania',
    'rejsevejledning Tanzania',
    'bedste sæson Kilimanjaro',
    'pakkeliste Kilimanjaro',
    'hvornår bestige Kilimanjaro',
    'strøm og stik i Tanzania',
    'drikkepenge safari guide',
    'er Tanzania sikkert for turister',
    'gnumigration måned for måned',
    'valutakurs tanzanianske shilling',
    'hvad skal man have på til safari',
  ],
  pl: [
    'wiza do Tanzanii',
    'porady podróżne Tanzania',
    'szczepienia Tanzania',
    'lista rzeczy na safari',
    'najlepszy czas na safari w Tanzanii',
    'pogoda safari Serengeti',
    'waluta Tanzania',
    'profilaktyka malarii Tanzania',
    'wymogi wjazdowe Tanzania',
    'co spakować na safari',
    'ubezpieczenie podróżne Afryka',
    'certyfikat żółtej gorączki Tanzania',
    'poradnik podróżny Tanzania',
    'najlepszy sezon na Kilimandżaro',
    'lista rzeczy na Kilimandżaro',
    'kiedy wejść na Kilimandżaro',
    'prąd i gniazdka w Tanzanii',
    'napiwki dla przewodnika safari',
    'czy Tanzania jest bezpieczna dla turystów',
    'migracja gnu miesiąc po miesiącu',
    'kurs wymiany szylinga tanzańskiego',
    'co na siebie na safari',
  ],
  cs: [
    'vízum do Tanzanie',
    'cestovní rady Tanzanie',
    'očkování Tanzanie',
    'seznam věcí na safari',
    'nejlepší doba na safari v Tanzanii',
    'počasí safari Serengeti',
    'měna Tanzanie',
    'prevence malárie Tanzanie',
    'vstupní požadavky Tanzanie',
    'co si sbalit na safari',
    'cestovní pojištění Afrika',
    'certifikát proti žluté zimnici Tanzanie',
    'cestovní průvodce Tanzanie',
    'nejlepší sezóna na Kilimandžáro',
    'seznam věcí na Kilimandžáro',
    'kdy vystoupit na Kilimandžáro',
    'elektřina a zásuvky v Tanzanii',
    'spropitné pro průvodce safari',
    'je Tanzanie bezpečná pro turisty',
    'migrace pakoňů měsíc po měsíci',
    'kurz tanzanského šilinku',
    'co na sebe na safari',
  ],
  no: [
    'visum til Tanzania',
    'reiseråd Tanzania',
    'vaksiner Tanzania',
    'pakkeliste for safari',
    'beste tid for safari i Tanzania',
    'vær safari Serengeti',
    'valuta Tanzania',
    'malariaforebygging Tanzania',
    'innreisekrav Tanzania',
    'hva du bør pakke til safari',
    'reiseforsikring Afrika',
    'gulfebersertifikat Tanzania',
    'reiseguide Tanzania',
    'beste sesong for Kilimanjaro',
    'pakkeliste for Kilimanjaro',
    'når bestige Kilimanjaro',
    'strøm og stikkontakter i Tanzania',
    'tips til safariguide',
    'er Tanzania trygt for turister',
    'migrasjon måned for måned',
    'valutakurs tanzaniansk shilling',
    'hva du skal ha på deg på safari',
  ],
  sv: [
    'visum till Tanzania',
    'reseråd Tanzania',
    'vaccinationer Tanzania',
    'packlista för safari',
    'bästa tiden för safari i Tanzania',
    'väder safari Serengeti',
    'valuta Tanzania',
    'malariaprofylax Tanzania',
    'inresekrav Tanzania',
    'vad du bör packa till safari',
    'reseförsäkring Afrika',
    'gula febern-intyg Tanzania',
    'reseguide Tanzania',
    'bästa säsongen för Kilimanjaro',
    'packlista för Kilimanjaro',
    'när bestiga Kilimanjaro',
    'el och eluttag i Tanzania',
    'dricks till safariguide',
    'är Tanzania säkert för turister',
    'migration månad för månad',
    'växelkurs tanzanisk shilling',
    'vad du ska ha på dig på safari',
  ],
}
