...
const PAYMENTS_KEYWORDS: Record<Locale, string[]> = {
  ...
  he: [
    'תשלום מקדמת ספארי אונליין', 'תשלום ל-EWA Safari Outfitters', 'תשלום ספארי דרך Pesapal',
    'אמצעי תשלום ספארי בטנזניה', 'תשלום יתרת ספארי', 'תשלום ספארי בכסף נייד',
  ],
  hi: [
    'सफारी डिपॉज़िट ऑनलाइन भुगतान', 'EWA Safari Outfitters को भुगतान', 'Pesapal से सफारी भुगतान',
    'तंजानिया सफारी भुगतान के तरीके', 'सफारी बकाया राशि का भुगतान', 'मोबाइल मनी से सफारी भुगतान',
  ],
  th: [
  ...
  pl: [
    'zapłać zaliczkę za safari online', 'płatność EWA Safari Outfitters', 'płatność za safari Pesapal',
    'metody płatności safari Tanzania', 'zapłać saldo za safari', 'płatność mobilna safari',
  ],
  cs: [
  ...
  sv: [
    'betala handpenning för safari online', 'betalning EWA Safari Outfitters', 'betalning för safari Pesapal',
    'betalningsmetoder safari Tanzania', 'betala restbelopp för safari', 'mobilbetalning safari',
  ],
}
