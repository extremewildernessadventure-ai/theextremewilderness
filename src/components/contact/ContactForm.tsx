      ...
      <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-5">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <svg className="absolute end-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
